...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_sinf16_ha_z0

__jsvml_sinf16_ha_z0    PROC    EXPORT
...
L1::
        ...
        vmovups   zmm4, ZMMWORD PTR [__jsvml_ssin_ha_data_internal+4096]
        and       r13, -64
        vmovups   zmm24, ZMMWORD PTR [__jsvml_ssin_ha_data_internal+5056]
        vmovups   zmm25, ZMMWORD PTR [__jsvml_ssin_ha_data_internal+4544]
        vmovups   zmm28, ZMMWORD PTR [__jsvml_ssin_ha_data_internal+5120]
        vmovups   zmm30, ZMMWORD PTR [__jsvml_ssin_ha_data_internal+5184]
        vmovaps   zmm22, zmm0
        vandps    zmm5, zmm22, zmm4
        vandnps   zmm1, zmm4, zmm22
        vmovups   zmm4, ZMMWORD PTR [__jsvml_ssin_ha_data_internal+5440]
        ...
        vmovups   zmm23, ZMMWORD PTR [__jsvml_ssin_ha_data_internal+5312]
        vmovups   zmm24, ZMMWORD PTR [__jsvml_ssin_ha_data_internal+5248]
        vextractf32x8 ymm27, zmm26, 1
        vcvtps2pd zmm2, ymm26 {sae}
        vcvtps2pd zmm0, ymm27 {sae}
        vmovups   zmm27, ZMMWORD PTR [__jsvml_ssin_ha_data_internal+5376]
        ...
        vmovups   zmm1, ZMMWORD PTR [__jsvml_ssin_ha_data_internal+4160]
...
_B1_15::
        ...
        call      __jsvml_ssin_ha_cout_rare_internal
        jmp       _B1_13
        ALIGN     16

_B1_16::

__jsvml_sinf16_ha_z0 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_sinf16_ha_z0_B1_B9:
        DD      267009
        DD      10867731
        DD      10944779
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B1_1
        DD      imagerel _B1_11
        DD      imagerel _unwind___jsvml_sinf16_ha_z0_B1_B9
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_sinf8_ha_l9

__jsvml_sinf8_ha_l9     PROC    EXPORT
...
L52::
        ...
        vmovups   ymm5, YMMWORD PTR [__jsvml_ssin_ha_data_internal+4096]
        and       r13, -64
        vmovups   ymm1, YMMWORD PTR [__jsvml_ssin_ha_data_internal+5056]
        vmovupd   ymm8, YMMWORD PTR [__jsvml_ssin_ha_data_internal+5120]
        vmovupd   ymm9, YMMWORD PTR [__jsvml_ssin_ha_data_internal+5184]
        vmovdqa   ymm4, ymm0
        vmovups   ymm0, YMMWORD PTR [__jsvml_ssin_ha_data_internal+4544]
        vandps    ymm3, ymm4, ymm5
        mov       QWORD PTR [536+rsp], r13
        vfmadd213ps ymm1, ymm3, ymm0
        vcvtps2pd ymm6, xmm3
        vextractf128 xmm2, ymm3, 1
        vcmpnle_uqps ymm3, ymm3, YMMWORD PTR [__jsvml_ssin_ha_data_internal+4160]
        ...
        vmovupd   ymm15, YMMWORD PTR [__jsvml_ssin_ha_data_internal+5440]
        vmulpd    ymm9, ymm0, ymm0
        vmulpd    ymm10, ymm1, ymm1
        vandnps   ymm6, ymm5, ymm4
        vmovupd   ymm5, YMMWORD PTR [__jsvml_ssin_ha_data_internal+5376]
        vmovdqa   ymm8, ymm5
        vfmadd231pd ymm8, ymm15, ymm9
        vfmadd231pd ymm5, ymm15, ymm10
        vmovupd   ymm15, YMMWORD PTR [__jsvml_ssin_ha_data_internal+5312]
        vfmadd213pd ymm8, ymm9, ymm15
        vfmadd213pd ymm5, ymm10, ymm15
        vmovupd   ymm15, YMMWORD PTR [__jsvml_ssin_ha_data_internal+5248]
        vfmadd213pd ymm8, ymm9, ymm15
        vfmadd213pd ymm5, ymm10, ymm15
...
__jsvml_sinf8_ha_l9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_sinf8_ha_l9_B1_B3:
        DD      933889
        DD      4379712
        DD      1796152
        DD      1673263
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B2_1
        DD      imagerel _B2_6
        DD      imagerel _unwind___jsvml_sinf8_ha_l9_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_sinf8_ha_l9_B6_B10:
        DD      931873
        DD      1598520
        DD      1651758
        DD      190502
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B2_6
        DD      imagerel _B2_11
        DD      imagerel _unwind___jsvml_sinf8_ha_l9_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_sinf4_ha_e9

__jsvml_sinf4_ha_e9     PROC    EXPORT
...
L79::
        ...
        vmovups   xmm0, XMMWORD PTR [__jsvml_ssin_ha_data_internal+4096]
        and       r13, -64
        vandps    xmm2, xmm3, xmm0
        vmulps    xmm1, xmm2, XMMWORD PTR [__jsvml_ssin_ha_data_internal+5056]
        vcvtps2pd ymm14, xmm2
        vcmpnleps xmm2, xmm2, XMMWORD PTR [__jsvml_ssin_ha_data_internal+4160]
        vmovups   xmm5, XMMWORD PTR [__jsvml_ssin_ha_data_internal+4544]
        vmovmskps edx, xmm2
        vaddps    xmm4, xmm5, xmm1
        vpslld    xmm1, xmm4, 31
        vsubps    xmm5, xmm4, xmm5
        vcvtps2pd ymm4, xmm5
        vmulpd    ymm5, ymm4, YMMWORD PTR [__jsvml_ssin_ha_data_internal+5120]
        vmulpd    ymm4, ymm4, YMMWORD PTR [__jsvml_ssin_ha_data_internal+5184]
        vsubpd    ymm14, ymm14, ymm5
        vsubpd    ymm5, ymm14, ymm4
        vandnps   xmm4, xmm0, xmm3
        vmulpd    ymm14, ymm5, ymm5
        vmulpd    ymm0, ymm14, YMMWORD PTR [__jsvml_ssin_ha_data_internal+5440]
        vaddpd    ymm0, ymm0, YMMWORD PTR [__jsvml_ssin_ha_data_internal+5376]
        vmulpd    ymm0, ymm14, ymm0
        vaddpd    ymm0, ymm0, YMMWORD PTR [__jsvml_ssin_ha_data_internal+5312]
        vmulpd    ymm0, ymm14, ymm0
        vaddpd    ymm0, ymm0, YMMWORD PTR [__jsvml_ssin_ha_data_internal+5248]
...
__jsvml_sinf4_ha_e9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_sinf4_ha_e9_B1_B3:
        DD      401409
        DD      1758240
        DD      845848
        DD      1900811
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B3_1
        DD      imagerel _B3_6
        DD      imagerel _unwind___jsvml_sinf4_ha_e9_B1_B3
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B3_6
        DD      imagerel _B3_11
        DD      imagerel _unwind___jsvml_sinf4_ha_e9_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_sinf8_ha_e9

__jsvml_sinf8_ha_e9     PROC    EXPORT
...
L88::
        ...
        mov       QWORD PTR [528+rsp], r13
        lea       r13, QWORD PTR [271+rsp]
        vmovups   ymm1, YMMWORD PTR [__jsvml_ssin_ha_data_internal+4096]
        and       r13, -64
        vmovups   ymm10, YMMWORD PTR [__jsvml_ssin_ha_data_internal+4544]
        vmovaps   ymm4, ymm0
        vandps    ymm5, ymm4, ymm1
        vandnps   ymm1, ymm1, ymm4
        mov       QWORD PTR [536+rsp], r13
        vmulps    ymm13, ymm5, YMMWORD PTR [__jsvml_ssin_ha_data_internal+5056]
        vcvtps2pd ymm0, xmm5
        vextractf128 xmm9, ymm5, 1
        vaddps    ymm13, ymm10, ymm13
        vcmpnle_uqps ymm5, ymm5, YMMWORD PTR [__jsvml_ssin_ha_data_internal+4160]
        vcvtps2pd ymm2, xmm9
        ...
        vmovupd   ymm13, YMMWORD PTR [__jsvml_ssin_ha_data_internal+5120]
        vinsertf128 ymm9, ymm15, xmm3, 1
        vmulpd    ymm3, ymm14, ymm13
        vcvtps2pd ymm15, xmm10
        vsubpd    ymm10, ymm0, ymm3
        vmulpd    ymm0, ymm15, ymm13
        vmovupd   ymm3, YMMWORD PTR [__jsvml_ssin_ha_data_internal+5440]
        vsubpd    ymm13, ymm2, ymm0
        vmovupd   ymm2, YMMWORD PTR [__jsvml_ssin_ha_data_internal+5184]
        vmulpd    ymm14, ymm14, ymm2
        vmulpd    ymm15, ymm15, ymm2
        vmovupd   ymm2, YMMWORD PTR [__jsvml_ssin_ha_data_internal+5376]
        ...
        vmovupd   ymm3, YMMWORD PTR [__jsvml_ssin_ha_data_internal+5312]
        vmulpd    ymm0, ymm14, ymm0
        vmulpd    ymm2, ymm15, ymm2
        vaddpd    ymm0, ymm3, ymm0
        vaddpd    ymm3, ymm3, ymm2
        vmovupd   ymm2, YMMWORD PTR [__jsvml_ssin_ha_data_internal+5248]
        vmulpd    ymm0, ymm14, ymm0
...
__jsvml_sinf8_ha_e9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_sinf8_ha_e9_B1_B3:
        DD      933889
        DD      4379712
        DD      1939512
        DD      2074671
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B4_1
        DD      imagerel _B4_6
        DD      imagerel _unwind___jsvml_sinf8_ha_e9_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_sinf8_ha_e9_B6_B10:
        DD      931873
        DD      1598520
        DD      1651758
        DD      182310
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B4_6
        DD      imagerel _B4_11
        DD      imagerel _unwind___jsvml_sinf8_ha_e9_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_sinf4_ha_l9

__jsvml_sinf4_ha_l9     PROC    EXPORT
...
L115::
        ...
        mov       QWORD PTR [208+rsp], r13
        lea       r13, QWORD PTR [111+rsp]
        vmovups   xmm4, XMMWORD PTR [__jsvml_ssin_ha_data_internal+4096]
        and       r13, -64
        vmovups   xmm3, XMMWORD PTR [__jsvml_ssin_ha_data_internal+5056]
        vandps    xmm1, xmm0, xmm4
        vmovups   xmm5, XMMWORD PTR [__jsvml_ssin_ha_data_internal+4544]
        vandnps   xmm4, xmm4, xmm0
        vfmadd213ps xmm3, xmm1, xmm5
        vcvtps2pd ymm12, xmm1
        vcmpnleps xmm1, xmm1, XMMWORD PTR [__jsvml_ssin_ha_data_internal+4160]
        vpslld    xmm2, xmm3, 31
        vsubps    xmm3, xmm3, xmm5
        vmovmskps edx, xmm1
        vcvtps2pd ymm3, xmm3
        vfnmadd231pd ymm12, ymm3, YMMWORD PTR [__jsvml_ssin_ha_data_internal+5120]
        vfnmadd132pd ymm3, ymm12, YMMWORD PTR [__jsvml_ssin_ha_data_internal+5184]
        vmovupd   ymm12, YMMWORD PTR [__jsvml_ssin_ha_data_internal+5440]
        vmulpd    ymm5, ymm3, ymm3
        vfmadd213pd ymm12, ymm5, YMMWORD PTR [__jsvml_ssin_ha_data_internal+5376]
        vfmadd213pd ymm12, ymm5, YMMWORD PTR [__jsvml_ssin_ha_data_internal+5312]
        vfmadd213pd ymm12, ymm5, YMMWORD PTR [__jsvml_ssin_ha_data_internal+5248]
...
__jsvml_sinf4_ha_l9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_sinf4_ha_l9_B1_B3:
        DD      400385
        DD      1758236
        DD      837652
        DD      1900811
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B5_1
        DD      imagerel _B5_6
        DD      imagerel _unwind___jsvml_sinf4_ha_l9_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_sinf4_ha_l9_B6_B10:
        DD      658945
        DD      287758
        DD      340999
        DD      837632
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B5_6
        DD      imagerel _B5_11
        DD      imagerel _unwind___jsvml_sinf4_ha_l9_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_sinf4_ha_ex

__jsvml_sinf4_ha_ex     PROC    EXPORT
...
L124::
        ...
        lea       r13, QWORD PTR [111+rsp]
        movups    xmm3, XMMWORD PTR [__jsvml_ssin_ha_data_internal+4096]
        and       r13, -64
        movups    xmm12, XMMWORD PTR [__jsvml_ssin_ha_data_internal+5056]
        andps     xmm4, xmm3
        mulps     xmm12, xmm4
        movaps    xmm2, xmm4
        cvtps2pd  xmm0, xmm4
        movups    xmm8, XMMWORD PTR [__jsvml_ssin_ha_data_internal+4544]
        andnps    xmm3, xmm5
        movhlps   xmm2, xmm4
        addps     xmm12, xmm8
        cvtps2pd  xmm1, xmm2
        cmpnleps  xmm4, XMMWORD PTR [__jsvml_ssin_ha_data_internal+4160]
        movaps    xmm2, xmm12
        subps     xmm12, xmm8
        movmskps  eax, xmm4
        movups    xmm14, XMMWORD PTR [__jsvml_ssin_ha_data_internal+5120]
        pslld     xmm2, 31
        cvtps2pd  xmm8, xmm12
        movhlps   xmm12, xmm12
        movaps    xmm13, xmm14
        ...
        subpd     xmm0, xmm13
        subpd     xmm1, xmm14
        movups    xmm7, XMMWORD PTR [__jsvml_ssin_ha_data_internal+5184]
        pxor      xmm2, xmm3
        mulpd     xmm8, xmm7
        mulpd     xmm12, xmm7
        subpd     xmm0, xmm8
        ...
        mulpd     xmm12, xmm0
        mulpd     xmm13, xmm1
        movups    xmm7, XMMWORD PTR [__jsvml_ssin_ha_data_internal+5440]
        movaps    xmm8, xmm7
        mulpd     xmm8, xmm12
        mulpd     xmm7, xmm13
        movups    xmm14, XMMWORD PTR [__jsvml_ssin_ha_data_internal+5376]
        addpd     xmm8, xmm14
        addpd     xmm14, xmm7
        mulpd     xmm8, xmm12
        mulpd     xmm14, xmm13
        movups    xmm7, XMMWORD PTR [__jsvml_ssin_ha_data_internal+5312]
        addpd     xmm8, xmm7
        addpd     xmm7, xmm14
        mulpd     xmm8, xmm12
        mulpd     xmm7, xmm13
        movups    xmm14, XMMWORD PTR [__jsvml_ssin_ha_data_internal+5248]
        addpd     xmm8, xmm14
        addpd     xmm14, xmm7
        mulpd     xmm12, xmm8
        mulpd     xmm13, xmm14
...
__jsvml_sinf4_ha_ex ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_sinf4_ha_ex_B1_B3:
        DD      935169
        DD      2282565
        DD      882749
        DD      821301
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_ssin_ha_cout_rare_internal

__jsvml_ssin_ha_cout_rare_internal      PROC
...
__jsvml_ssin_ha_cout_rare_internal ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_ssin_ha_cout_rare_internal_B1_B20:
        DD      675841
        DD      354384
        DD      579659
        DD      522306
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B7_1
        DD      imagerel _B7_21
        DD      imagerel _unwind___jsvml_ssin_ha_cout_rare_internal_B1_B20
