...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_hypotf8_ha_l9

__jsvml_hypotf8_ha_l9   PROC    EXPORT
...
L1::
        ...
        vmovups   ymm2, YMMWORD PTR [__jsvml_shypot_ha_data_internal+128]
        and       r13, -64
        vmovups   ymm5, YMMWORD PTR [__jsvml_shypot_ha_data_internal]
        vmovups   ymm8, YMMWORD PTR [__jsvml_shypot_ha_data_internal+192]
        vmovaps   ymm14, ymm1
        ...
        vpcmpgtd  ymm13, ymm15, YMMWORD PTR [__jsvml_shypot_ha_data_internal+320]
        ...
        vmovups   ymm2, YMMWORD PTR [__jsvml_shypot_ha_data_internal+384]
        vfmadd213ps ymm5, ymm15, ymm4
        vaddps    ymm15, ymm13, ymm5
        vpcmpgtd  ymm1, ymm15, YMMWORD PTR [__jsvml_shypot_ha_data_internal+448]
        ...
        vandps    ymm1, ymm15, YMMWORD PTR [__jsvml_shypot_ha_data_internal+64]
...
__jsvml_hypotf8_ha_l9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_hypotf8_ha_l9_B1_B3:
        DD      800513
        DD      4903991
        DD      1935407
        DD      2349094
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B1_1
        DD      imagerel _B1_6
        DD      imagerel _unwind___jsvml_hypotf8_ha_l9_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_hypotf8_ha_l9_B6_B10:
        DD      1065249
        DD      1860673
        DD      1913911
        DD      182319
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B1_6
        DD      imagerel _B1_11
        DD      imagerel _unwind___jsvml_hypotf8_ha_l9_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_hypotf4_ha_l9

__jsvml_hypotf4_ha_l9   PROC    EXPORT
...
L28::
        ...
        vmovups   xmm2, XMMWORD PTR [__jsvml_shypot_ha_data_internal+128]
        and       r13, -64
        vandps    xmm3, xmm0, xmm2
        vandps    xmm4, xmm14, xmm2
        vmaxps    xmm1, xmm3, xmm4
        vminps    xmm2, xmm4, xmm3
        vmovups   xmm8, XMMWORD PTR [__jsvml_shypot_ha_data_internal]
        vpsubd    xmm15, xmm1, xmm2
        vandps    xmm3, xmm1, xmm8
        vpcmpgtd  xmm13, xmm15, XMMWORD PTR [__jsvml_shypot_ha_data_internal+320]
        ...
        vmovups   xmm2, XMMWORD PTR [__jsvml_shypot_ha_data_internal+384]
        vmovups   xmm5, XMMWORD PTR [__jsvml_shypot_ha_data_internal+192]
        vfmadd231ps xmm8, xmm15, xmm15
        vfmadd213ps xmm13, xmm15, xmm4
        mov       QWORD PTR [328+rsp], r13
        vaddps    xmm15, xmm8, xmm13
        vpcmpgtd  xmm1, xmm15, XMMWORD PTR [__jsvml_shypot_ha_data_internal+448]
        ...
        vandps    xmm1, xmm15, XMMWORD PTR [__jsvml_shypot_ha_data_internal+64]
...
__jsvml_hypotf4_ha_l9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_hypotf4_ha_l9_B1_B3:
        DD      801537
        DD      2675771
        DD      1083443
        DD      1300522
...
.xdata  SEGMENT  DWORD   READ  ''
        ...
        ALIGN 004H
_unwind___jsvml_hypotf4_ha_l9_B6_B10:
        DD      265761
        DD      287758
        DD      340999
        DD      imagerel _B2_1
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B2_6
        DD      imagerel _B2_11
        DD      imagerel _unwind___jsvml_hypotf4_ha_l9_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_hypotf8_ha_e9

__jsvml_hypotf8_ha_e9   PROC    EXPORT
...
L43::
        ...
        vmovups   ymm2, YMMWORD PTR [__jsvml_shypot_ha_data_internal+128]
        and       r13, -64
        vmovups   ymm15, YMMWORD PTR [__jsvml_shypot_ha_data_internal]
        vmovups   ymm7, YMMWORD PTR [__jsvml_shypot_ha_data_internal+192]
        vmovaps   ymm9, ymm1
        vandps    ymm14, ymm0, ymm2
        vandps    ymm11, ymm9, ymm2
        vmaxps    ymm4, ymm14, ymm11
        vminps    ymm1, ymm11, ymm14
        vmovups   xmm11, XMMWORD PTR [__jsvml_shypot_ha_data_internal+320]
        ...
        vmovups   xmm15, XMMWORD PTR [__jsvml_shypot_ha_data_internal+448]
        ...
        vmovups   xmm3, XMMWORD PTR [__jsvml_shypot_ha_data_internal+384]
        ...
        vandps    ymm3, ymm11, YMMWORD PTR [__jsvml_shypot_ha_data_internal+64]
...
__jsvml_hypotf8_ha_e9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_hypotf8_ha_e9_B1_B3:
        DD      1067265
        DD      4904009
        DD      2193473
        DD      2328632
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B3_1
        DD      imagerel _B3_6
        DD      imagerel _unwind___jsvml_hypotf8_ha_e9_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_hypotf8_ha_e9_B6_B10:
        DD      798497
        DD      1336367
        DD      1389605
        DD      186397
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B3_6
        DD      imagerel _B3_11
        DD      imagerel _unwind___jsvml_hypotf8_ha_e9_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_hypotf4_ha_ex

__jsvml_hypotf4_ha_ex   PROC    EXPORT
...
L70::
        ...
        lea       r13, QWORD PTR [111+rsp]
        movups    xmm5, XMMWORD PTR [__jsvml_shypot_ha_data_internal+128]
        and       r13, -64
        andps     xmm0, xmm5
        andps     xmm5, xmm1
        movaps    xmm7, xmm0
        ...
        psubd     xmm3, xmm5
        movaps    xmm10, xmm7
        movups    xmm2, XMMWORD PTR [__jsvml_shypot_ha_data_internal]
        pcmpgtd   xmm3, XMMWORD PTR [__jsvml_shypot_ha_data_internal+320]
        andps     xmm4, xmm2
        andnps    xmm3, xmm2
        movaps    xmm2, xmm5
        andps     xmm3, xmm5
        ...
        movaps    xmm0, xmm8
        addps     xmm10, xmm3
        movdqu    xmm4, XMMWORD PTR [__jsvml_shypot_ha_data_internal+384]
        addps     xmm0, xmm10
        rsqrtps   xmm2, xmm0
        movups    xmm14, XMMWORD PTR [__jsvml_shypot_ha_data_internal+192]
        pcmpgtd   xmm4, xmm0
        movaps    xmm3, xmm0
        mulps     xmm0, xmm2
        mulps     xmm2, xmm14
        movaps    xmm5, xmm0
        mulps     xmm5, xmm2
        pcmpgtd   xmm3, XMMWORD PTR [__jsvml_shypot_ha_data_internal+448]
        subps     xmm14, xmm5
        por       xmm4, xmm3
        movaps    xmm3, xmm14
        mulps     xmm14, xmm0
        ...
        addps     xmm0, xmm14
        addps     xmm2, xmm3
        movups    xmm4, XMMWORD PTR [__jsvml_shypot_ha_data_internal+64]
        movaps    xmm7, xmm0
        andps     xmm4, xmm0
        movaps    xmm14, xmm4
        subps     xmm7, xmm4
...
__jsvml_hypotf4_ha_ex ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_hypotf4_ha_ex_B1_B3:
        DD      934657
        DD      2806851
        DD      1275963
        DD      1148979
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B4_1
        DD      imagerel _B4_6
        DD      imagerel _unwind___jsvml_hypotf4_ha_ex_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_hypotf4_ha_ex_B6_B10:
        DD      265761
        DD      287758
        DD      340999
        DD      imagerel _B4_1
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B4_6
        DD      imagerel _B4_11
        DD      imagerel _unwind___jsvml_hypotf4_ha_ex_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_hypotf16_ha_z0

__jsvml_hypotf16_ha_z0  PROC    EXPORT
...
L87::
        ...
        vmovups   zmm3, ZMMWORD PTR [__jsvml_shypot_ha_data_internal+192]
        and       r13, -64
        vandps    zmm22, zmm5, ZMMWORD PTR [__jsvml_shypot_ha_data_internal+128]
        vmovaps   zmm29, zmm2
        vfmsub213ps zmm29, zmm2, zmm24 {rn-sae}
        vpcmpd    k0, zmm22, ZMMWORD PTR [__jsvml_shypot_ha_data_internal+512], 5
...
__jsvml_hypotf16_ha_z0 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_hypotf16_ha_z0_B1_B9:
        DD      291585
        DD      11392115
        DD      11469067
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B5_1
        DD      imagerel _B5_11
        DD      imagerel _unwind___jsvml_hypotf16_ha_z0_B1_B9
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B5_11
        DD      imagerel _B5_16
        DD      imagerel _unwind___jsvml_hypotf16_ha_z0_B11_B15
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_hypotf4_ha_e9

__jsvml_hypotf4_ha_e9   PROC    EXPORT
...
L138::
        ...
        vmovups   xmm5, XMMWORD PTR [__jsvml_shypot_ha_data_internal]
        vpcmpgtd  xmm11, xmm2, XMMWORD PTR [__jsvml_shypot_ha_data_internal+320]
        ...
        vmovups   xmm4, XMMWORD PTR [__jsvml_shypot_ha_data_internal+384]
        vaddps    xmm10, xmm8, xmm15
        vmovups   xmm1, XMMWORD PTR [__jsvml_shypot_ha_data_internal+192]
        vaddps    xmm11, xmm2, xmm10
        vrsqrtps  xmm15, xmm11
        vpcmpgtd  xmm5, xmm11, XMMWORD PTR [__jsvml_shypot_ha_data_internal+448]
        ...
        vandps    xmm8, xmm4, XMMWORD PTR [__jsvml_shypot_ha_data_internal+64]
...
__jsvml_hypotf4_ha_e9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_hypotf4_ha_e9_B1_B3:
        DD      934913
        DD      2806852
        DD      1140796
        DD      1280051
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B6_1
        DD      imagerel _B6_6
        DD      imagerel _unwind___jsvml_hypotf4_ha_e9_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_hypotf4_ha_e9_B6_B10:
        DD      265761
        DD      287758
        DD      340999
        DD      imagerel _B6_1
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B6_6
        DD      imagerel _B6_11
        DD      imagerel _unwind___jsvml_hypotf4_ha_e9_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_shypot_ha_cout_rare_internal

__jsvml_shypot_ha_cout_rare_internal    PROC
...
__jsvml_shypot_ha_cout_rare_internal ENDP
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B7_1
        DD      imagerel _B7_21
        DD      imagerel _unwind___jsvml_shypot_ha_cout_rare_internal_B1_B18
