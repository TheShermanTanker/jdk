...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_cosh1_ha_e9

__jsvml_cosh1_ha_e9     PROC    EXPORT
...
L1::
        ...
        vmovsd    xmm5, QWORD PTR [__jsvml_dcosh_ha_data_internal+4672]
        and       r13, -64
        vandnpd   xmm13, xmm5, xmm4
        vmovd     xmm5, eax
        vmulsd    xmm0, xmm13, QWORD PTR [__jsvml_dcosh_ha_data_internal+3968]
        vmovsd    xmm1, QWORD PTR [__jsvml_dcosh_ha_data_internal+4160]
        vmovsd    xmm11, QWORD PTR [__jsvml_dcosh_ha_data_internal+4032]
        ...
        vmovmskps eax, xmm6
        vmovsd    xmm12, QWORD PTR [__jsvml_dcosh_ha_data_internal+4096]
        vmovd     xmm5, edx
        ...
        vpslld    xmm6, xmm5, 3
        vmovd     ecx, xmm6
        vmovq     xmm12, QWORD PTR [__jsvml_dcosh_ha_data_internal+4608]
        vpand     xmm11, xmm0, xmm12
        vmovq     xmm6, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+912+r8+rcx]
        vpsubq    xmm12, xmm6, xmm11
        vmulsd    xmm6, xmm1, xmm1
        vmovsd    xmm2, QWORD PTR [__jsvml_dcosh_ha_data_internal+4544]
        vmulsd    xmm2, xmm2, xmm6
        vmovsd    xmm3, QWORD PTR [__jsvml_dcosh_ha_data_internal+4480]
        vmulsd    xmm3, xmm3, xmm6
        vaddsd    xmm2, xmm2, QWORD PTR [__jsvml_dcosh_ha_data_internal+4416]
        vmovq     xmm15, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+896+r8+rcx]
        vmovq     xmm5, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+904+r8+rcx]
        vpaddq    xmm0, xmm15, xmm11
        vpaddq    xmm13, xmm5, xmm11
        vaddsd    xmm11, xmm3, QWORD PTR [__jsvml_dcosh_ha_data_internal+4352]
...
_B1_6::
        ...
        call      __jsvml_dcosh_ha_cout_rare_internal
        jmp       _B1_4
        ALIGN     16

_B1_7::

__jsvml_cosh1_ha_e9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_cosh1_ha_e9_B1_B6:
        DD      939265
        DD      1430613
        DD      747597
        DD      1030212
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B1_1
        DD      imagerel _B1_7
        DD      imagerel _unwind___jsvml_cosh1_ha_e9_B1_B6
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_cosh4_ha_l9

__jsvml_cosh4_ha_l9     PROC    EXPORT
...
L14::
        ...
        vmovupd   ymm3, YMMWORD PTR [__jsvml_dcosh_ha_data_internal+4672]
        and       r13, -64
        vmovupd   ymm8, YMMWORD PTR [__jsvml_dcosh_ha_data_internal+3968]
        vmovupd   ymm4, YMMWORD PTR [__jsvml_dcosh_ha_data_internal+4160]
        vmovupd   ymm1, YMMWORD PTR [__jsvml_dcosh_ha_data_internal+4544]
        vmovapd   ymm2, ymm0
        vandnpd   ymm3, ymm3, ymm2
        vfmadd213pd ymm8, ymm3, ymm4
        vmovupd   ymm0, YMMWORD PTR [__jsvml_dcosh_ha_data_internal+4480]
        mov       QWORD PTR [536+rsp], r13
        vextracti128 xmm5, ymm3, 1
        vshufps   xmm9, xmm3, xmm5, 221
        vpcmpgtd  xmm5, xmm9, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+4736]
        vmovmskps r8d, xmm5
        vextracti128 xmm6, ymm8, 1
        vsubpd    ymm4, ymm8, ymm4
        vshufps   xmm15, xmm8, xmm6, 136
        vpand     xmm9, xmm15, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+4224]
        vpslld    xmm10, xmm9, 1
        vpaddd    xmm5, xmm10, xmm9
        vpslld    xmm10, xmm5, 3
        vfnmadd231pd ymm3, ymm4, YMMWORD PTR [__jsvml_dcosh_ha_data_internal+4032]
        vpsllq    ymm8, ymm8, 45
        vmovd     ecx, xmm10
        vfnmadd231pd ymm3, ymm4, YMMWORD PTR [__jsvml_dcosh_ha_data_internal+4096]
        vmovq     xmm6, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+896+rdx+rcx]
        vpand     ymm4, ymm8, YMMWORD PTR [__jsvml_dcosh_ha_data_internal+4608]
        vpextrd   r9d, xmm10, 2
        vpextrd   eax, xmm10, 1
        vpextrd   r10d, xmm10, 3
        vmovq     xmm9, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+896+rdx+r9]
        vmovhpd   xmm15, xmm6, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+896+rdx+rax]
        vmovhpd   xmm5, xmm9, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+896+rdx+r10]
        vmovq     xmm6, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+904+rdx+rcx]
        vmovhpd   xmm10, xmm6, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+904+rdx+rax]
        vinsertf128 ymm9, ymm15, xmm5, 1
        vmovq     xmm5, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+904+rdx+r9]
        vmovhpd   xmm6, xmm5, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+904+rdx+r10]
        vmovq     xmm5, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+912+rdx+rcx]
        vpaddq    ymm9, ymm9, ymm4
        vinsertf128 ymm15, ymm10, xmm6, 1
        vpaddq    ymm8, ymm15, ymm4
        vmovq     xmm10, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+912+rdx+r9]
        vmovhpd   xmm6, xmm5, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+912+rdx+rax]
        vmovhpd   xmm5, xmm10, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+912+rdx+r10]
        vmulpd    ymm15, ymm3, ymm3
        vfmadd213pd ymm1, ymm15, YMMWORD PTR [__jsvml_dcosh_ha_data_internal+4416]
        vfmadd213pd ymm0, ymm15, YMMWORD PTR [__jsvml_dcosh_ha_data_internal+4352]
...
__jsvml_cosh4_ha_l9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_cosh4_ha_l9_B1_B3:
        DD      935681
        DD      4379719
        DD      1534015
        DD      1804342
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B2_1
        DD      imagerel _B2_6
        DD      imagerel _unwind___jsvml_cosh4_ha_l9_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_cosh4_ha_l9_B6_B10:
        DD      931873
        DD      1598520
        DD      1651758
        DD      190502
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B2_6
        DD      imagerel _B2_11
        DD      imagerel _unwind___jsvml_cosh4_ha_l9_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_cosh8_ha_z0

__jsvml_cosh8_ha_z0     PROC    EXPORT
...
L41::
        ...
        vmovups   zmm26, ZMMWORD PTR [__jsvml_dcosh_ha_data_internal+4672]
        and       r13, -64
        vmovups   zmm22, ZMMWORD PTR [__jsvml_dcosh_ha_data_internal+3968]
        vmovups   zmm3, ZMMWORD PTR [__jsvml_dcosh_ha_data_internal+384]
        vmovups   zmm4, ZMMWORD PTR [__jsvml_dcosh_ha_data_internal+4032]
        vmovups   zmm2, ZMMWORD PTR [__jsvml_dcosh_ha_data_internal+4096]
        vmovups   zmm31, ZMMWORD PTR [__jsvml_dcosh_ha_data_internal+640]
        vmovups   zmm30, ZMMWORD PTR [__jsvml_dcosh_ha_data_internal+704]
        vmovups   zmm28, ZMMWORD PTR [__jsvml_dcosh_ha_data_internal+768]
        vmovups   zmm27, ZMMWORD PTR [__jsvml_dcosh_ha_data_internal+832]
        vmovups   zmm25, ZMMWORD PTR [__jsvml_dcosh_ha_data_internal+512]
        vmovups   zmm24, ZMMWORD PTR [__jsvml_dcosh_ha_data_internal+576]
        vmovups   zmm5, ZMMWORD PTR [__jsvml_dcosh_ha_data_internal+128]
        vmovaps   zmm29, zmm0
        vandnpd   zmm26, zmm26, zmm29
        vpsrlq    zmm23, zmm26, 32
        vfmadd213pd zmm22, zmm26, zmm3 {rn-sae}
        vpmovqd   ymm0, zmm23
        vmovups   zmm23, ZMMWORD PTR [__jsvml_dcosh_ha_data_internal+256]
        vpermt2pd zmm5, zmm22, ZMMWORD PTR [__jsvml_dcosh_ha_data_internal+192]
        vpermt2pd zmm23, zmm22, ZMMWORD PTR [__jsvml_dcosh_ha_data_internal+320]
        vpcmpgtd  ymm1, ymm0, YMMWORD PTR [__jsvml_dcosh_ha_data_internal+4736]
        vmovmskps r8d, ymm1
        vsubpd    zmm1, zmm22, zmm3 {rn-sae}
        vmovups   zmm0, ZMMWORD PTR [__jsvml_dcosh_ha_data_internal]
        vpsllq    zmm3, zmm22, 48
        vfnmadd231pd zmm26, zmm1, zmm4 {rn-sae}
        vpermt2pd zmm0, zmm22, ZMMWORD PTR [__jsvml_dcosh_ha_data_internal+64]
        ...
        vpandq    zmm4, zmm3, ZMMWORD PTR [__jsvml_dcosh_ha_data_internal+4608]
...
__jsvml_cosh8_ha_z0 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_cosh8_ha_z0_B1_B9:
        DD      267009
        DD      10867731
        DD      10944779
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B3_1
        DD      imagerel _B3_11
        DD      imagerel _unwind___jsvml_cosh8_ha_z0_B1_B9
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B3_11
        DD      imagerel _B3_16
        DD      imagerel _unwind___jsvml_cosh8_ha_z0_B11_B15
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_cosh2_ha_l9

__jsvml_cosh2_ha_l9     PROC    EXPORT
...
L92::
        ...
        vmovupd   xmm1, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+4672]
        and       r13, -64
        vmovupd   xmm11, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+3968]
        vandnpd   xmm1, xmm1, xmm3
        vmovupd   xmm9, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+4160]
        vfmadd213pd xmm11, xmm1, xmm9
        vmovq     xmm0, QWORD PTR [__jsvml_dcosh_ha_data_internal+4736]
        vpshufd   xmm2, xmm1, 221
        vmovq     xmm8, QWORD PTR [__jsvml_dcosh_ha_data_internal+4224]
        vpcmpgtd  xmm2, xmm2, xmm0
        vmovupd   xmm5, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+4480]
        vsubpd    xmm9, xmm11, xmm9
        vmovmskps edx, xmm2
        vpshufd   xmm6, xmm11, 136
        vpsllq    xmm11, xmm11, 45
        vpand     xmm2, xmm6, xmm8
        vfnmadd231pd xmm1, xmm9, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+4032]
        vpslld    xmm8, xmm2, 1
        vpaddd    xmm0, xmm8, xmm2
        vpslld    xmm8, xmm0, 3
        vmovd     eax, xmm8
        vmovupd   xmm4, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+4544]
        vfnmadd231pd xmm1, xmm9, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+4096]
        vmovq     xmm6, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+896+r8+rax]
        vmovq     xmm0, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+904+r8+rax]
        vpextrd   ecx, xmm8, 1
        vmovq     xmm8, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+912+r8+rax]
        vmovhpd   xmm2, xmm6, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+896+r8+rcx]
        vmovhpd   xmm6, xmm8, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+912+r8+rcx]
        vpand     xmm8, xmm11, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+4608]
        vpsubq    xmm11, xmm6, xmm8
        vpaddq    xmm2, xmm2, xmm8
        vmulpd    xmm6, xmm1, xmm1
        vsubpd    xmm9, xmm2, xmm11
        vfmadd213pd xmm4, xmm6, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+4416]
        vfmadd213pd xmm5, xmm6, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+4352]
        vmovhpd   xmm0, xmm0, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+904+r8+rcx]
...
__jsvml_cosh2_ha_l9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_cosh2_ha_l9_B1_B3:
        DD      803329
        DD      2151490
        DD      944186
        DD      886833
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B4_1
        DD      imagerel _B4_6
        DD      imagerel _unwind___jsvml_cosh2_ha_l9_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_cosh2_ha_l9_B6_B10:
        DD      265761
        DD      287758
        DD      340999
        DD      imagerel _B4_1
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B4_6
        DD      imagerel _B4_11
        DD      imagerel _unwind___jsvml_cosh2_ha_l9_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_cosh1_ha_l9

__jsvml_cosh1_ha_l9     PROC    EXPORT
...
L107::
        ...
        mov       QWORD PTR [168+rsp], r13
        lea       r13, QWORD PTR [95+rsp]
        vmovsd    xmm1, QWORD PTR [__jsvml_dcosh_ha_data_internal+4672]
        and       r13, -64
        vandnpd   xmm6, xmm1, xmm4
        vmovsd    xmm9, QWORD PTR [__jsvml_dcosh_ha_data_internal+4160]
        vmovapd   xmm14, xmm6
        vfmadd132sd xmm14, xmm9, QWORD PTR [__jsvml_dcosh_ha_data_internal+3968]
        vpshufd   xmm15, xmm6, 85
        vmovsd    xmm10, QWORD PTR [__jsvml_dcosh_ha_data_internal+4032]
        vpcmpgtd  xmm1, xmm15, xmm0
        vmovd     xmm0, edx
        vmovsd    xmm5, QWORD PTR [__jsvml_dcosh_ha_data_internal+4096]
        ...
        vpslld    xmm1, xmm0, 3
        vmovd     ecx, xmm1
        vmovq     xmm6, QWORD PTR [__jsvml_dcosh_ha_data_internal+4608]
        vmovsd    xmm2, QWORD PTR [__jsvml_dcosh_ha_data_internal+4544]
        vfnmadd213sd xmm5, xmm9, xmm10
        vpand     xmm10, xmm14, xmm6
        vmovq     xmm0, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+904+r8+rcx]
        vpaddq    xmm14, xmm0, xmm10
        vmovsd    xmm3, QWORD PTR [__jsvml_dcosh_ha_data_internal+4480]
        vmulsd    xmm0, xmm5, xmm5
        vfmadd213sd xmm2, xmm0, QWORD PTR [__jsvml_dcosh_ha_data_internal+4416]
        vfmadd213sd xmm3, xmm0, QWORD PTR [__jsvml_dcosh_ha_data_internal+4352]
        vmovq     xmm15, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+896+r8+rcx]
        vmovq     xmm1, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+912+r8+rcx]
...
__jsvml_cosh1_ha_l9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_cosh1_ha_l9_B1_B6:
        DD      940289
        DD      1430617
        DD      747597
        DD      890948
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B5_1
        DD      imagerel _B5_7
        DD      imagerel _unwind___jsvml_cosh1_ha_l9_B1_B6
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_cosh4_ha_e9

__jsvml_cosh4_ha_e9     PROC    EXPORT
...
L120::
        ...
        vmovupd   ymm2, YMMWORD PTR [__jsvml_dcosh_ha_data_internal+4672]
        and       r13, -64
        vmovupd   ymm15, YMMWORD PTR [__jsvml_dcosh_ha_data_internal+4160]
        vmovapd   ymm5, ymm0
        vandnpd   ymm10, ymm2, ymm5
        vmulpd    ymm4, ymm10, YMMWORD PTR [__jsvml_dcosh_ha_data_internal+3968]
        vaddpd    ymm11, ymm15, ymm4
        mov       QWORD PTR [536+rsp], r13
        vextractf128 xmm12, ymm11, 1
        vshufps   xmm13, xmm11, xmm12, 136
        vpsllq    xmm12, xmm12, 45
        vpand     xmm4, xmm13, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+4224]
        vpslld    xmm2, xmm4, 1
        ...
        vpslld    xmm0, xmm1, 3
        vmovd     ecx, xmm0
        vpcmpgtd  xmm14, xmm3, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+4736]
        vmovmskps r8d, xmm14
        vmovq     xmm2, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+904+rdx+rcx]
        vmovq     xmm3, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+896+rdx+rcx]
        vpextrd   eax, xmm0, 1
        vpextrd   r9d, xmm0, 2
        vpextrd   r10d, xmm0, 3
        vmovhpd   xmm0, xmm2, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+904+rdx+rax]
        vmovq     xmm4, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+904+rdx+r9]
        vmovq     xmm2, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+912+rdx+r9]
        vmovhpd   xmm1, xmm4, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+904+rdx+r10]
        vmovhpd   xmm4, xmm2, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+912+rdx+r10]
        vsubpd    ymm2, ymm11, ymm15
        vpsllq    xmm11, xmm11, 45
        vmovq     xmm14, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+896+rdx+r9]
        vmovhpd   xmm13, xmm3, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+896+rdx+rax]
        vmulpd    ymm15, ymm2, YMMWORD PTR [__jsvml_dcosh_ha_data_internal+4032]
        vmulpd    ymm2, ymm2, YMMWORD PTR [__jsvml_dcosh_ha_data_internal+4096]
        vmovhpd   xmm14, xmm14, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+896+rdx+r10]
        vmovq     xmm3, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+912+rdx+rcx]
        vmovhpd   xmm3, xmm3, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+912+rdx+rax]
        vsubpd    ymm15, ymm10, ymm15
        vmovupd   xmm10, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+4608]
        ...
        vmulpd    ymm11, ymm0, YMMWORD PTR [__jsvml_dcosh_ha_data_internal+4480]
        vaddpd    ymm10, ymm11, YMMWORD PTR [__jsvml_dcosh_ha_data_internal+4352]
        vinsertf128 ymm14, ymm13, xmm14, 1
        vpsubq    xmm13, xmm3, xmm15
        vpsubq    xmm15, xmm4, xmm12
        vmulpd    ymm4, ymm0, YMMWORD PTR [__jsvml_dcosh_ha_data_internal+4544]
        vaddpd    ymm12, ymm4, YMMWORD PTR [__jsvml_dcosh_ha_data_internal+4416]
...
__jsvml_cosh4_ha_e9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_cosh4_ha_e9_B1_B3:
        DD      1069057
        DD      4379728
        DD      2074696
        DD      1947711
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B6_1
        DD      imagerel _B6_6
        DD      imagerel _unwind___jsvml_cosh4_ha_e9_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_cosh4_ha_e9_B6_B10:
        DD      798497
        DD      1336367
        DD      1389605
        DD      170013
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B6_6
        DD      imagerel _B6_11
        DD      imagerel _unwind___jsvml_cosh4_ha_e9_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_cosh1_ha_ex

__jsvml_cosh1_ha_ex     PROC    EXPORT
...
L147::
        ...
        mov       QWORD PTR [168+rsp], r13
        lea       r13, QWORD PTR [95+rsp]
        movsd     xmm8, QWORD PTR [__jsvml_dcosh_ha_data_internal+4672]
        and       r13, -64
        andnps    xmm8, xmm10
        movaps    xmm6, xmm8
        mulsd     xmm6, QWORD PTR [__jsvml_dcosh_ha_data_internal+3968]
        movsd     xmm9, QWORD PTR [__jsvml_dcosh_ha_data_internal+4160]
        movsd     xmm5, QWORD PTR [__jsvml_dcosh_ha_data_internal+4032]
        addsd     xmm6, xmm9
        movaps    xmm11, xmm6
        movsd     xmm4, QWORD PTR [__jsvml_dcosh_ha_data_internal+4096]
        subsd     xmm11, xmm9
        mulsd     xmm5, xmm11
        mulsd     xmm4, xmm11
        pshufd    xmm2, xmm8, 85
        subsd     xmm8, xmm5
        movsd     xmm0, QWORD PTR [__jsvml_dcosh_ha_data_internal+4544]
        pcmpgtd   xmm2, xmm1
        pshufd    xmm1, xmm6, 0
        psllq     xmm6, 45
        pand      xmm1, xmm3
        ...
        mulsd     xmm0, xmm5
        paddd     xmm2, xmm1
        movsd     xmm7, QWORD PTR [__jsvml_dcosh_ha_data_internal+4480]
        pslld     xmm2, 3
        mulsd     xmm7, xmm5
        addsd     xmm0, QWORD PTR [__jsvml_dcosh_ha_data_internal+4416]
        movd      ecx, xmm2
        movq      xmm4, QWORD PTR [__jsvml_dcosh_ha_data_internal+4608]
        mulsd     xmm0, xmm5
        addsd     xmm7, QWORD PTR [__jsvml_dcosh_ha_data_internal+4352]
        movq      xmm1, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+896+r8+rcx]
        pand      xmm6, xmm4
        movq      xmm2, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+912+r8+rcx]
        and       eax, 1
        paddq     xmm1, xmm6
        psubq     xmm2, xmm6
        mulsd     xmm7, xmm5
        ...
        addsd     xmm0, xmm8
        addsd     xmm4, xmm2
        movq      xmm3, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+904+r8+rcx]
        paddq     xmm3, xmm6
        mulsd     xmm7, xmm4
        movdqa    xmm6, xmm1
        addsd     xmm7, xmm3
...
__jsvml_cosh1_ha_ex ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_cosh1_ha_ex_B1_B6:
        DD      1074177
        DD      1430628
        DD      1075292
        DD      1013840
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B7_1
        DD      imagerel _B7_7
        DD      imagerel _unwind___jsvml_cosh1_ha_ex_B1_B6
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_cosh2_ha_ex

__jsvml_cosh2_ha_ex     PROC    EXPORT
...
L162::
        ...
        lea       r13, QWORD PTR [111+rsp]
        movups    xmm10, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+4672]
        and       r13, -64
        movups    xmm6, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+3968]
        andnps    xmm10, xmm12
        mulpd     xmm6, xmm10
        movups    xmm11, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+4160]
        addpd     xmm6, xmm11
        movq      xmm2, QWORD PTR [__jsvml_dcosh_ha_data_internal+4224]
        movq      xmm0, QWORD PTR [__jsvml_dcosh_ha_data_internal+4736]
        ...
        movaps    xmm13, xmm6
        subpd     xmm13, xmm11
        movups    xmm4, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+4032]
        pslld     xmm1, 3
        mulpd     xmm4, xmm13
        movd      edx, xmm1
        movups    xmm3, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+4096]
        psllq     xmm6, 45
        movups    xmm9, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+4544]
        mulpd     xmm3, xmm13
        subpd     xmm10, xmm4
        subpd     xmm10, xmm3
        movaps    xmm3, xmm10
        ...
        mulpd     xmm3, xmm10
        mulpd     xmm9, xmm3
        movups    xmm5, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+4480]
        addpd     xmm9, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+4416]
        mulpd     xmm5, xmm3
        mulpd     xmm9, xmm3
        addpd     xmm5, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+4352]
        mulpd     xmm9, xmm10
        mulpd     xmm3, xmm5
        addpd     xmm10, xmm9
        pshufd    xmm2, xmm1, 1
        movd      ecx, xmm2
        movq      xmm0, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+896+r8+rdx]
        movq      xmm2, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+912+r8+rdx]
        movhpd    xmm0, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+896+r8+rcx]
        pand      xmm6, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+4608]
        movhpd    xmm2, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+912+r8+rcx]
        paddq     xmm0, xmm6
        psubq     xmm2, xmm6
        movaps    xmm4, xmm0
        addpd     xmm4, xmm2
        movq      xmm1, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+904+r8+rdx]
        movhpd    xmm1, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+904+r8+rcx]
        paddq     xmm1, xmm6
        mulpd     xmm4, xmm3
        movaps    xmm6, xmm0
        subpd     xmm6, xmm2
...
__jsvml_cosh2_ha_ex ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_cosh2_ha_ex_B1_B3:
        DD      1069825
        DD      2413651
        DD      813131
        DD      1153091
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B8_1
        DD      imagerel _B8_6
        DD      imagerel _unwind___jsvml_cosh2_ha_ex_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_cosh2_ha_ex_B6_B10:
        DD      265761
        DD      287758
        DD      340999
        DD      imagerel _B8_1
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B8_6
        DD      imagerel _B8_11
        DD      imagerel _unwind___jsvml_cosh2_ha_ex_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_cosh2_ha_e9

__jsvml_cosh2_ha_e9     PROC    EXPORT
...
L181::
        ...
        mov       QWORD PTR [256+rsp], r13
        lea       r13, QWORD PTR [111+rsp]
        vmovupd   xmm5, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+4672]
        and       r13, -64
        vandnpd   xmm0, xmm5, xmm11
        vmulpd    xmm4, xmm0, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+3968]
        vmovupd   xmm3, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+4160]
        vaddpd    xmm12, xmm3, xmm4
        vmovq     xmm1, QWORD PTR [__jsvml_dcosh_ha_data_internal+4224]
        vpshufd   xmm5, xmm12, 136
        vpand     xmm5, xmm5, xmm1
        vpslld    xmm1, xmm5, 1
        vmovq     xmm14, QWORD PTR [__jsvml_dcosh_ha_data_internal+4736]
        ...
        vmovd     eax, xmm2
        vmovmskps edx, xmm13
        vmovq     xmm1, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+896+r8+rax]
        vpextrd   ecx, xmm2, 1
        vmovhpd   xmm5, xmm1, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+896+r8+rcx]
        vsubpd    xmm1, xmm12, xmm3
        vmulpd    xmm3, xmm1, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+4032]
        vmovq     xmm14, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+904+r8+rax]
        vpsllq    xmm12, xmm12, 45
        vmovhpd   xmm2, xmm14, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+904+r8+rcx]
        vsubpd    xmm14, xmm0, xmm3
        vmulpd    xmm0, xmm1, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+4096]
        vsubpd    xmm1, xmm14, xmm0
        vmovq     xmm13, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+912+r8+rax]
        vmovhpd   xmm4, xmm13, QWORD PTR [imagerel(__jsvml_dcosh_ha_data_internal)+912+r8+rcx]
        vpand     xmm3, xmm12, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+4608]
        ...
        vmulpd    xmm13, xmm3, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+4544]
        vaddpd    xmm14, xmm13, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+4416]
        vmulpd    xmm13, xmm3, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+4480]
        vmulpd    xmm14, xmm3, xmm14
        vaddpd    xmm13, xmm13, XMMWORD PTR [__jsvml_dcosh_ha_data_internal+4352]
...
__jsvml_cosh2_ha_e9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_cosh2_ha_e9_B1_B3:
        DD      803329
        DD      2151490
        DD      1030198
        DD      968749
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B9_1
        DD      imagerel _B9_6
        DD      imagerel _unwind___jsvml_cosh2_ha_e9_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_cosh2_ha_e9_B6_B10:
        DD      265761
        DD      287758
        DD      340999
        DD      imagerel _B9_1
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B9_6
        DD      imagerel _B9_11
        DD      imagerel _unwind___jsvml_cosh2_ha_e9_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_dcosh_ha_cout_rare_internal

__jsvml_dcosh_ha_cout_rare_internal     PROC
...
__jsvml_dcosh_ha_cout_rare_internal ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_dcosh_ha_cout_rare_internal_B1_B12:
        DD      535041
        DD      354346
        DD      505893
        DD      444447
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B10_1
        DD      imagerel _B10_13
        DD      imagerel _unwind___jsvml_dcosh_ha_cout_rare_internal_B1_B12
