...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_tanf4_ha_ex

__jsvml_tanf4_ha_ex     PROC    EXPORT
...
L1::
        ...
        movaps    xmm10, xmm7
        movups    xmm4, XMMWORD PTR [__jsvml_stan_ha_data_internal+960]
        ...
        movaps    xmm5, xmm10
        cvtps2pd  xmm2, xmm10
        cmpnleps  xmm5, XMMWORD PTR [__jsvml_stan_ha_data_internal+1216]
        movhlps   xmm3, xmm10
        and       r13, -64
        mulps     xmm10, XMMWORD PTR [__jsvml_stan_ha_data_internal+832]
        cvtps2pd  xmm0, xmm3
        movmskps  eax, xmm5
        movups    xmm1, XMMWORD PTR [__jsvml_stan_ha_data_internal+1088]
        movups    xmm12, XMMWORD PTR [__jsvml_stan_ha_data_internal+1344]
        addps     xmm10, xmm1
        movaps    xmm5, xmm10
        subps     xmm10, xmm1
        ...
        movups    xmm14, XMMWORD PTR [__jsvml_stan_ha_data_internal+1280]
        movaps    xmm13, xmm14
        mulpd     xmm13, xmm11
        mulpd     xmm14, xmm10
        mulpd     xmm11, xmm12
        ...
        subpd     xmm2, xmm11
        subpd     xmm0, xmm10
        movups    xmm13, XMMWORD PTR [__jsvml_stan_ha_data_internal+1472]
        movaps    xmm10, xmm2
        movaps    xmm11, xmm13
        movaps    xmm14, xmm0
        mulpd     xmm10, xmm2
        ...
        addpd     xmm2, xmm11
        addpd     xmm0, xmm13
        movups    xmm11, XMMWORD PTR [__jsvml_stan_ha_data_internal+1664]
        movaps    xmm13, xmm11
        mulpd     xmm13, xmm10
        mulpd     xmm11, xmm14
        movups    xmm12, XMMWORD PTR [__jsvml_stan_ha_data_internal+1600]
        addpd     xmm13, xmm12
        addpd     xmm12, xmm11
        mulpd     xmm10, xmm13
        mulpd     xmm14, xmm12
        movups    xmm11, XMMWORD PTR [__jsvml_stan_ha_data_internal+1536]
        movdqa    xmm12, xmm1
        addpd     xmm10, xmm11
        addpd     xmm11, xmm14
        movdqa    xmm14, xmm1
...
_B1_10::
        ...
        call      __jsvml_stan_ha_cout_rare_internal
        jmp       _B1_8
        ALIGN     16

_B1_11::

__jsvml_tanf4_ha_ex ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_tanf4_ha_ex_B1_B3:
        DD      1069057
        DD      2413648
        DD      817221
        DD      1026109
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B1_1
        DD      imagerel _B1_6
        DD      imagerel _unwind___jsvml_tanf4_ha_ex_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_tanf4_ha_ex_B6_B10:
        DD      265761
        DD      287758
        DD      340999
        DD      imagerel _B1_1
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B1_6
        DD      imagerel _B1_11
        DD      imagerel _unwind___jsvml_tanf4_ha_ex_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_tanf4_ha_e9

__jsvml_tanf4_ha_e9     PROC    EXPORT
...
L20::
        ...
        lea       r13, QWORD PTR [111+rsp]
        vmovups   xmm3, XMMWORD PTR [__jsvml_stan_ha_data_internal+960]
        and       r13, -64
        vandps    xmm14, xmm5, xmm3
        vandnps   xmm3, xmm3, xmm5
        vcmpnleps xmm4, xmm14, XMMWORD PTR [__jsvml_stan_ha_data_internal+1216]
        vcvtps2pd ymm1, xmm14
        vmovups   xmm2, XMMWORD PTR [__jsvml_stan_ha_data_internal+1088]
        vmovmskps edx, xmm4
        vmulps    xmm4, xmm14, XMMWORD PTR [__jsvml_stan_ha_data_internal+832]
        ...
        vmulpd    ymm0, ymm14, YMMWORD PTR [__jsvml_stan_ha_data_internal+1280]
        vmulpd    ymm14, ymm14, YMMWORD PTR [__jsvml_stan_ha_data_internal+1344]
        vsubpd    ymm1, ymm1, ymm0
        vsubpd    ymm14, ymm1, ymm14
        vmulpd    ymm0, ymm14, ymm14
        vmulpd    ymm1, ymm14, YMMWORD PTR [__jsvml_stan_ha_data_internal+1472]
        vmulpd    ymm1, ymm0, ymm1
        vaddpd    ymm1, ymm14, ymm1
        vmulpd    ymm14, ymm0, YMMWORD PTR [__jsvml_stan_ha_data_internal+1664]
        vaddpd    ymm14, ymm14, YMMWORD PTR [__jsvml_stan_ha_data_internal+1600]
        vmulpd    ymm0, ymm0, ymm14
        vaddpd    ymm0, ymm0, YMMWORD PTR [__jsvml_stan_ha_data_internal+1536]
...
__jsvml_tanf4_ha_e9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_tanf4_ha_e9_B1_B3:
        DD      401409
        DD      1758240
        DD      845848
        DD      1900811
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B2_1
        DD      imagerel _B2_6
        DD      imagerel _unwind___jsvml_tanf4_ha_e9_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_tanf4_ha_e9_B6_B10:
        DD      658945
        DD      287758
        DD      340999
        DD      845824
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B2_6
        DD      imagerel _B2_11
        DD      imagerel _unwind___jsvml_tanf4_ha_e9_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_tanf16_ha_z0

__jsvml_tanf16_ha_z0    PROC    EXPORT
...
L29::
        ...
        vmovups   zmm1, ZMMWORD PTR [__jsvml_stan_ha_data_internal]
        and       r13, -64
        vmovups   zmm23, ZMMWORD PTR [__jsvml_stan_ha_data_internal+1088]
        vmovups   zmm24, ZMMWORD PTR [__jsvml_stan_ha_data_internal+64]
        vmovups   zmm26, ZMMWORD PTR [__jsvml_stan_ha_data_internal+256]
        vmovups   zmm27, ZMMWORD PTR [__jsvml_stan_ha_data_internal+320]
        vmovups   zmm3, ZMMWORD PTR [__jsvml_stan_ha_data_internal+768]
        vmovups   zmm2, ZMMWORD PTR [__jsvml_stan_ha_data_internal+704]
        vmovups   zmm4, ZMMWORD PTR [__jsvml_stan_ha_data_internal+384]
        vmovaps   zmm22, zmm0
        vfmadd213ps zmm1, zmm22, zmm23 {rn-sae}
        vmovups   zmm0, ZMMWORD PTR [__jsvml_stan_ha_data_internal+640]
        vandps    zmm31, zmm22, ZMMWORD PTR [__jsvml_stan_ha_data_internal+960]
        vsubps    zmm30, zmm1, zmm23 {rn-sae}
        vpermt2ps zmm4, zmm1, ZMMWORD PTR [__jsvml_stan_ha_data_internal+448]
        vcmpps    k0, zmm31, zmm3, 22 {sae}
        vfnmadd213ps zmm24, zmm30, zmm22 {rn-sae}
        vmovups   zmm3, ZMMWORD PTR [__jsvml_stan_ha_data_internal+512]
        kmovw     r8d, k0
        vpermt2ps zmm3, zmm1, ZMMWORD PTR [__jsvml_stan_ha_data_internal+576]
        vmovaps   zmm25, zmm30
        ...
        vmovups   zmm28, ZMMWORD PTR [__jsvml_stan_ha_data_internal+1152]
...
__jsvml_tanf16_ha_z0 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_tanf16_ha_z0_B1_B9:
        DD      267009
        DD      10867731
        DD      10944779
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B3_1
        DD      imagerel _B3_11
        DD      imagerel _unwind___jsvml_tanf16_ha_z0_B1_B9
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B3_11
        DD      imagerel _B3_16
        DD      imagerel _unwind___jsvml_tanf16_ha_z0_B11_B15
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_tanf8_ha_e9

__jsvml_tanf8_ha_e9     PROC    EXPORT
...
L80::
        ...
        vmovups   ymm11, YMMWORD PTR [__jsvml_stan_ha_data_internal+960]
        and       r13, -64
        vmovaps   ymm13, ymm0
        vandps    ymm12, ymm13, ymm11
        vcmpnle_uqps ymm3, ymm12, YMMWORD PTR [__jsvml_stan_ha_data_internal+1216]
        vandnps   ymm11, ymm11, ymm13
        mov       QWORD PTR [536+rsp], r13
        vextractf128 xmm0, ymm12, 1
        vmulps    ymm10, ymm12, YMMWORD PTR [__jsvml_stan_ha_data_internal+832]
        vcvtps2pd ymm15, xmm0
        vcvtps2pd ymm14, xmm12
        vmovups   ymm0, YMMWORD PTR [__jsvml_stan_ha_data_internal+1088]
        ...
        vmovupd   ymm1, YMMWORD PTR [__jsvml_stan_ha_data_internal+1280]
        ...
        vmovupd   ymm14, YMMWORD PTR [__jsvml_stan_ha_data_internal+1344]
        vmulpd    ymm15, ymm3, ymm14
        vmovupd   ymm3, YMMWORD PTR [__jsvml_stan_ha_data_internal+1472]
        ...
        vmovupd   ymm2, YMMWORD PTR [__jsvml_stan_ha_data_internal+1664]
        vmovupd   ymm1, YMMWORD PTR [__jsvml_stan_ha_data_internal+1600]
        vmulpd    ymm14, ymm2, ymm15
        vmulpd    ymm2, ymm2, ymm0
        vaddpd    ymm14, ymm1, ymm14
        vaddpd    ymm1, ymm1, ymm2
        vmovupd   ymm2, YMMWORD PTR [__jsvml_stan_ha_data_internal+1536]
...
__jsvml_tanf8_ha_e9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_tanf8_ha_e9_B1_B3:
        DD      1068289
        DD      4379725
        DD      2074693
        DD      1947708
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B4_1
        DD      imagerel _B4_6
        DD      imagerel _unwind___jsvml_tanf8_ha_e9_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_tanf8_ha_e9_B6_B10:
        DD      798497
        DD      1336367
        DD      1389605
        DD      170013
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B4_6
        DD      imagerel _B4_11
        DD      imagerel _unwind___jsvml_tanf8_ha_e9_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_tanf4_ha_l9

__jsvml_tanf4_ha_l9     PROC    EXPORT
...
L107::
        ...
        mov       QWORD PTR [288+rsp], r13
        lea       r13, QWORD PTR [111+rsp]
        vmovups   xmm15, XMMWORD PTR [__jsvml_stan_ha_data_internal]
        and       r13, -64
        vmovups   xmm3, XMMWORD PTR [__jsvml_stan_ha_data_internal+1088]
        vfmadd213ps xmm15, xmm0, xmm3
        vmovups   xmm1, XMMWORD PTR [__jsvml_stan_ha_data_internal+64]
        vandps    xmm2, xmm0, XMMWORD PTR [__jsvml_stan_ha_data_internal+960]
        vmovups   xmm4, XMMWORD PTR [__jsvml_stan_ha_data_internal+256]
        vcmpnleps xmm12, xmm2, XMMWORD PTR [__jsvml_stan_ha_data_internal+768]
        ...
        vmovups   xmm2, XMMWORD PTR [__jsvml_stan_ha_data_internal+320]
        vmovd     ecx, xmm11
        ...
        movsxd    rcx, ecx
        vpextrd   eax, xmm11, 1
        vmovd     xmm4, DWORD PTR [imagerel(__jsvml_stan_ha_data_internal)+384+rdx+r9]
        movsxd    rax, eax
        vpinsrd   xmm12, xmm4, DWORD PTR [imagerel(__jsvml_stan_ha_data_internal)+384+rdx+r10], 1
        vmulps    xmm4, xmm9, xmm9
        vfmadd213ps xmm13, xmm2, xmm3
        vmovd     xmm5, DWORD PTR [imagerel(__jsvml_stan_ha_data_internal)+384+rdx+rcx]
        vmovd     xmm2, DWORD PTR [imagerel(__jsvml_stan_ha_data_internal)+512+rdx+rcx]
        vmovd     xmm3, DWORD PTR [imagerel(__jsvml_stan_ha_data_internal)+512+rdx+r9]
        vpinsrd   xmm15, xmm5, DWORD PTR [imagerel(__jsvml_stan_ha_data_internal)+384+rdx+rax], 1
        vsubps    xmm14, xmm1, xmm13
        vpinsrd   xmm1, xmm2, DWORD PTR [imagerel(__jsvml_stan_ha_data_internal)+512+rdx+rax], 1
        vpinsrd   xmm11, xmm3, DWORD PTR [imagerel(__jsvml_stan_ha_data_internal)+512+rdx+r10], 1
        vmovups   xmm5, XMMWORD PTR [__jsvml_stan_ha_data_internal+704]
        vfmadd213ps xmm5, xmm4, XMMWORD PTR [__jsvml_stan_ha_data_internal+640]
        vunpcklpd xmm13, xmm15, xmm12
        vpunpcklqdq xmm12, xmm1, xmm11
        vmulps    xmm2, xmm9, xmm5
        vfnmsub213ps xmm2, xmm4, xmm14
        vmovapd   xmm4, xmm13
        vmovups   xmm1, XMMWORD PTR [__jsvml_stan_ha_data_internal+1152]
        mov       QWORD PTR [296+rsp], r13
...
__jsvml_tanf4_ha_l9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_tanf4_ha_l9_B1_B3:
        DD      1069057
        DD      2413648
        DD      1153096
        DD      1095743
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B5_1
        DD      imagerel _B5_6
        DD      imagerel _unwind___jsvml_tanf4_ha_l9_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_tanf4_ha_l9_B6_B10:
        DD      265761
        DD      287758
        DD      340999
        DD      imagerel _B5_1
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B5_6
        DD      imagerel _B5_11
        DD      imagerel _unwind___jsvml_tanf4_ha_l9_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_tanf8_ha_l9

__jsvml_tanf8_ha_l9     PROC    EXPORT
...
L126::
        ...
        vmovups   ymm15, YMMWORD PTR [__jsvml_stan_ha_data_internal]
        and       r13, -64
        vmovups   ymm4, YMMWORD PTR [__jsvml_stan_ha_data_internal+1088]
        vmovups   ymm2, YMMWORD PTR [__jsvml_stan_ha_data_internal+64]
        vmovups   ymm1, YMMWORD PTR [__jsvml_stan_ha_data_internal+256]
        vfmadd213ps ymm15, ymm0, ymm4
        vsubps    ymm13, ymm15, ymm4
        vfnmadd213ps ymm2, ymm13, ymm0
        vandps    ymm3, ymm0, YMMWORD PTR [__jsvml_stan_ha_data_internal+960]
        vcmpnle_uqps ymm12, ymm3, YMMWORD PTR [__jsvml_stan_ha_data_internal+768]
        vmovups   ymm3, YMMWORD PTR [__jsvml_stan_ha_data_internal+320]
        vmovaps   ymm5, ymm1
        ...
        movsxd    rdx, edx
        movsxd    r15, r15d
        vmovd     xmm5, DWORD PTR [imagerel(__jsvml_stan_ha_data_internal)+384+r10+r11]
        vmovd     xmm1, DWORD PTR [imagerel(__jsvml_stan_ha_data_internal)+384+r10+r8]
        vmovd     xmm2, DWORD PTR [imagerel(__jsvml_stan_ha_data_internal)+384+r10+rcx]
        vmovd     xmm13, DWORD PTR [imagerel(__jsvml_stan_ha_data_internal)+384+r10+rax]
        vpinsrd   xmm15, xmm5, DWORD PTR [imagerel(__jsvml_stan_ha_data_internal)+384+r10+r9], 1
        vpinsrd   xmm12, xmm1, DWORD PTR [imagerel(__jsvml_stan_ha_data_internal)+384+r10+rsi], 1
        vpinsrd   xmm5, xmm2, DWORD PTR [imagerel(__jsvml_stan_ha_data_internal)+384+r10+rdx], 1
        vpinsrd   xmm1, xmm13, DWORD PTR [imagerel(__jsvml_stan_ha_data_internal)+384+r10+r15], 1
        vpunpcklqdq xmm3, xmm15, xmm12
        vmovd     xmm12, DWORD PTR [imagerel(__jsvml_stan_ha_data_internal)+512+r10+r11]
        vpunpcklqdq xmm15, xmm5, xmm1
        vpinsrd   xmm4, xmm12, DWORD PTR [imagerel(__jsvml_stan_ha_data_internal)+512+r10+r9], 1
        vmovd     xmm5, DWORD PTR [imagerel(__jsvml_stan_ha_data_internal)+512+r10+rcx]
        vmovd     xmm1, DWORD PTR [imagerel(__jsvml_stan_ha_data_internal)+512+r10+rax]
        vpinsrd   xmm12, xmm1, DWORD PTR [imagerel(__jsvml_stan_ha_data_internal)+512+r10+r15], 1
        vinsertf128 ymm13, ymm3, xmm15, 1
        vmovd     xmm3, DWORD PTR [imagerel(__jsvml_stan_ha_data_internal)+512+r10+r8]
        vpinsrd   xmm2, xmm3, DWORD PTR [imagerel(__jsvml_stan_ha_data_internal)+512+r10+rsi], 1
        vpinsrd   xmm15, xmm5, DWORD PTR [imagerel(__jsvml_stan_ha_data_internal)+512+r10+rdx], 1
        vpunpcklqdq xmm11, xmm4, xmm2
        vmulps    ymm2, ymm10, ymm10
        vmovups   ymm4, YMMWORD PTR [__jsvml_stan_ha_data_internal+704]
        vpunpcklqdq xmm3, xmm15, xmm12
        vfmadd213ps ymm4, ymm2, YMMWORD PTR [__jsvml_stan_ha_data_internal+640]
        vmovaps   ymm1, ymm13
        vinsertf128 ymm12, ymm11, xmm3, 1
        vmulps    ymm3, ymm10, ymm4
        vfnmsub213ps ymm3, ymm2, ymm14
        vmovups   ymm2, YMMWORD PTR [__jsvml_stan_ha_data_internal+1152]
...
__jsvml_tanf8_ha_l9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_tanf8_ha_l9_B1_B3:
        DD      1266689
        DD      4248660
        DD      2009164
        DD      1882179
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B6_1
        DD      imagerel _B6_6
        DD      imagerel _unwind___jsvml_tanf8_ha_l9_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_tanf8_ha_l9_B6_B10:
        DD      531745
        DD      170013
        DD      296983
        DD      423953
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B6_6
        DD      imagerel _B6_11
        DD      imagerel _unwind___jsvml_tanf8_ha_l9_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_stan_ha_cout_rare_internal

__jsvml_stan_ha_cout_rare_internal      PROC
...
__jsvml_stan_ha_cout_rare_internal ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_stan_ha_cout_rare_internal_B1_B20:
        DD      621498113
        DD      497743
        DD      649290
        DD      587845
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B7_1
        DD      imagerel _B7_21
        DD      imagerel _unwind___jsvml_stan_ha_cout_rare_internal_B1_B20
