...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_hypot2_ha_e9

__jsvml_hypot2_ha_e9    PROC    EXPORT
...
L1::
        ...
        vmovupd   xmm4, XMMWORD PTR [__jsvml_dhypot_ha_data_internal+64]
        and       r13, -64
        ...
        vmovq     xmm5, QWORD PTR [__jsvml_dhypot_ha_data_internal+512]
        vpsubd    xmm14, xmm14, xmm15
        vpcmpgtd  xmm5, xmm14, xmm5
        vmovupd   xmm11, XMMWORD PTR [__jsvml_dhypot_ha_data_internal]
        ...
        vmovq     xmm3, QWORD PTR [__jsvml_dhypot_ha_data_internal+640]
        vpshufd   xmm1, xmm2, 221
        vpcmpgtd  xmm14, xmm1, xmm3
        vcvtpd2ps xmm3, xmm2
        vmovq     xmm11, QWORD PTR [__jsvml_dhypot_ha_data_internal+576]
        ...
        vsubpd    xmm3, xmm11, XMMWORD PTR [__jsvml_dhypot_ha_data_internal+128]
        vmulpd    xmm15, xmm14, xmm15
        vaddpd    xmm11, xmm3, xmm4
        vmulpd    xmm5, xmm14, xmm5
        vmulpd    xmm1, xmm11, XMMWORD PTR [__jsvml_dhypot_ha_data_internal+192]
        vaddpd    xmm3, xmm1, XMMWORD PTR [__jsvml_dhypot_ha_data_internal+256]
        vmulpd    xmm4, xmm11, xmm3
        vaddpd    xmm1, xmm4, XMMWORD PTR [__jsvml_dhypot_ha_data_internal+320]
        vmulpd    xmm3, xmm11, xmm1
        vaddpd    xmm4, xmm3, XMMWORD PTR [__jsvml_dhypot_ha_data_internal+384]
        vmulpd    xmm1, xmm11, xmm4
        vaddpd    xmm3, xmm1, XMMWORD PTR [__jsvml_dhypot_ha_data_internal+448]
...
_B1_10::
        ...
        call      __jsvml_dhypot_ha_cout_rare_internal
        jmp       _B1_8
        ALIGN     16

_B1_11::

__jsvml_hypot2_ha_e9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_hypot2_ha_e9_B1_B3:
        DD      801537
        DD      2675771
        DD      1222703
        DD      1292326
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B1_1
        DD      imagerel _B1_6
        DD      imagerel _unwind___jsvml_hypot2_ha_e9_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_hypot2_ha_e9_B6_B10:
        DD      265761
        DD      287758
        DD      340999
        DD      imagerel _B1_1
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B1_6
        DD      imagerel _B1_11
        DD      imagerel _unwind___jsvml_hypot2_ha_e9_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_hypot4_ha_e9

__jsvml_hypot4_ha_e9    PROC    EXPORT
...
L16::
        ...
        vmovupd   ymm2, YMMWORD PTR [__jsvml_dhypot_ha_data_internal+64]
        and       r13, -64
        vmovapd   ymm14, ymm1
        ...
        vpcmpgtd  xmm15, xmm2, XMMWORD PTR [__jsvml_dhypot_ha_data_internal+512]
        ...
        vmovups   xmm1, XMMWORD PTR [__jsvml_dhypot_ha_data_internal+576]
        vaddpd    ymm5, ymm5, ymm3
        vaddpd    ymm3, ymm12, ymm5
        vextractf128 xmm15, ymm3, 1
        vshufps   xmm6, xmm3, xmm15, 221
        vpcmpgtd  xmm15, xmm6, XMMWORD PTR [__jsvml_dhypot_ha_data_internal+640]
        ...
        vsubpd    ymm15, ymm2, YMMWORD PTR [__jsvml_dhypot_ha_data_internal+128]
        vaddpd    ymm15, ymm15, ymm1
        vmulpd    ymm2, ymm15, YMMWORD PTR [__jsvml_dhypot_ha_data_internal+192]
        vaddpd    ymm6, ymm2, YMMWORD PTR [__jsvml_dhypot_ha_data_internal+256]
        vmulpd    ymm1, ymm15, ymm6
        vaddpd    ymm2, ymm1, YMMWORD PTR [__jsvml_dhypot_ha_data_internal+320]
        vmulpd    ymm6, ymm15, ymm2
        vaddpd    ymm1, ymm6, YMMWORD PTR [__jsvml_dhypot_ha_data_internal+384]
        vmulpd    ymm2, ymm15, ymm1
        vaddpd    ymm6, ymm2, YMMWORD PTR [__jsvml_dhypot_ha_data_internal+448]
...
__jsvml_hypot4_ha_e9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_hypot4_ha_e9_B1_B3:
        DD      800513
        DD      4903991
        DD      2189359
        DD      2344998
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B2_1
        DD      imagerel _B2_6
        DD      imagerel _unwind___jsvml_hypot4_ha_e9_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_hypot4_ha_e9_B6_B10:
        DD      1065249
        DD      1860673
        DD      1913911
        DD      186415
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B2_6
        DD      imagerel _B2_11
        DD      imagerel _unwind___jsvml_hypot4_ha_e9_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_hypot1_ha_l9

__jsvml_hypot1_ha_l9    PROC    EXPORT
...
L43::
        ...
        vmovsd    xmm1, QWORD PTR [__jsvml_dhypot_ha_data_internal+64]
        and       r13, -64
        ...
        vmovsd    xmm3, QWORD PTR [__jsvml_dhypot_ha_data_internal+192]
        ...
        vfmsub213sd xmm9, xmm7, QWORD PTR [__jsvml_dhypot_ha_data_internal+128]
        vfmadd213sd xmm10, xmm7, xmm9
        vfmadd213sd xmm3, xmm10, QWORD PTR [__jsvml_dhypot_ha_data_internal+256]
        vfmadd213sd xmm3, xmm10, QWORD PTR [__jsvml_dhypot_ha_data_internal+320]
        vfmadd213sd xmm3, xmm10, QWORD PTR [__jsvml_dhypot_ha_data_internal+384]
        vfmadd213sd xmm3, xmm10, QWORD PTR [__jsvml_dhypot_ha_data_internal+448]
...
__jsvml_hypot1_ha_l9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_hypot1_ha_l9_B1_B6:
        DD      939777
        DD      1954903
        DD      1009743
        DD      1275969
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B3_1
        DD      imagerel _B3_7
        DD      imagerel _unwind___jsvml_hypot1_ha_l9_B1_B6
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_hypot2_ha_l9

__jsvml_hypot2_ha_l9    PROC    EXPORT
...
L56::
        ...
        lea       r13, QWORD PTR [111+rsp]
        vmovupd   xmm2, XMMWORD PTR [__jsvml_dhypot_ha_data_internal+64]
        and       r13, -64
        ...
        vmovq     xmm14, QWORD PTR [__jsvml_dhypot_ha_data_internal+512]
        ...
        vmovq     xmm2, QWORD PTR [__jsvml_dhypot_ha_data_internal+576]
        vmovq     xmm1, QWORD PTR [__jsvml_dhypot_ha_data_internal+640]
        vmovupd   xmm6, XMMWORD PTR [__jsvml_dhypot_ha_data_internal+128]
        vmovupd   xmm5, XMMWORD PTR [__jsvml_dhypot_ha_data_internal+192]
        ...
        vfmadd213pd xmm5, xmm6, XMMWORD PTR [__jsvml_dhypot_ha_data_internal+256]
        vfmadd213pd xmm5, xmm6, XMMWORD PTR [__jsvml_dhypot_ha_data_internal+320]
        vfmadd213pd xmm5, xmm6, XMMWORD PTR [__jsvml_dhypot_ha_data_internal+384]
        vfmadd213pd xmm5, xmm6, XMMWORD PTR [__jsvml_dhypot_ha_data_internal+448]
...
__jsvml_hypot2_ha_l9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_hypot2_ha_l9_B1_B3:
        DD      1068289
        DD      2937933
        DD      1075269
        DD      1345592
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B4_1
        DD      imagerel _B4_6
        DD      imagerel _unwind___jsvml_hypot2_ha_l9_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_hypot2_ha_l9_B6_B10:
        DD      265761
        DD      287758
        DD      340999
        DD      imagerel _B4_1
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B4_6
        DD      imagerel _B4_11
        DD      imagerel _unwind___jsvml_hypot2_ha_l9_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_hypot4_ha_l9

__jsvml_hypot4_ha_l9    PROC    EXPORT
...
L75::
        ...
        vmovupd   ymm5, YMMWORD PTR [__jsvml_dhypot_ha_data_internal+64]
        and       r13, -64
        vmovupd   ymm2, YMMWORD PTR [__jsvml_dhypot_ha_data_internal]
        vmovupd   ymm12, YMMWORD PTR [__jsvml_dhypot_ha_data_internal+128]
        vmovupd   ymm14, YMMWORD PTR [__jsvml_dhypot_ha_data_internal+192]
        vmovdqa   ymm10, ymm0
        ...
        vpcmpgtd  xmm8, xmm0, XMMWORD PTR [__jsvml_dhypot_ha_data_internal+512]
        ...
        vmovups   xmm2, XMMWORD PTR [__jsvml_dhypot_ha_data_internal+576]
        vaddpd    ymm3, ymm0, ymm8
        vextracti128 xmm4, ymm3, 1
        vshufps   xmm5, xmm3, xmm4, 221
        vpcmpgtd  xmm4, xmm5, XMMWORD PTR [__jsvml_dhypot_ha_data_internal+640]
        ...
        vfmadd213pd ymm14, ymm12, YMMWORD PTR [__jsvml_dhypot_ha_data_internal+256]
        vfmadd213pd ymm14, ymm12, YMMWORD PTR [__jsvml_dhypot_ha_data_internal+320]
        vfmadd213pd ymm14, ymm12, YMMWORD PTR [__jsvml_dhypot_ha_data_internal+384]
        vfmadd213pd ymm14, ymm12, YMMWORD PTR [__jsvml_dhypot_ha_data_internal+448]
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B5_1
        DD      imagerel _B5_6
        DD      imagerel _unwind___jsvml_hypot4_ha_l9_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_hypot4_ha_l9_B6_B10:
        DD      931873
        DD      1598520
        DD      1651758
        DD      194598
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B5_6
        DD      imagerel _B5_11
        DD      imagerel _unwind___jsvml_hypot4_ha_l9_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_hypot2_ha_ex

__jsvml_hypot2_ha_ex    PROC    EXPORT
...
L102::
        ...
        lea       r13, QWORD PTR [111+rsp]
        movups    xmm9, XMMWORD PTR [__jsvml_dhypot_ha_data_internal+64]
        and       r13, -64
        movaps    xmm3, xmm9
        andps     xmm9, xmm1
        andps     xmm3, xmm14
        ...
        movq      xmm2, QWORD PTR [__jsvml_dhypot_ha_data_internal+512]
        psubd     xmm3, xmm0
        pcmpgtd   xmm3, xmm2
        movaps    xmm0, xmm9
        movups    xmm5, XMMWORD PTR [__jsvml_dhypot_ha_data_internal]
        pshufd    xmm2, xmm3, 80
        movaps    xmm4, xmm5
        andnps    xmm2, xmm5
        andps     xmm4, xmm10
        ...
        movlhps   xmm9, xmm9
        rsqrtps   xmm10, xmm9
        movq      xmm5, QWORD PTR [__jsvml_dhypot_ha_data_internal+576]
        movq      xmm4, QWORD PTR [__jsvml_dhypot_ha_data_internal+640]
        ...
        mulpd     xmm4, xmm2
        mulpd     xmm2, xmm6
        subpd     xmm4, XMMWORD PTR [__jsvml_dhypot_ha_data_internal+128]
        mulpd     xmm6, xmm5
        addpd     xmm4, xmm2
        movups    xmm13, XMMWORD PTR [__jsvml_dhypot_ha_data_internal+192]
        mulpd     xmm13, xmm4
        addpd     xmm13, XMMWORD PTR [__jsvml_dhypot_ha_data_internal+256]
        mulpd     xmm13, xmm4
        addpd     xmm13, XMMWORD PTR [__jsvml_dhypot_ha_data_internal+320]
        mulpd     xmm13, xmm4
        addpd     xmm13, XMMWORD PTR [__jsvml_dhypot_ha_data_internal+384]
        mulpd     xmm13, xmm4
        addpd     xmm13, XMMWORD PTR [__jsvml_dhypot_ha_data_internal+448]
        mulpd     xmm4, xmm13
        mulpd     xmm4, xmm5
        mulpd     xmm5, xmm3
        mulpd     xmm0, xmm4
...
__jsvml_hypot2_ha_ex ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_hypot2_ha_ex_B1_B3:
        DD      934657
        DD      2806851
        DD      1140795
        DD      1349683
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B6_1
        DD      imagerel _B6_6
        DD      imagerel _unwind___jsvml_hypot2_ha_ex_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_hypot2_ha_ex_B6_B10:
        DD      265761
        DD      287758
        DD      340999
        DD      imagerel _B6_1
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_hypot1_ha_ex

__jsvml_hypot1_ha_ex    PROC    EXPORT
...
L119::
        ...
        mov       QWORD PTR [232+rsp], r13
        lea       r13, QWORD PTR [95+rsp]
        movsd     xmm12, QWORD PTR [__jsvml_dhypot_ha_data_internal+64]
        and       r13, -64
        movaps    xmm5, xmm12
        andps     xmm12, xmm2
        andps     xmm5, xmm0
        ...
        movd      xmm4, ecx
        addsd     xmm5, xmm9
        movsd     xmm1, QWORD PTR [__jsvml_dhypot_ha_data_internal+192]
        addsd     xmm3, xmm5
        ...
        mulsd     xmm12, xmm11
        mulsd     xmm4, xmm11
        subsd     xmm12, QWORD PTR [__jsvml_dhypot_ha_data_internal+128]
        mov       QWORD PTR [320+rsp], r13
        addsd     xmm4, xmm12
        mulsd     xmm1, xmm4
        addsd     xmm1, QWORD PTR [__jsvml_dhypot_ha_data_internal+256]
        mulsd     xmm1, xmm4
        addsd     xmm1, QWORD PTR [__jsvml_dhypot_ha_data_internal+320]
        mulsd     xmm1, xmm4
        addsd     xmm1, QWORD PTR [__jsvml_dhypot_ha_data_internal+384]
        mulsd     xmm1, xmm4
        addsd     xmm1, QWORD PTR [__jsvml_dhypot_ha_data_internal+448]
        mulsd     xmm1, xmm4
        mulsd     xmm1, xmm13
        mulsd     xmm1, xmm3
        addsd     xmm5, xmm1
...
__jsvml_hypot1_ha_ex ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_hypot1_ha_ex_B1_B6:
        DD      939521
        DD      1954902
        DD      1280074
        DD      1087553
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B7_1
        DD      imagerel _B7_7
        DD      imagerel _unwind___jsvml_hypot1_ha_ex_B1_B6
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_hypot8_ha_z0

__jsvml_hypot8_ha_z0    PROC    EXPORT
...
L132::
        ...
        vmovups   zmm23, ZMMWORD PTR [__jsvml_dhypot_ha_data_internal+832]
        vandpd    zmm22, zmm5, ZMMWORD PTR [__jsvml_dhypot_ha_data_internal+64]
        vpcmpq    k0, zmm22, ZMMWORD PTR [__jsvml_dhypot_ha_data_internal+704], 5
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B8_1
        DD      imagerel _B8_11
        DD      imagerel _unwind___jsvml_hypot8_ha_z0_B1_B9
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B8_11
        DD      imagerel _B8_16
        DD      imagerel _unwind___jsvml_hypot8_ha_z0_B11_B15
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_hypot1_ha_e9

__jsvml_hypot1_ha_e9    PROC    EXPORT
...
L183::
        ...
        mov       QWORD PTR [232+rsp], r13
        lea       r13, QWORD PTR [95+rsp]
        vmovsd    xmm4, QWORD PTR [__jsvml_dhypot_ha_data_internal+64]
        and       r13, -64
        vandpd    xmm5, xmm0, xmm4
        ...
        vmovd     xmm14, ecx
        vmovd     xmm4, edx
        vmovsd    xmm1, QWORD PTR [__jsvml_dhypot_ha_data_internal+192]
        ...
        vsubsd    xmm15, xmm4, QWORD PTR [__jsvml_dhypot_ha_data_internal+128]
        vmulsd    xmm2, xmm2, xmm5
        vaddsd    xmm4, xmm14, xmm15
        vmulsd    xmm1, xmm1, xmm4
        vaddsd    xmm1, xmm1, QWORD PTR [__jsvml_dhypot_ha_data_internal+256]
        vmulsd    xmm13, xmm1, xmm4
        vaddsd    xmm14, xmm13, QWORD PTR [__jsvml_dhypot_ha_data_internal+320]
        vmulsd    xmm15, xmm14, xmm4
        vaddsd    xmm1, xmm15, QWORD PTR [__jsvml_dhypot_ha_data_internal+384]
        vmulsd    xmm13, xmm1, xmm4
        vaddsd    xmm14, xmm13, QWORD PTR [__jsvml_dhypot_ha_data_internal+448]
...
__jsvml_hypot1_ha_e9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_hypot1_ha_e9_B1_B6:
        DD      938753
        DD      1954899
        DD      1288267
        DD      1226818
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B9_1
        DD      imagerel _B9_7
        DD      imagerel _unwind___jsvml_hypot1_ha_e9_B1_B6
...
__jsvml_dhypot_ha_cout_rare_internal    PROC
...
__jsvml_dhypot_ha_cout_rare_internal ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_dhypot_ha_cout_rare_internal_B1_B22:
        DD      403713
        DD      256041
        DD      194595
        DD      3221680653
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B10_1
        DD      imagerel _B10_25
        DD      imagerel _unwind___jsvml_dhypot_ha_cout_rare_internal_B1_B22
