...
class Events : AllStatic {
 ...
 public:
  ...
  ATTRIBUTE_PRINTF(2, 3) static void log_memprotect(Thread* thread, const char* format, ...);

  ATTRIBUTE_PRINTF(2, 3) static void log_nmethod_flush(Thread* thread, const char* format, ...);
