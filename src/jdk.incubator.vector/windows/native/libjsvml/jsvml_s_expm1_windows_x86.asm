...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_expm1f4_ha_e9

__jsvml_expm1f4_ha_e9   PROC    EXPORT
...
L1::
        ...
        vmovups   xmm4, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+1280]
        and       r13, -64
        vandps    xmm11, xmm10, xmm4
        vmulps    xmm14, xmm10, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+768]
        vcmpnleps xmm13, xmm11, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+1344]
        vroundps  xmm14, xmm14, 0
        vmovmskps edx, xmm13
        vaddps    xmm13, xmm14, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+960]
        vmulps    xmm5, xmm14, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+832]
        vmulps    xmm2, xmm14, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+896]
        vsubps    xmm3, xmm10, xmm5
        vandps    xmm12, xmm13, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+1024]
        ...
        movsxd    r9, r9d
        movsxd    r10, r10d
        vmovq     xmm14, QWORD PTR [imagerel(__jsvml_sexpm1_ha_data_internal)+rax+rcx]
        vmovq     xmm15, QWORD PTR [imagerel(__jsvml_sexpm1_ha_data_internal)+rax+r8]
        vmovq     xmm11, QWORD PTR [imagerel(__jsvml_sexpm1_ha_data_internal)+rax+r9]
        vmovq     xmm12, QWORD PTR [imagerel(__jsvml_sexpm1_ha_data_internal)+rax+r10]
        vunpcklps xmm15, xmm14, xmm15
        vunpcklps xmm11, xmm11, xmm12
        vandps    xmm13, xmm13, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+1088]
        ...
        vmulps    xmm15, xmm1, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+512]
        vmulps    xmm12, xmm1, xmm1
        vaddps    xmm14, xmm15, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+576]
        vorps     xmm1, xmm0, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+1152]
        vandps    xmm0, xmm3, xmm1
        vmulps    xmm14, xmm14, xmm12
        vsubps    xmm3, xmm3, xmm0
        vmulps    xmm15, xmm13, xmm0
        vsubps    xmm2, xmm3, xmm2
        vmovups   xmm3, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+1216]
...
_B1_10::
        ...
        call      __jsvml_sexpm1_ha_cout_rare_internal
        jmp       _B1_8
        ALIGN     16

_B1_11::

__jsvml_expm1f4_ha_e9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_expm1f4_ha_e9_B1_B3:
        DD      1070081
        DD      2413652
        DD      1157192
        DD      1095743
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B1_1
        DD      imagerel _B1_6
        DD      imagerel _unwind___jsvml_expm1f4_ha_e9_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_expm1f4_ha_e9_B6_B10:
        DD      265761
        DD      287758
        DD      340999
        DD      imagerel _B1_1
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B1_6
        DD      imagerel _B1_11
        DD      imagerel _unwind___jsvml_expm1f4_ha_e9_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_expm1f4_ha_ex

__jsvml_expm1f4_ha_ex   PROC    EXPORT
...
L20::
        ...
        mov       QWORD PTR [288+rsp], r13
        lea       r13, QWORD PTR [111+rsp]
        movups    xmm6, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+768]
        and       r13, -64
        mulps     xmm6, xmm9
        movups    xmm5, XMMWORD PTR [_2il0floatpacket_29]
        movups    xmm14, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+1280]
        addps     xmm6, xmm5
        andps     xmm1, xmm14
        movaps    xmm8, xmm14
        cmpnleps  xmm1, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+1344]
        subps     xmm6, xmm5
        movmskps  edx, xmm1
        movups    xmm1, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+960]
        movaps    xmm5, xmm9
        movups    xmm2, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+832]
        andnps    xmm8, xmm9
        mulps     xmm2, xmm6
        addps     xmm1, xmm6
        movdqu    xmm15, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+1024]
        subps     xmm5, xmm2
        pand      xmm15, xmm1
        movaps    xmm3, xmm5
        pshufd    xmm4, xmm15, 1
        ...
        movd      r8d, xmm4
        movups    xmm0, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+896]
        pand      xmm1, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+1088]
        movd      r9d, xmm2
        pslld     xmm1, 14
        movd      r10d, xmm15
        mulps     xmm0, xmm6
        ...
        movsxd    r9, r9d
        movsxd    r10, r10d
        movq      xmm6, QWORD PTR [imagerel(__jsvml_sexpm1_ha_data_internal)+rax+rcx]
        movq      xmm4, QWORD PTR [imagerel(__jsvml_sexpm1_ha_data_internal)+rax+r8]
        movq      xmm2, QWORD PTR [imagerel(__jsvml_sexpm1_ha_data_internal)+rax+r9]
        movq      xmm15, QWORD PTR [imagerel(__jsvml_sexpm1_ha_data_internal)+rax+r10]
        unpcklps  xmm6, xmm4
        unpcklps  xmm2, xmm15
        movaps    xmm4, xmm6
        movlhps   xmm4, xmm2
        ...
        orps      xmm4, xmm1
        movups    xmm2, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+512]
        mulps     xmm2, xmm3
        mulps     xmm3, xmm3
        mulps     xmm6, xmm1
        addps     xmm2, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+576]
        orps      xmm7, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+1152]
        movaps    xmm1, xmm4
        andps     xmm7, xmm5
        movups    xmm15, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+1216]
        subps     xmm5, xmm7
        mulps     xmm2, xmm3
        mulps     xmm1, xmm7
        subps     xmm5, xmm0
...
__jsvml_expm1f4_ha_ex ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_expm1f4_ha_ex_B1_B3:
        DD      1070593
        DD      2413654
        DD      1009742
        DD      948294
...
.xdata  SEGMENT  DWORD   READ  ''
        ...
        ALIGN 004H
_unwind___jsvml_expm1f4_ha_ex_B6_B10:
        DD      265761
        DD      287758
        DD      340999
        DD      imagerel _B2_1
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B2_6
        DD      imagerel _B2_11
        DD      imagerel _unwind___jsvml_expm1f4_ha_ex_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_expm1f8_ha_l9

__jsvml_expm1f8_ha_l9   PROC    EXPORT
...
L39::
        ...
        vmovdqa   ymm13, ymm0
        and       r13, -64
        vmulps    ymm1, ymm13, YMMWORD PTR [__jsvml_sexpm1_ha_data_internal+768]
        vmovups   ymm10, YMMWORD PTR [__jsvml_sexpm1_ha_data_internal+832]
        vmovups   ymm11, YMMWORD PTR [__jsvml_sexpm1_ha_data_internal+1280]
        vroundps  ymm6, ymm1, 0
        vaddps    ymm2, ymm6, YMMWORD PTR [__jsvml_sexpm1_ha_data_internal+960]
        vmulps    ymm9, ymm6, YMMWORD PTR [__jsvml_sexpm1_ha_data_internal+896]
        vfnmadd213ps ymm10, ymm6, ymm13
        vandps    ymm4, ymm2, YMMWORD PTR [__jsvml_sexpm1_ha_data_internal+1024]
        vandps    ymm3, ymm13, ymm11
        vcmpnle_uqps ymm5, ymm3, YMMWORD PTR [__jsvml_sexpm1_ha_data_internal+1344]
        vcmpeqps  ymm7, ymm10, ymm13
        vsubps    ymm8, ymm10, ymm9
        vandps    ymm2, ymm2, YMMWORD PTR [__jsvml_sexpm1_ha_data_internal+1088]
        vmovmskps edx, ymm5
        vpslld    ymm2, ymm2, 14
        test      edx, edx
        vorps     ymm7, ymm7, YMMWORD PTR [__jsvml_sexpm1_ha_data_internal+1152]
        ...
        movsxd    r9, r9d
        vmovd     r11d, xmm6
        vmovq     xmm15, QWORD PTR [imagerel(__jsvml_sexpm1_ha_data_internal)+rax+rcx]
        vmovq     xmm0, QWORD PTR [imagerel(__jsvml_sexpm1_ha_data_internal)+rax+r8]
        vpextrd   r10d, xmm4, 3
        vmovq     xmm14, QWORD PTR [imagerel(__jsvml_sexpm1_ha_data_internal)+rax+r9]
        vpextrd   ecx, xmm6, 1
        vpextrd   r8d, xmm6, 2
        vpextrd   r9d, xmm6, 3
        movsxd    r10, r10d
        ...
        movsxd    r8, r8d
        movsxd    r9, r9d
        vmovq     xmm1, QWORD PTR [imagerel(__jsvml_sexpm1_ha_data_internal)+rax+r10]
        vmovq     xmm3, QWORD PTR [imagerel(__jsvml_sexpm1_ha_data_internal)+rax+r11]
        vmovq     xmm4, QWORD PTR [imagerel(__jsvml_sexpm1_ha_data_internal)+rax+rcx]
        vmovq     xmm5, QWORD PTR [imagerel(__jsvml_sexpm1_ha_data_internal)+rax+r8]
        vmovq     xmm6, QWORD PTR [imagerel(__jsvml_sexpm1_ha_data_internal)+rax+r9]
        ...
        vmovups   ymm2, YMMWORD PTR [__jsvml_sexpm1_ha_data_internal+512]
        vmovups   ymm1, YMMWORD PTR [__jsvml_sexpm1_ha_data_internal+1216]
        vfmadd213ps ymm2, ymm8, YMMWORD PTR [__jsvml_sexpm1_ha_data_internal+576]
...
__jsvml_expm1f8_ha_l9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_expm1f8_ha_l9_B1_B3:
        DD      1602561
        DD      4379764
        DD      2058348
        DD      1931363
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B3_1
        DD      imagerel _B3_6
        DD      imagerel _unwind___jsvml_expm1f8_ha_l9_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_expm1f8_ha_l9_B6_B10:
        DD      265761
        DD      287758
        DD      340999
        DD      imagerel _B3_1
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B3_6
        DD      imagerel _B3_11
        DD      imagerel _unwind___jsvml_expm1f8_ha_l9_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_expm1f16_ha_z0

__jsvml_expm1f16_ha_z0  PROC    EXPORT
...
L66::
        ...
        vmovups   zmm23, ZMMWORD PTR [__jsvml_sexpm1_ha_data_internal_avx512+128]
        and       r13, -64
        vmovups   zmm22, ZMMWORD PTR [__jsvml_sexpm1_ha_data_internal_avx512+192]
        vmovups   zmm24, ZMMWORD PTR [__jsvml_sexpm1_ha_data_internal_avx512+384]
        vmovups   zmm27, ZMMWORD PTR [__jsvml_sexpm1_ha_data_internal_avx512+512]
        vmovups   zmm25, ZMMWORD PTR [__jsvml_sexpm1_ha_data_internal_avx512+448]
        vmovups   zmm5, ZMMWORD PTR [__jsvml_sexpm1_ha_data_internal_avx512+256]
        vmovaps   zmm4, zmm0
        vfmadd213ps zmm23, zmm4, zmm22 {rn-sae}
        vmovups   zmm0, ZMMWORD PTR [__jsvml_sexpm1_ha_data_internal_avx512+576]
        vcmpps    k0, zmm4, zmm5, 21 {sae}
        vmovups   zmm5, ZMMWORD PTR [__jsvml_sexpm1_ha_data_internal_avx512+640]
        vsubps    zmm26, zmm23, zmm22 {rn-sae}
        vpermps   zmm28, zmm23, ZMMWORD PTR [__jsvml_sexpm1_ha_data_internal_avx512]
        vpermps   zmm3, zmm23, ZMMWORD PTR [__jsvml_sexpm1_ha_data_internal_avx512+64]
        vfnmadd213ps zmm24, zmm26, zmm4 {rn-sae}
        vmovups   zmm22, ZMMWORD PTR [__jsvml_sexpm1_ha_data_internal_avx512+768]
        ...
        vmovups   zmm25, ZMMWORD PTR [__jsvml_sexpm1_ha_data_internal_avx512+832]
        vmovups   zmm26, ZMMWORD PTR [__jsvml_sexpm1_ha_data_internal_avx512+896]
        vmulps    zmm30, zmm1, zmm1 {rn-sae}
        vcmpps    k1, zmm2, zmm25, 17 {sae}
        vandps    zmm23, zmm31, zmm0
        vaddps    zmm31, zmm2, zmm26 {rn-sae}
        vmovups   zmm0, ZMMWORD PTR [__jsvml_sexpm1_ha_data_internal_avx512+704]
        ...
        vpternlogd zmm0, zmm4, ZMMWORD PTR [__jsvml_sexpm1_ha_data_internal_avx512+320], 248
        test      r8d, r8d
        jne       _B4_3
...
__jsvml_expm1f16_ha_z0 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_expm1f16_ha_z0_B1_B9:
        DD      267009
        DD      10867731
        DD      10944779
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B4_1
        DD      imagerel _B4_11
        DD      imagerel _unwind___jsvml_expm1f16_ha_z0_B1_B9
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B4_11
        DD      imagerel _B4_16
        DD      imagerel _unwind___jsvml_expm1f16_ha_z0_B11_B15
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_expm1f4_ha_l9

__jsvml_expm1f4_ha_l9   PROC    EXPORT
...
L117::
        ...
        vmulps    xmm12, xmm6, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+768]
        vcmpnleps xmm13, xmm11, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+1344]
        vroundps  xmm12, xmm12, 0
        vmovmskps edx, xmm13
        vaddps    xmm13, xmm12, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+960]
        vmulps    xmm3, xmm12, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+896]
        vmovups   xmm2, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+832]
        ...
        vorps     xmm15, xmm0, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+1152]
        vandps    xmm15, xmm2, xmm15
        vmovups   xmm13, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+512]
        vsubps    xmm2, xmm2, xmm15
        vfmadd213ps xmm13, xmm1, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+576]
        vmulps    xmm1, xmm1, xmm1
        vmulps    xmm14, xmm12, xmm15
        vsubps    xmm3, xmm2, xmm3
        vmovups   xmm0, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+1216]
...
__jsvml_expm1f4_ha_l9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_expm1f4_ha_l9_B1_B3:
        DD      1070081
        DD      2413652
        DD      813128
        DD      1161279
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B5_1
        DD      imagerel _B5_6
        DD      imagerel _unwind___jsvml_expm1f4_ha_l9_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_expm1f4_ha_l9_B6_B10:
        DD      265761
        DD      287758
        DD      340999
        DD      imagerel _B5_1
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B5_6
        DD      imagerel _B5_11
        DD      imagerel _unwind___jsvml_expm1f4_ha_l9_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_expm1f8_ha_e9

__jsvml_expm1f8_ha_e9   PROC    EXPORT
...
L136::
        ...
        mov       QWORD PTR [528+rsp], r13
        lea       r13, QWORD PTR [111+rsp]
        vmulps    ymm1, ymm0, YMMWORD PTR [__jsvml_sexpm1_ha_data_internal+768]
        and       r13, -64
        vmovups   ymm14, YMMWORD PTR [__jsvml_sexpm1_ha_data_internal+1280]
        vmovups   YMMWORD PTR [r13], ymm0
        vroundps  ymm2, ymm1, 0
        vandps    ymm4, ymm0, ymm14
        vcmpnle_uqps ymm5, ymm4, YMMWORD PTR [__jsvml_sexpm1_ha_data_internal+1344]
        vmulps    ymm3, ymm2, YMMWORD PTR [__jsvml_sexpm1_ha_data_internal+832]
        vmulps    ymm13, ymm2, YMMWORD PTR [__jsvml_sexpm1_ha_data_internal+896]
        vsubps    ymm12, ymm0, ymm3
        vcmpeqps  ymm10, ymm12, ymm0
        vsubps    ymm11, ymm12, ymm13
        vandnps   ymm15, ymm14, ymm0
        vmovups   xmm0, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+1024]
        vorps     ymm10, ymm10, YMMWORD PTR [__jsvml_sexpm1_ha_data_internal+1152]
        ...
        vaddps    ymm8, ymm2, YMMWORD PTR [__jsvml_sexpm1_ha_data_internal+960]
        vpmovmskb edx, xmm7
        ...
        movsxd    r9, r9d
        vmovd     r11d, xmm6
        vmovq     xmm0, QWORD PTR [imagerel(__jsvml_sexpm1_ha_data_internal)+rax+rcx]
        vmovq     xmm2, QWORD PTR [imagerel(__jsvml_sexpm1_ha_data_internal)+rax+r8]
        vpextrd   r10d, xmm3, 3
        vmovq     xmm1, QWORD PTR [imagerel(__jsvml_sexpm1_ha_data_internal)+rax+r9]
        vpextrd   ecx, xmm6, 1
        vpextrd   r8d, xmm6, 2
        vpextrd   r9d, xmm6, 3
        movsxd    r10, r10d
        ...
        movsxd    r8, r8d
        movsxd    r9, r9d
        vmovq     xmm3, QWORD PTR [imagerel(__jsvml_sexpm1_ha_data_internal)+rax+r10]
        vmovq     xmm4, QWORD PTR [imagerel(__jsvml_sexpm1_ha_data_internal)+rax+r11]
        vmovq     xmm7, QWORD PTR [imagerel(__jsvml_sexpm1_ha_data_internal)+rax+rcx]
        vmovq     xmm5, QWORD PTR [imagerel(__jsvml_sexpm1_ha_data_internal)+rax+r8]
        vmovq     xmm6, QWORD PTR [imagerel(__jsvml_sexpm1_ha_data_internal)+rax+r9]
        ...
        vmulps    ymm5, ymm11, YMMWORD PTR [__jsvml_sexpm1_ha_data_internal+512]
        vmulps    ymm11, ymm11, ymm11
        vinsertf128 ymm7, ymm0, xmm1, 1
        vinsertf128 ymm0, ymm2, xmm4, 1
        vmovups   xmm2, XMMWORD PTR [__jsvml_sexpm1_ha_data_internal+1088]
        vandps    xmm8, xmm8, xmm2
        vandps    xmm9, xmm9, xmm2
        vpslld    xmm1, xmm8, 14
        vpslld    xmm3, xmm9, 14
        vunpcklps ymm6, ymm7, ymm0
        vmovups   ymm2, YMMWORD PTR [__jsvml_sexpm1_ha_data_internal+1216]
        vunpckhps ymm7, ymm7, ymm0
        vinsertf128 ymm4, ymm1, xmm3, 1
        vorps     ymm8, ymm6, ymm4
        vaddps    ymm6, ymm5, YMMWORD PTR [__jsvml_sexpm1_ha_data_internal+576]
...
__jsvml_expm1f8_ha_e9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_expm1f8_ha_e9_B1_B3:
        DD      1603585
        DD      4379768
        DD      1927276
        DD      1800291
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B6_1
        DD      imagerel _B6_6
        DD      imagerel _unwind___jsvml_expm1f8_ha_e9_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_expm1f8_ha_e9_B6_B10:
        DD      265761
        DD      287758
        DD      340999
        DD      imagerel _B6_1
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B6_6
        DD      imagerel _B6_11
        DD      imagerel _unwind___jsvml_expm1f8_ha_e9_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_sexpm1_ha_cout_rare_internal

__jsvml_sexpm1_ha_cout_rare_internal    PROC
...
__jsvml_sexpm1_ha_cout_rare_internal ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_sexpm1_ha_cout_rare_internal_B1_B22:
        DD      67585
        DD      49672
...
__jsvml_sexpm1_ha_data_internal_avx512  DD      1065353216
        ...
        DD      3212836864
        DD      3212836864
        PUBLIC __jsvml_sexpm1_ha_data_internal
__jsvml_sexpm1_ha_data_internal DD      0
        DD      0
        DD      90112
        DD      958021240
        DD      184320
