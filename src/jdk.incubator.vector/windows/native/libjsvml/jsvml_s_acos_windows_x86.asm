...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_acosf16_ha_z0

__jsvml_acosf16_ha_z0   PROC    EXPORT
...
L1::
        ...
        vmovups   zmm22, ZMMWORD PTR [__jsvml_sacos_ha_data_internal]
        vmovups   zmm27, ZMMWORD PTR [__jsvml_sacos_ha_data_internal+64]
        vmovups   zmm26, ZMMWORD PTR [__jsvml_sacos_ha_data_internal+192]
        vmovups   zmm24, ZMMWORD PTR [__jsvml_sacos_ha_data_internal+256]
        vmovaps   zmm5, zmm0
        vorps     zmm4, zmm22, zmm5
        vandps    zmm3, zmm22, zmm5
        vmovups   zmm0, ZMMWORD PTR [__jsvml_sacos_ha_data_internal+448]
        vfmadd231ps zmm27, zmm27, zmm4 {rn-sae}
        vmovups   zmm22, ZMMWORD PTR [__jsvml_sacos_ha_data_internal+512]
        ...
        vandps    zmm31, zmm25, ZMMWORD PTR [__jsvml_sacos_ha_data_internal+384]
        vcmpps    k1, zmm2, zmm27, 21 {sae}
        vmovups   zmm27, ZMMWORD PTR [__jsvml_sacos_ha_data_internal+640]
        vandps    zmm29, zmm28, ZMMWORD PTR [__jsvml_sacos_ha_data_internal+320]
        vxorps    zmm31{k3}, zmm31, zmm31
        vorps     zmm2{k2}, zmm2, ZMMWORD PTR [__jsvml_sacos_ha_data_internal+1344]
        ...
        vmovups   zmm28, ZMMWORD PTR [__jsvml_sacos_ha_data_internal+768]
        vfmsub231ps zmm0, zmm31, zmm1 {rn-sae}
        vmovups   zmm30, ZMMWORD PTR [__jsvml_sacos_ha_data_internal+832]
        vmovups   zmm5, ZMMWORD PTR [__jsvml_sacos_ha_data_internal+1216]
        ...
        vmovups   zmm0, ZMMWORD PTR [__jsvml_sacos_ha_data_internal+576]
        vmulps    zmm25, zmm23, zmm24 {rn-sae}
        vfmadd231ps zmm0, zmm22, zmm24 {rn-sae}
        vmovups   zmm22, ZMMWORD PTR [__jsvml_sacos_ha_data_internal+704]
        vfmsub213ps zmm0, zmm25, zmm26 {rn-sae}
        vfmadd231ps zmm22, zmm27, zmm2 {rn-sae}
        vmovups   zmm27, ZMMWORD PTR [__jsvml_sacos_ha_data_internal+896]
        ...
        vmovups   zmm2, ZMMWORD PTR [__jsvml_sacos_ha_data_internal+1024]
        vmovups   zmm22, ZMMWORD PTR [__jsvml_sacos_ha_data_internal+960]
        vxorps    zmm2{k1}, zmm2, zmm2
        vxorps    zmm22{k1}, zmm22, zmm22
        vorps     zmm2{k2}, zmm2, ZMMWORD PTR [__jsvml_sacos_ha_data_internal+1152]
        vorps     zmm22{k2}, zmm22, ZMMWORD PTR [__jsvml_sacos_ha_data_internal+1088]
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_acosf4_ha_ex

__jsvml_acosf4_ha_ex    PROC    EXPORT
...
L2::
        ...
        movups    xmm8, XMMWORD PTR [__jsvml_sacos_ha_data_internal]
        and       r13, -64
        movaps    xmm1, xmm8
        andps     xmm8, xmm9
        orps      xmm1, xmm9
        movups    xmm2, XMMWORD PTR [__jsvml_sacos_ha_data_internal+64]
        movaps    xmm4, xmm1
        mulps     xmm4, xmm2
        movaps    xmm0, xmm1
        mulps     xmm0, xmm1
        addps     xmm2, xmm4
        movups    xmm3, XMMWORD PTR [__jsvml_sacos_ha_data_internal+256]
        movaps    xmm5, xmm2
        cmpnleps  xmm3, xmm1
        minps     xmm0, xmm2
        cmpltps   xmm5, XMMWORD PTR [__jsvml_sacos_ha_data_internal+192]
        rsqrtps   xmm7, xmm2
        movmskps  eax, xmm3
        movaps    xmm3, xmm0
        andnps    xmm5, xmm7
        movups    xmm10, XMMWORD PTR [__jsvml_sacos_ha_data_internal+320]
        movaps    xmm4, xmm5
        cmpnltps  xmm3, xmm2
        addps     xmm2, xmm2
        movaps    xmm7, xmm2
        ...
        mulps     xmm10, xmm5
        mulps     xmm5, xmm15
        subps     xmm10, XMMWORD PTR [__jsvml_sacos_ha_data_internal+448]
        movaps    xmm15, xmm7
        andps     xmm7, xmm3
        addps     xmm4, xmm10
        movups    xmm10, XMMWORD PTR [__jsvml_sacos_ha_data_internal+1152]
        addps     xmm15, xmm2
        addps     xmm5, xmm4
        movups    xmm4, XMMWORD PTR [__jsvml_sacos_ha_data_internal+512]
        mulps     xmm4, xmm5
        mulps     xmm5, xmm15
        addps     xmm4, XMMWORD PTR [__jsvml_sacos_ha_data_internal+576]
        movups    xmm15, XMMWORD PTR [__jsvml_sacos_ha_data_internal+640]
        mulps     xmm4, xmm5
        mulps     xmm15, xmm0
        subps     xmm4, xmm2
        addps     xmm15, XMMWORD PTR [__jsvml_sacos_ha_data_internal+704]
        movups    xmm5, XMMWORD PTR [__jsvml_sacos_ha_data_internal+768]
        movaps    xmm2, xmm0
        mulps     xmm5, xmm0
        andps     xmm4, xmm3
        mulps     xmm2, xmm0
        addps     xmm5, XMMWORD PTR [__jsvml_sacos_ha_data_internal+832]
        mulps     xmm15, xmm2
        movups    xmm2, XMMWORD PTR [__jsvml_sacos_ha_data_internal+1088]
        addps     xmm5, xmm15
        mulps     xmm5, xmm0
        movaps    xmm15, xmm3
        andnps    xmm15, XMMWORD PTR [__jsvml_sacos_ha_data_internal+1024]
        addps     xmm5, XMMWORD PTR [__jsvml_sacos_ha_data_internal+896]
        mulps     xmm5, xmm0
        cmpnltps  xmm0, xmm9
        andps     xmm0, xmm3
        andps     xmm10, xmm0
        ...
        movaps    xmm1, xmm7
        pxor      xmm15, xmm8
        andnps    xmm0, XMMWORD PTR [__jsvml_sacos_ha_data_internal+960]
        subps     xmm1, xmm4
        subps     xmm15, xmm4
        mulps     xmm5, xmm1
        orps      xmm0, xmm2
...
__jsvml_acosf4_ha_ex ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_acosf4_ha_ex_B1_B3:
        DD      934657
        DD      2282563
        DD      1079355
        DD      886835
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B2_1
        DD      imagerel _B2_6
        DD      imagerel _unwind___jsvml_acosf4_ha_ex_B1_B3
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B2_6
        DD      imagerel _B2_11
        DD      imagerel _unwind___jsvml_acosf4_ha_ex_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_acosf8_ha_e9

__jsvml_acosf8_ha_e9    PROC    EXPORT
...
L19::
        ...
        vmovups   ymm5, YMMWORD PTR [__jsvml_sacos_ha_data_internal]
        and       r13, -64
        vmovups   ymm3, YMMWORD PTR [__jsvml_sacos_ha_data_internal+64]
        vmovaps   ymm7, ymm0
        vorps     ymm4, ymm5, ymm7
        vmulps    ymm1, ymm4, ymm3
        vmulps    ymm6, ymm4, ymm4
        vcmpnge_uqps ymm14, ymm4, YMMWORD PTR [__jsvml_sacos_ha_data_internal+256]
        vaddps    ymm2, ymm3, ymm1
        vpxor     xmm1, xmm1, xmm1
        vminps    ymm3, ymm6, ymm2
        vcmplt_oqps ymm0, ymm2, YMMWORD PTR [__jsvml_sacos_ha_data_internal+192]
        ...
        vmovups   ymm1, YMMWORD PTR [__jsvml_sacos_ha_data_internal+320]
        vpmovmskb edx, xmm6
        ...
        vsubps    ymm13, ymm1, YMMWORD PTR [__jsvml_sacos_ha_data_internal+448]
        vaddps    ymm1, ymm2, ymm13
        vaddps    ymm13, ymm15, ymm14
        vaddps    ymm0, ymm0, ymm1
        vmulps    ymm2, ymm0, YMMWORD PTR [__jsvml_sacos_ha_data_internal+512]
        vaddps    ymm1, ymm2, YMMWORD PTR [__jsvml_sacos_ha_data_internal+576]
        vmulps    ymm2, ymm0, ymm13
        vmulps    ymm0, ymm1, ymm2
        vmulps    ymm1, ymm3, YMMWORD PTR [__jsvml_sacos_ha_data_internal+768]
        vsubps    ymm14, ymm0, ymm14
        vandps    ymm0, ymm15, ymm6
        vmulps    ymm15, ymm3, YMMWORD PTR [__jsvml_sacos_ha_data_internal+640]
        vandps    ymm2, ymm14, ymm6
        vmulps    ymm14, ymm3, ymm3
        vaddps    ymm13, ymm15, YMMWORD PTR [__jsvml_sacos_ha_data_internal+704]
        vaddps    ymm15, ymm1, YMMWORD PTR [__jsvml_sacos_ha_data_internal+832]
        vmulps    ymm1, ymm13, ymm14
        vaddps    ymm13, ymm15, ymm1
        vmulps    ymm14, ymm3, ymm13
        vaddps    ymm15, ymm14, YMMWORD PTR [__jsvml_sacos_ha_data_internal+896]
        vmulps    ymm1, ymm3, ymm15
        vcmpnlt_uqps ymm3, ymm3, ymm7
        vandps    ymm13, ymm3, ymm6
        vandps    ymm15, ymm13, YMMWORD PTR [__jsvml_sacos_ha_data_internal+1152]
        vandps    ymm14, ymm13, YMMWORD PTR [__jsvml_sacos_ha_data_internal+1088]
        vandnps   ymm3, ymm6, YMMWORD PTR [__jsvml_sacos_ha_data_internal+1024]
        vandnps   ymm13, ymm6, YMMWORD PTR [__jsvml_sacos_ha_data_internal+960]
...
__jsvml_acosf8_ha_e9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_acosf8_ha_e9_B1_B3:
        DD      933889
        DD      4379712
        DD      1534008
        DD      2062383
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B3_1
        DD      imagerel _B3_6
        DD      imagerel _unwind___jsvml_acosf8_ha_e9_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_acosf8_ha_e9_B6_B10:
        DD      931873
        DD      1598520
        DD      1651758
        DD      182310
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B3_6
        DD      imagerel _B3_11
        DD      imagerel _unwind___jsvml_acosf8_ha_e9_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_acosf8_ha_l9

__jsvml_acosf8_ha_l9    PROC    EXPORT
...
L46::
        ...
        vcmpnge_uqps ymm4, ymm1, YMMWORD PTR [__jsvml_sacos_ha_data_internal+256]
        vcmplt_oqps ymm2, ymm3, YMMWORD PTR [__jsvml_sacos_ha_data_internal+192]
        vminps    ymm8, ymm12, ymm3
        vrsqrtps  ymm12, ymm3
        vcmpnlt_uqps ymm0, ymm8, ymm3
        vaddps    ymm3, ymm3, ymm3
        vmovmskps edx, ymm4
        vandps    ymm4, ymm3, YMMWORD PTR [__jsvml_sacos_ha_data_internal+320]
        test      edx, edx
        vandnps   ymm10, ymm2, ymm12
        vsubps    ymm2, ymm3, ymm4
        vmovups   ymm12, YMMWORD PTR [__jsvml_sacos_ha_data_internal+448]
        vmulps    ymm11, ymm10, ymm4
        vmulps    ymm2, ymm10, ymm2
        vmovups   ymm3, YMMWORD PTR [__jsvml_sacos_ha_data_internal+512]
        vfmsub231ps ymm12, ymm10, ymm11
        vmulps    ymm10, ymm10, ymm2
        vaddps    ymm4, ymm11, ymm2
        vaddps    ymm12, ymm12, ymm10
        vfmadd213ps ymm3, ymm12, YMMWORD PTR [__jsvml_sacos_ha_data_internal+576]
        vmulps    ymm4, ymm4, ymm12
        vmovups   ymm12, YMMWORD PTR [__jsvml_sacos_ha_data_internal+768]
        vfmsub213ps ymm3, ymm4, ymm2
        vfmadd213ps ymm12, ymm8, YMMWORD PTR [__jsvml_sacos_ha_data_internal+832]
        vandps    ymm4, ymm3, ymm0
        vmovups   ymm3, YMMWORD PTR [__jsvml_sacos_ha_data_internal+640]
        vfmadd213ps ymm3, ymm8, YMMWORD PTR [__jsvml_sacos_ha_data_internal+704]
        vandps    ymm2, ymm11, ymm0
        vmulps    ymm11, ymm8, ymm8
        vfmadd213ps ymm3, ymm11, ymm12
        vfmadd213ps ymm3, ymm8, YMMWORD PTR [__jsvml_sacos_ha_data_internal+896]
        vmulps    ymm3, ymm8, ymm3
        vcmpnlt_uqps ymm8, ymm8, ymm7
        vandps    ymm12, ymm8, ymm0
        vandps    ymm11, ymm12, YMMWORD PTR [__jsvml_sacos_ha_data_internal+1152]
        vandnps   ymm10, ymm0, YMMWORD PTR [__jsvml_sacos_ha_data_internal+1024]
        vandnps   ymm8, ymm0, YMMWORD PTR [__jsvml_sacos_ha_data_internal+960]
        vandps    ymm5, ymm5, ymm7
        ...
        vandps    ymm12, ymm12, YMMWORD PTR [__jsvml_sacos_ha_data_internal+1088]
...
__jsvml_acosf8_ha_l9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_acosf8_ha_l9_B1_B3:
        DD      933889
        DD      4379712
        DD      2062392
        DD      1935407
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B4_1
        DD      imagerel _B4_6
        DD      imagerel _unwind___jsvml_acosf8_ha_l9_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_acosf8_ha_l9_B6_B10:
        DD      931873
        DD      1598520
        DD      1651758
        DD      194598
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B4_6
        DD      imagerel _B4_11
        DD      imagerel _unwind___jsvml_acosf8_ha_l9_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_acosf4_ha_l9

__jsvml_acosf4_ha_l9    PROC    EXPORT
...
L73::
        ...
        mov       QWORD PTR [272+rsp], r13
        lea       r13, QWORD PTR [111+rsp]
        vmovups   xmm3, XMMWORD PTR [__jsvml_sacos_ha_data_internal]
        and       r13, -64
        vmovups   xmm1, XMMWORD PTR [__jsvml_sacos_ha_data_internal+64]
        vorps     xmm7, xmm3, xmm5
        vfmadd231ps xmm1, xmm1, xmm7
        vandps    xmm3, xmm3, xmm5
        vmulps    xmm4, xmm7, xmm7
        vcmpngeps xmm11, xmm7, XMMWORD PTR [__jsvml_sacos_ha_data_internal+256]
        vcmpltps  xmm2, xmm1, XMMWORD PTR [__jsvml_sacos_ha_data_internal+192]
        ...
        vandps    xmm2, xmm1, XMMWORD PTR [__jsvml_sacos_ha_data_internal+320]
        test      edx, edx
        vmulps    xmm12, xmm10, xmm2
        vsubps    xmm0, xmm1, xmm2
        vmulps    xmm0, xmm10, xmm0
        vmovups   xmm11, XMMWORD PTR [__jsvml_sacos_ha_data_internal+448]
        vaddps    xmm2, xmm12, xmm0
        vfmsub231ps xmm11, xmm10, xmm12
        vmulps    xmm10, xmm10, xmm0
        vmovups   xmm1, XMMWORD PTR [__jsvml_sacos_ha_data_internal+512]
        vaddps    xmm11, xmm11, xmm10
        vfmadd213ps xmm1, xmm11, XMMWORD PTR [__jsvml_sacos_ha_data_internal+576]
        vmulps    xmm2, xmm2, xmm11
        vfmsub213ps xmm1, xmm2, xmm0
        vandps    xmm0, xmm12, xmm4
        vmovups   xmm11, XMMWORD PTR [__jsvml_sacos_ha_data_internal+768]
        vorps     xmm0, xmm0, xmm7
        vfmadd213ps xmm11, xmm8, XMMWORD PTR [__jsvml_sacos_ha_data_internal+832]
        vmulps    xmm12, xmm8, xmm8
        vandps    xmm2, xmm1, xmm4
        vmovups   xmm1, XMMWORD PTR [__jsvml_sacos_ha_data_internal+640]
        vsubps    xmm7, xmm0, xmm2
        vfmadd213ps xmm1, xmm8, XMMWORD PTR [__jsvml_sacos_ha_data_internal+704]
        vfmadd213ps xmm1, xmm12, xmm11
        vandnps   xmm12, xmm4, XMMWORD PTR [__jsvml_sacos_ha_data_internal+960]
        vfmadd213ps xmm1, xmm8, XMMWORD PTR [__jsvml_sacos_ha_data_internal+896]
        vmulps    xmm1, xmm8, xmm1
        vcmpnltps xmm8, xmm8, xmm5
        vandps    xmm11, xmm8, xmm4
        vandps    xmm10, xmm11, XMMWORD PTR [__jsvml_sacos_ha_data_internal+1152]
        vandnps   xmm8, xmm4, XMMWORD PTR [__jsvml_sacos_ha_data_internal+1024]
        vorps     xmm4, xmm8, xmm10
        vxorps    xmm4, xmm4, xmm3
        vandps    xmm11, xmm11, XMMWORD PTR [__jsvml_sacos_ha_data_internal+1088]
...
__jsvml_acosf4_ha_l9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_acosf4_ha_l9_B1_B3:
        DD      934913
        DD      2282564
        DD      1079356
        DD      1017907
...
.xdata  SEGMENT  DWORD   READ  ''
        ...
        ALIGN 004H
_unwind___jsvml_acosf4_ha_l9_B6_B10:
        DD      265761
        DD      287758
        DD      340999
        DD      imagerel _B5_1
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_acosf4_ha_e9

__jsvml_acosf4_ha_e9    PROC    EXPORT
...
L90::
        ...
        mov       QWORD PTR [272+rsp], r13
        lea       r13, QWORD PTR [111+rsp]
        vmovups   xmm5, XMMWORD PTR [__jsvml_sacos_ha_data_internal]
        and       r13, -64
        vmovups   xmm2, XMMWORD PTR [__jsvml_sacos_ha_data_internal+64]
        vorps     xmm4, xmm5, xmm7
        vmulps    xmm3, xmm4, xmm2
        vandps    xmm5, xmm5, xmm7
        vcmpngeps xmm6, xmm4, XMMWORD PTR [__jsvml_sacos_ha_data_internal+256]
        vmulps    xmm1, xmm4, xmm4
        vaddps    xmm15, xmm2, xmm3
        vmovmskps edx, xmm6
        vrsqrtps  xmm0, xmm15
        vcmpltps  xmm2, xmm15, XMMWORD PTR [__jsvml_sacos_ha_data_internal+192]
        vminps    xmm3, xmm1, xmm15
        vaddps    xmm9, xmm15, xmm15
        vcmpnltps xmm6, xmm3, xmm15
        vmovups   xmm1, XMMWORD PTR [__jsvml_sacos_ha_data_internal+320]
        ...
        vsubps    xmm8, xmm1, XMMWORD PTR [__jsvml_sacos_ha_data_internal+448]
        mov       QWORD PTR [280+rsp], r13
        vaddps    xmm1, xmm2, xmm8
        vaddps    xmm8, xmm15, xmm9
        vaddps    xmm0, xmm0, xmm1
        vmulps    xmm2, xmm0, XMMWORD PTR [__jsvml_sacos_ha_data_internal+512]
        vaddps    xmm1, xmm2, XMMWORD PTR [__jsvml_sacos_ha_data_internal+576]
        vmulps    xmm2, xmm0, xmm8
        vmulps    xmm0, xmm1, xmm2
        vmulps    xmm1, xmm3, XMMWORD PTR [__jsvml_sacos_ha_data_internal+768]
        vsubps    xmm9, xmm0, xmm9
        vaddps    xmm8, xmm1, XMMWORD PTR [__jsvml_sacos_ha_data_internal+832]
        vandps    xmm0, xmm15, xmm6
        vandps    xmm2, xmm9, xmm6
        vmulps    xmm15, xmm3, XMMWORD PTR [__jsvml_sacos_ha_data_internal+640]
        vaddps    xmm9, xmm15, XMMWORD PTR [__jsvml_sacos_ha_data_internal+704]
        vmulps    xmm15, xmm3, xmm3
        vmulps    xmm1, xmm9, xmm15
        vaddps    xmm9, xmm8, xmm1
        vmulps    xmm15, xmm3, xmm9
        vaddps    xmm8, xmm15, XMMWORD PTR [__jsvml_sacos_ha_data_internal+896]
        vmulps    xmm1, xmm3, xmm8
        vcmpnltps xmm3, xmm3, xmm7
        vandps    xmm9, xmm3, xmm6
        vandps    xmm3, xmm9, XMMWORD PTR [__jsvml_sacos_ha_data_internal+1152]
        vandps    xmm15, xmm9, XMMWORD PTR [__jsvml_sacos_ha_data_internal+1088]
        vandnps   xmm8, xmm6, XMMWORD PTR [__jsvml_sacos_ha_data_internal+1024]
        vandnps   xmm9, xmm6, XMMWORD PTR [__jsvml_sacos_ha_data_internal+960]
...
__jsvml_acosf4_ha_e9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_acosf4_ha_e9_B1_B3:
        DD      934913
        DD      2282564
        DD      1075260
        DD      882735
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B6_1
        DD      imagerel _B6_6
        DD      imagerel _unwind___jsvml_acosf4_ha_e9_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_acosf4_ha_e9_B6_B10:
        DD      265761
        DD      287758
        DD      340999
        DD      imagerel _B6_1
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B6_6
        DD      imagerel _B6_11
        DD      imagerel _unwind___jsvml_acosf4_ha_e9_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_sacos_ha_cout_rare_internal

__jsvml_sacos_ha_cout_rare_internal     PROC
...
__jsvml_sacos_ha_cout_rare_internal ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_sacos_ha_cout_rare_internal_B1_B20:
        DD      621957633
        DD      424018
        DD      362574
        DD      501833
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B7_1
        DD      imagerel _B7_21
        DD      imagerel _unwind___jsvml_sacos_ha_cout_rare_internal_B1_B20
