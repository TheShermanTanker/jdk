...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_cosf8_ha_e9

__jsvml_cosf8_ha_e9     PROC    EXPORT
...
L1::
        ...
        vmovaps   ymm8, ymm0
        and       r13, -64
        vandps    ymm3, ymm8, YMMWORD PTR [__jsvml_scos_ha_data_internal+4096]
        vaddps    ymm6, ymm3, YMMWORD PTR [__jsvml_scos_ha_data_internal+5504]
        vcmpnle_uqps ymm7, ymm3, YMMWORD PTR [__jsvml_scos_ha_data_internal+4160]
        vmovups   ymm2, YMMWORD PTR [__jsvml_scos_ha_data_internal+5440]
        vmulps    ymm10, ymm6, YMMWORD PTR [__jsvml_scos_ha_data_internal+5376]
        vaddps    ymm1, ymm2, ymm10
        mov       QWORD PTR [536+rsp], r13
        vpslld    xmm4, xmm1, 31
        vsubps    ymm2, ymm1, ymm2
        vextractf128 xmm5, ymm1, 1
        vsubps    ymm10, ymm2, YMMWORD PTR [__jsvml_scos_ha_data_internal+5568]
        vpslld    xmm6, xmm5, 31
        vextractf128 xmm5, ymm10, 1
        vcvtps2pd ymm0, xmm10
        vcvtps2pd ymm2, xmm5
        vmovupd   ymm5, YMMWORD PTR [__jsvml_scos_ha_data_internal+4992]
        vcvtps2pd ymm10, xmm3
        vextractf128 xmm3, ymm3, 1
        vcvtps2pd ymm1, xmm3
        vmulpd    ymm3, ymm2, ymm5
        vsubpd    ymm3, ymm1, ymm3
        vmovupd   ymm1, YMMWORD PTR [__jsvml_scos_ha_data_internal+5056]
        ...
        vmovupd   ymm5, YMMWORD PTR [__jsvml_scos_ha_data_internal+5312]
        vsubpd    ymm10, ymm10, ymm4
        vmovupd   ymm4, YMMWORD PTR [__jsvml_scos_ha_data_internal+5248]
        ...
        vmovupd   ymm5, YMMWORD PTR [__jsvml_scos_ha_data_internal+5184]
        vmulpd    ymm0, ymm1, ymm0
        vmulpd    ymm4, ymm3, ymm4
        vaddpd    ymm0, ymm5, ymm0
        vaddpd    ymm5, ymm5, ymm4
        vmovupd   ymm4, YMMWORD PTR [__jsvml_scos_ha_data_internal+5120]
        vmulpd    ymm0, ymm1, ymm0
...
_B1_10::
        ...
        call      __jsvml_scos_ha_cout_rare_internal
        jmp       _B1_8
        ALIGN     16

_B1_11::

__jsvml_cosf8_ha_e9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_cosf8_ha_e9_B1_B3:
        DD      800513
        DD      4379703
        DD      2058287
        DD      1931302
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B1_1
        DD      imagerel _B1_6
        DD      imagerel _unwind___jsvml_cosf8_ha_e9_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_cosf8_ha_e9_B6_B10:
        DD      1065249
        DD      1860673
        DD      1913911
        DD      194607
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B1_6
        DD      imagerel _B1_11
        DD      imagerel _unwind___jsvml_cosf8_ha_e9_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_cosf4_ha_ex

__jsvml_cosf4_ha_ex     PROC    EXPORT
...
L28::
        ...
        movups    xmm12, XMMWORD PTR [__jsvml_scos_ha_data_internal+4096]
        and       r13, -64
        movups    xmm5, XMMWORD PTR [__jsvml_scos_ha_data_internal+5504]
        andps     xmm12, xmm4
        movups    xmm1, XMMWORD PTR [__jsvml_scos_ha_data_internal+5440]
        movaps    xmm3, xmm12
        cvtps2pd  xmm0, xmm12
        cmpnleps  xmm3, XMMWORD PTR [__jsvml_scos_ha_data_internal+4160]
        addps     xmm5, xmm12
        movmskps  eax, xmm3
        movhlps   xmm12, xmm12
        mulps     xmm5, XMMWORD PTR [__jsvml_scos_ha_data_internal+5376]
        mov       QWORD PTR [264+rsp], r13
        addps     xmm5, xmm1
        movaps    xmm2, xmm5
        subps     xmm5, xmm1
        cvtps2pd  xmm1, xmm12
        subps     xmm5, XMMWORD PTR [__jsvml_scos_ha_data_internal+5568]
        cvtps2pd  xmm10, xmm5
        movhlps   xmm5, xmm5
        pslld     xmm2, 31
        cvtps2pd  xmm7, xmm5
        movups    xmm12, XMMWORD PTR [__jsvml_scos_ha_data_internal+4992]
        movaps    xmm14, xmm12
        mulpd     xmm14, xmm10
        mulpd     xmm12, xmm7
        subpd     xmm0, xmm14
        subpd     xmm1, xmm12
        movups    xmm5, XMMWORD PTR [__jsvml_scos_ha_data_internal+5056]
        mulpd     xmm10, xmm5
        mulpd     xmm7, xmm5
        subpd     xmm0, xmm10
        subpd     xmm1, xmm7
        ...
        mulpd     xmm10, xmm0
        mulpd     xmm12, xmm1
        movups    xmm5, XMMWORD PTR [__jsvml_scos_ha_data_internal+5312]
        movaps    xmm7, xmm5
        mulpd     xmm7, xmm10
        mulpd     xmm5, xmm12
        movups    xmm14, XMMWORD PTR [__jsvml_scos_ha_data_internal+5248]
        addpd     xmm7, xmm14
        addpd     xmm14, xmm5
        mulpd     xmm7, xmm10
        mulpd     xmm14, xmm12
        movups    xmm5, XMMWORD PTR [__jsvml_scos_ha_data_internal+5184]
        addpd     xmm7, xmm5
        addpd     xmm5, xmm14
        mulpd     xmm7, xmm10
        mulpd     xmm5, xmm12
        movups    xmm14, XMMWORD PTR [__jsvml_scos_ha_data_internal+5120]
        addpd     xmm7, xmm14
        addpd     xmm14, xmm5
        mulpd     xmm10, xmm7
        mulpd     xmm12, xmm14
...
__jsvml_cosf4_ha_ex ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_cosf4_ha_ex_B1_B3:
        DD      801025
        DD      2151481
        DD      817201
        DD      1026089
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B2_1
        DD      imagerel _B2_6
        DD      imagerel _unwind___jsvml_cosf4_ha_ex_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_cosf4_ha_ex_B6_B10:
        DD      265761
        DD      287758
        DD      340999
        DD      imagerel _B2_1
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B2_6
        DD      imagerel _B2_11
        DD      imagerel _unwind___jsvml_cosf4_ha_ex_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_cosf4_ha_l9

__jsvml_cosf4_ha_l9     PROC    EXPORT
...
L43::
        ...
        lea       r13, QWORD PTR [111+rsp]
        vandps    xmm3, xmm2, XMMWORD PTR [__jsvml_scos_ha_data_internal+4096]
        and       r13, -64
        vmovups   xmm0, XMMWORD PTR [__jsvml_scos_ha_data_internal+5440]
        vcmpnleps xmm1, xmm3, XMMWORD PTR [__jsvml_scos_ha_data_internal+4160]
        vaddps    xmm5, xmm3, XMMWORD PTR [__jsvml_scos_ha_data_internal+5504]
        vcvtps2pd ymm3, xmm3
        vmovmskps edx, xmm1
        vfmadd132ps xmm5, xmm0, XMMWORD PTR [__jsvml_scos_ha_data_internal+5376]
        vpslld    xmm4, xmm5, 31
        vsubps    xmm5, xmm5, xmm0
        mov       QWORD PTR [200+rsp], r13
        vsubps    xmm0, xmm5, XMMWORD PTR [__jsvml_scos_ha_data_internal+5568]
        vmovupd   ymm5, YMMWORD PTR [__jsvml_scos_ha_data_internal+5312]
        vcvtps2pd ymm0, xmm0
        vfnmadd231pd ymm3, ymm0, YMMWORD PTR [__jsvml_scos_ha_data_internal+4992]
        vfnmadd132pd ymm0, ymm3, YMMWORD PTR [__jsvml_scos_ha_data_internal+5056]
        vmulpd    ymm3, ymm0, ymm0
        vfmadd213pd ymm5, ymm3, YMMWORD PTR [__jsvml_scos_ha_data_internal+5248]
        vfmadd213pd ymm5, ymm3, YMMWORD PTR [__jsvml_scos_ha_data_internal+5184]
        vfmadd213pd ymm5, ymm3, YMMWORD PTR [__jsvml_scos_ha_data_internal+5120]
...
__jsvml_cosf4_ha_l9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_cosf4_ha_l9_B1_B3:
        DD      268033
        DD      1627159
        DD      1769739
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B3_1
        DD      imagerel _B3_6
        DD      imagerel _unwind___jsvml_cosf4_ha_l9_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_cosf4_ha_l9_B6_B10:
        DD      527873
        DD      287758
        DD      340999
        DD      1627136
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B3_6
        DD      imagerel _B3_11
        DD      imagerel _unwind___jsvml_cosf4_ha_l9_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_cosf4_ha_e9

__jsvml_cosf4_ha_e9     PROC    EXPORT
...
L50::
        ...
        mov       QWORD PTR [192+rsp], r13
        lea       r13, QWORD PTR [111+rsp]
        vandps    xmm4, xmm0, XMMWORD PTR [__jsvml_scos_ha_data_internal+4096]
        and       r13, -64
        vmovups   xmm3, XMMWORD PTR [__jsvml_scos_ha_data_internal+5440]
        vcmpnleps xmm1, xmm4, XMMWORD PTR [__jsvml_scos_ha_data_internal+4160]
        vaddps    xmm2, xmm4, XMMWORD PTR [__jsvml_scos_ha_data_internal+5504]
        vcvtps2pd ymm4, xmm4
        vmovmskps edx, xmm1
        vmulps    xmm5, xmm2, XMMWORD PTR [__jsvml_scos_ha_data_internal+5376]
        mov       QWORD PTR [200+rsp], r13
        vaddps    xmm5, xmm3, xmm5
        vpslld    xmm2, xmm5, 31
        vsubps    xmm3, xmm5, xmm3
        vsubps    xmm3, xmm3, XMMWORD PTR [__jsvml_scos_ha_data_internal+5568]
        vcvtps2pd ymm5, xmm3
        vmulpd    ymm3, ymm5, YMMWORD PTR [__jsvml_scos_ha_data_internal+4992]
        vmulpd    ymm5, ymm5, YMMWORD PTR [__jsvml_scos_ha_data_internal+5056]
        vsubpd    ymm4, ymm4, ymm3
        vsubpd    ymm3, ymm4, ymm5
        vmulpd    ymm4, ymm3, ymm3
        vmulpd    ymm5, ymm4, YMMWORD PTR [__jsvml_scos_ha_data_internal+5312]
        vaddpd    ymm5, ymm5, YMMWORD PTR [__jsvml_scos_ha_data_internal+5248]
        vmulpd    ymm5, ymm4, ymm5
        vaddpd    ymm5, ymm5, YMMWORD PTR [__jsvml_scos_ha_data_internal+5184]
        vmulpd    ymm5, ymm4, ymm5
        vaddpd    ymm5, ymm5, YMMWORD PTR [__jsvml_scos_ha_data_internal+5120]
...
__jsvml_cosf4_ha_e9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_cosf4_ha_e9_B1_B3:
        DD      267009
        DD      1627155
        DD      1769739
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B4_1
        DD      imagerel _B4_6
        DD      imagerel _unwind___jsvml_cosf4_ha_e9_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_cosf4_ha_e9_B6_B10:
        DD      527873
        DD      287758
        DD      340999
        DD      1627136
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B4_6
        DD      imagerel _B4_11
        DD      imagerel _unwind___jsvml_cosf4_ha_e9_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_cosf8_ha_l9

__jsvml_cosf8_ha_l9     PROC    EXPORT
...
L57::
        ...
        mov       QWORD PTR [528+rsp], r13
        lea       r13, QWORD PTR [303+rsp]
        vmovups   ymm4, YMMWORD PTR [__jsvml_scos_ha_data_internal+5440]
        and       r13, -64
        vmovupd   ymm14, YMMWORD PTR [__jsvml_scos_ha_data_internal+4992]
        vandps    ymm5, ymm0, YMMWORD PTR [__jsvml_scos_ha_data_internal+4096]
        vaddps    ymm3, ymm5, YMMWORD PTR [__jsvml_scos_ha_data_internal+5504]
        vcmpnle_uqps ymm1, ymm5, YMMWORD PTR [__jsvml_scos_ha_data_internal+4160]
        vfmadd132ps ymm3, ymm4, YMMWORD PTR [__jsvml_scos_ha_data_internal+5376]
        vpslld    ymm2, ymm3, 31
        vsubps    ymm3, ymm3, ymm4
        vsubps    ymm4, ymm3, YMMWORD PTR [__jsvml_scos_ha_data_internal+5568]
        vmovmskps edx, ymm1
        mov       QWORD PTR [536+rsp], r13
        test      edx, edx
        ...
        vmovupd   ymm5, YMMWORD PTR [__jsvml_scos_ha_data_internal+5056]
        vfnmadd231pd ymm15, ymm14, ymm3
        vfnmadd231pd ymm13, ymm14, ymm4
        vfnmadd213pd ymm3, ymm5, ymm15
        vfnmadd213pd ymm4, ymm5, ymm13
        vmovupd   ymm5, YMMWORD PTR [__jsvml_scos_ha_data_internal+5248]
        vmovupd   ymm15, YMMWORD PTR [__jsvml_scos_ha_data_internal+5312]
        vmulpd    ymm6, ymm3, ymm3
        vmulpd    ymm13, ymm4, ymm4
        vmovdqa   ymm14, ymm5
        vfmadd231pd ymm14, ymm15, ymm6
        vfmadd231pd ymm5, ymm15, ymm13
        vmovupd   ymm15, YMMWORD PTR [__jsvml_scos_ha_data_internal+5184]
        vfmadd213pd ymm14, ymm6, ymm15
        vfmadd213pd ymm5, ymm13, ymm15
        vmovupd   ymm15, YMMWORD PTR [__jsvml_scos_ha_data_internal+5120]
        vfmadd213pd ymm14, ymm6, ymm15
        vfmadd213pd ymm5, ymm13, ymm15
...
__jsvml_cosf8_ha_l9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_cosf8_ha_l9_B1_B3:
        DD      800513
        DD      4379703
        DD      1796143
        DD      2086950
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B5_1
        DD      imagerel _B5_6
        DD      imagerel _unwind___jsvml_cosf8_ha_l9_B1_B3

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_cosf8_ha_l9_B6_B10:
        DD      1065249
        DD      1860673
        DD      1913911
        DD      182319
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B5_6
        DD      imagerel _B5_11
        DD      imagerel _unwind___jsvml_cosf8_ha_l9_B6_B10
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_cosf16_ha_z0

__jsvml_cosf16_ha_z0    PROC    EXPORT
...
L84::
        ...
        vmovups   zmm22, ZMMWORD PTR [__jsvml_scos_ha_data_internal+5504]
        and       r13, -64
        vmovups   zmm26, ZMMWORD PTR [__jsvml_scos_ha_data_internal+5440]
        vmovups   zmm24, ZMMWORD PTR [__jsvml_scos_ha_data_internal+5376]
        vmovups   zmm23, ZMMWORD PTR [__jsvml_scos_ha_data_internal+4160]
        vmovups   zmm28, ZMMWORD PTR [__jsvml_scos_ha_data_internal+5568]
        vpternlogd zmm4, zmm4, zmm4, 255
        vmovaps   zmm5, zmm0
        vandps    zmm2, zmm5, ZMMWORD PTR [__jsvml_scos_ha_data_internal+4096]
        vaddps    zmm25, zmm2, zmm22 {rn-sae}
        vcmpps    k1, zmm2, zmm23, 18 {sae}
        vfmadd213ps zmm25, zmm24, zmm26 {rn-sae}
        vmovups   zmm23, ZMMWORD PTR [__jsvml_scos_ha_data_internal+5056]
        vsubps    zmm27, zmm25, zmm26 {rn-sae}
        vpslld    zmm3, zmm25, 31
        vmovups   zmm25, ZMMWORD PTR [__jsvml_scos_ha_data_internal+5312]
        vmovups   zmm26, ZMMWORD PTR [__jsvml_scos_ha_data_internal+5184]
        vsubps    zmm29, zmm27, zmm28 {rn-sae}
        vmovups   zmm27, ZMMWORD PTR [__jsvml_scos_ha_data_internal+5120]
        ...
        vmovups   zmm2, ZMMWORD PTR [__jsvml_scos_ha_data_internal+4992]
        vmovups   zmm30, ZMMWORD PTR [__jsvml_scos_ha_data_internal+5248]
        kmovw     r8d, k0
...
__jsvml_cosf16_ha_z0 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_cosf16_ha_z0_B1_B9:
        DD      267009
        DD      10867731
        DD      10944779
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B6_1
        DD      imagerel _B6_11
        DD      imagerel _unwind___jsvml_cosf16_ha_z0_B1_B9
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B6_11
        DD      imagerel _B6_16
        DD      imagerel _unwind___jsvml_cosf16_ha_z0_B11_B15
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_scos_ha_cout_rare_internal

__jsvml_scos_ha_cout_rare_internal      PROC
...
__jsvml_scos_ha_cout_rare_internal ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_scos_ha_cout_rare_internal_B1_B17:
        DD      676865
        DD      489556
        DD      374863
        DD      579657
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B7_1
        DD      imagerel _B7_18
        DD      imagerel _unwind___jsvml_scos_ha_cout_rare_internal_B1_B17
