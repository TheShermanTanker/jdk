...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_atan22_ha_ex

__jsvml_atan22_ha_ex    PROC    EXPORT
...
L1::
        ...
        movups    xmm4, XMMWORD PTR [__jsvml_datan2_ha_data_internal+896]
        and       r13, -64
        movaps    xmm1, xmm4
        andps     xmm4, xmm0
        andps     xmm1, xmm13
        ...
        movaps    xmm14, xmm1
        movups    xmm5, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2880]
        movdqa    xmm7, xmm15
        pshufd    xmm2, xmm4, 221
        pxor      xmm14, xmm13
        movq      xmm3, QWORD PTR [__jsvml_datan2_ha_data_internal+2688]
        movdqa    xmm6, xmm2
        ...
        psubd     xmm5, xmm15
        movaps    xmm9, xmm4
        movq      xmm15, QWORD PTR [__jsvml_datan2_ha_data_internal+2752]
        movaps    xmm8, xmm1
        pcmpgtd   xmm3, xmm15
        pcmpeqd   xmm7, xmm15
        movups    xmm12, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1088]
        por       xmm3, xmm7
        movdqa    xmm7, xmm6
        movaps    xmm10, xmm12
        pcmpgtd   xmm7, xmm15
        ...
        andps     xmm10, xmm4
        movq      xmm4, QWORD PTR [__jsvml_datan2_ha_data_internal+3200]
        por       xmm7, xmm6
        movq      xmm6, QWORD PTR [__jsvml_datan2_ha_data_internal+3264]
        paddd     xmm5, xmm4
        por       xmm3, xmm7
        movdqa    xmm7, xmm6
        pcmpgtd   xmm7, xmm5
        ...
        movups    xmm15, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1152]
        movups    xmm7, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1216]
        movups    xmm4, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1280]
        movups    xmm3, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1344]
        mulpd     xmm15, xmm1
        mulpd     xmm3, xmm1
        mulpd     xmm7, xmm1
        mulpd     xmm4, xmm1
        ...
        paddd     xmm15, xmm7
        movaps    xmm1, xmm11
        movq      xmm5, QWORD PTR [__jsvml_datan2_ha_data_internal+1408]
        paddd     xmm6, xmm15
        paddd     xmm6, xmm5
        movaps    xmm15, xmm8
        pslld     xmm6, 5
        ...
        movd      ecx, xmm2
        movaps    xmm2, xmm10
        movq      xmm3, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+r8+rdx]
        movq      xmm4, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+24+r8+rdx]
        movhpd    xmm3, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+r8+rcx]
        mulpd     xmm1, xmm3
        mulpd     xmm15, xmm3
        mulpd     xmm10, xmm3
        mulpd     xmm3, xmm9
        movhpd    xmm4, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+24+r8+rcx]
        andps     xmm2, xmm4
        andps     xmm7, xmm4
        subpd     xmm2, xmm1
        subpd     xmm7, xmm15
        ...
        andps     xmm2, xmm1
        movdqa    xmm11, xmm15
        movq      xmm8, QWORD PTR [__jsvml_datan2_ha_data_internal+1600]
        pslld     xmm11, 3
        movq      xmm10, QWORD PTR [__jsvml_datan2_ha_data_internal+1664]
        pand      xmm11, xmm8
        por       xmm11, xmm10
        addpd     xmm4, xmm9
        subpd     xmm1, xmm2
        rcpps     xmm9, xmm11
        addpd     xmm7, xmm1
        movq      xmm3, QWORD PTR [__jsvml_datan2_ha_data_internal+1472]
        psrld     xmm9, 3
        movq      xmm8, QWORD PTR [__jsvml_datan2_ha_data_internal+1536]
        pand      xmm15, xmm3
        movq      xmm1, QWORD PTR [__jsvml_datan2_ha_data_internal+1728]
        psubd     xmm8, xmm15
        psubd     xmm9, xmm1
        movaps    xmm1, xmm2
        paddd     xmm9, xmm8
        pshufd    xmm10, xmm9, 80
        andps     xmm10, XMMWORD PTR [__jsvml_datan2_ha_data_internal+3008]
        mulpd     xmm12, xmm10
        mulpd     xmm4, xmm10
        subpd     xmm12, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1792]
        mulpd     xmm2, xmm10
        addpd     xmm12, xmm4
        movaps    xmm4, xmm12
        mulpd     xmm4, xmm12
        ...
        movaps    xmm7, xmm3
        mulpd     xmm7, xmm3
        movups    xmm4, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1856]
        mulpd     xmm4, xmm7
        movups    xmm12, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1920]
        addpd     xmm4, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1984]
        mulpd     xmm12, xmm7
        mulpd     xmm4, xmm7
        addpd     xmm12, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2048]
        addpd     xmm4, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2112]
        mulpd     xmm12, xmm7
        mulpd     xmm4, xmm7
        addpd     xmm12, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2176]
        addpd     xmm4, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2240]
        mulpd     xmm12, xmm7
        mulpd     xmm4, xmm7
        addpd     xmm12, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2304]
        addpd     xmm4, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2368]
        mulpd     xmm12, xmm7
        mulpd     xmm4, xmm7
        addpd     xmm12, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2432]
        addpd     xmm4, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2496]
        mulpd     xmm7, xmm12
        mulpd     xmm4, xmm3
        addpd     xmm7, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2560]
        addpd     xmm7, xmm4
        mulpd     xmm3, xmm7
        movq      xmm5, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+16+r8+rdx]
        movhpd    xmm5, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+16+r8+rcx]
        addpd     xmm5, xmm1
        mulpd     xmm8, xmm3
        movups    xmm0, XMMWORD PTR [__jsvml_datan2_ha_data_internal+960]
        andps     xmm0, xmm13
        andps     xmm13, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1024]
        pxor      xmm13, xmm14
        addpd     xmm13, xmm5
        addpd     xmm13, xmm8
        addpd     xmm2, xmm13
        movq      xmm6, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+8+r8+rdx]
        movhpd    xmm6, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+8+r8+rcx]
        addpd     xmm6, xmm2
        pxor      xmm6, xmm14
        addpd     xmm0, xmm6
...
_B1_11::
        ...
        call      __jsvml_datan2_ha_cout_rare_internal
        jmp       _B1_9
...
_B1_12::
        ...
        andnps    xmm2, xmm10
        movups    xmm3, XMMWORD PTR [__jsvml_datan2_ha_data_internal+832]
        movups    xmm1, XMMWORD PTR [__jsvml_datan2_ha_data_internal+3136]
        movaps    xmm4, xmm3
        cmpordpd  xmm11, xmm5
        cmpeqpd   xmm10, xmm13
        andps     xmm3, xmm8
        ...
        andps     xmm15, XMMWORD PTR [__jsvml_datan2_ha_data_internal+3072]
        addpd     xmm8, xmm15
        movmskps  eax, xmm12
        pshufd    xmm1, xmm7, 80
        orps      xmm8, xmm3
...
__jsvml_atan22_ha_ex ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_atan22_ha_ex_B1_B4:
        DD      1603585
        DD      4248696
        DD      1402992
        DD      1341544
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B1_1
        DD      imagerel _B1_7
        DD      imagerel _unwind___jsvml_atan22_ha_ex_B1_B4

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_atan22_ha_ex_B7_B11:
        DD      265761
        DD      287758
        DD      340999
        DD      imagerel _B1_1
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B1_7
        DD      imagerel _B1_12
        DD      imagerel _unwind___jsvml_atan22_ha_ex_B7_B11

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_atan22_ha_ex_B12_B12:
        DD      33
        DD      imagerel _B1_1
        DD      imagerel _B1_7
        DD      imagerel _unwind___jsvml_atan22_ha_ex_B1_B4
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B1_12
        DD      imagerel _B1_13
        DD      imagerel _unwind___jsvml_atan22_ha_ex_B12_B12
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_atan21_ha_ex

__jsvml_atan21_ha_ex    PROC    EXPORT
...
L44::
        ...
        movsd     xmm5, QWORD PTR [__jsvml_datan2_ha_data_internal+896]
        and       r13, -64
        movaps    xmm12, xmm5
        andps     xmm5, xmm0
        andps     xmm12, xmm9
        movaps    xmm2, xmm5
        movsd     xmm13, QWORD PTR [__jsvml_datan2_ha_data_internal+2880]
        movaps    xmm10, xmm12
        ...
        movaps    xmm1, xmm12
        movsd     xmm11, QWORD PTR [__jsvml_datan2_ha_data_internal+960]
        cmpltsd   xmm9, xmm13
        movsd     xmm7, QWORD PTR [__jsvml_datan2_ha_data_internal+1024]
        andps     xmm11, xmm9
        pshufd    xmm13, xmm12, 85
        andps     xmm9, xmm7
        pshufd    xmm0, xmm5, 85
        movdqa    xmm15, xmm13
        movsd     xmm8, QWORD PTR [__jsvml_datan2_ha_data_internal+1088]
        movdqa    xmm7, xmm0
        movaps    xmm3, xmm8
        psubd     xmm15, xmm14
        psubd     xmm7, xmm13
        ...
        movaps    xmm6, xmm12
        por       xmm13, xmm5
        mulsd     xmm7, QWORD PTR [__jsvml_datan2_ha_data_internal+1152]
        andps     xmm4, xmm12
        subsd     xmm1, xmm4
        mulsd     xmm6, QWORD PTR [__jsvml_datan2_ha_data_internal+1216]
        subsd     xmm2, xmm3
        mulsd     xmm14, QWORD PTR [__jsvml_datan2_ha_data_internal+1280]
        mulsd     xmm15, QWORD PTR [__jsvml_datan2_ha_data_internal+1344]
        pshufd    xmm5, xmm7, 85
        mov       r8d, 1065353216
        ...
        pxor      xmm9, xmm10
        movd      edx, xmm5
        movq      xmm6, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+rax+rdx]
        movdqa    xmm5, xmm6
        movdqa    xmm7, xmm6
        mulsd     xmm5, xmm4
        mulsd     xmm7, xmm1
        movq      xmm14, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+24+rax+rdx]
        movdqa    xmm0, xmm14
        movdqa    xmm15, xmm14
        andps     xmm4, xmm14
        andps     xmm14, xmm1
        ...
        psubd     xmm1, xmm2
        paddd     xmm1, xmm0
        movsd     xmm15, QWORD PTR [__jsvml_datan2_ha_data_internal+3008]
        pshufd    xmm0, xmm1, 0
        andps     xmm0, xmm15
        mulsd     xmm8, xmm0
        movaps    xmm1, xmm0
        mulsd     xmm6, xmm0
        mulsd     xmm1, xmm7
        subsd     xmm8, QWORD PTR [__jsvml_datan2_ha_data_internal+1792]
        movsd     xmm2, QWORD PTR [__jsvml_datan2_ha_data_internal+1856]
        addsd     xmm6, xmm8
        movaps    xmm8, xmm6
        mulsd     xmm8, xmm6
        subsd     xmm8, xmm6
        ...
        mulsd     xmm6, xmm5
        mulsd     xmm8, xmm7
        movsd     xmm7, QWORD PTR [__jsvml_datan2_ha_data_internal+1920]
        addsd     xmm8, xmm6
        addsd     xmm1, xmm8
        addsd     xmm15, xmm1
        addsd     xmm1, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+16+rax+rdx]
        movaps    xmm14, xmm15
        addsd     xmm1, xmm9
        mulsd     xmm14, xmm15
        movaps    xmm5, xmm14
        ...
        mulsd     xmm2, xmm5
        mulsd     xmm7, xmm5
        addsd     xmm2, QWORD PTR [__jsvml_datan2_ha_data_internal+1984]
        addsd     xmm7, QWORD PTR [__jsvml_datan2_ha_data_internal+2048]
        mulsd     xmm2, xmm5
        mulsd     xmm7, xmm5
        addsd     xmm2, QWORD PTR [__jsvml_datan2_ha_data_internal+2112]
        addsd     xmm7, QWORD PTR [__jsvml_datan2_ha_data_internal+2176]
        mulsd     xmm2, xmm5
        mulsd     xmm7, xmm5
        addsd     xmm2, QWORD PTR [__jsvml_datan2_ha_data_internal+2240]
        addsd     xmm7, QWORD PTR [__jsvml_datan2_ha_data_internal+2304]
        mulsd     xmm2, xmm5
        mulsd     xmm7, xmm5
        addsd     xmm2, QWORD PTR [__jsvml_datan2_ha_data_internal+2368]
        addsd     xmm7, QWORD PTR [__jsvml_datan2_ha_data_internal+2432]
        mulsd     xmm2, xmm5
        mulsd     xmm7, xmm5
        addsd     xmm2, QWORD PTR [__jsvml_datan2_ha_data_internal+2496]
        addsd     xmm7, QWORD PTR [__jsvml_datan2_ha_data_internal+2560]
        mulsd     xmm2, xmm14
        addsd     xmm2, xmm7
        mulsd     xmm2, xmm14
        mulsd     xmm2, xmm15
        addsd     xmm2, xmm1
        addsd     xmm0, xmm2
        addsd     xmm0, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+8+rax+rdx]
        movmskps  eax, xmm13
        pxor      xmm0, xmm10
...
_B2_8::
        ...
        movaps    xmm11, xmm7
        movsd     xmm4, QWORD PTR [__jsvml_datan2_ha_data_internal+832]
        andnps    xmm2, xmm12
        movsd     xmm3, QWORD PTR [__jsvml_datan2_ha_data_internal+3136]
        movaps    xmm5, xmm4
        andps     xmm4, xmm9
        andps     xmm3, xmm8
        andps     xmm8, xmm10
        ...
        orps      xmm8, xmm5
        pcmpgtd   xmm15, xmm13
        movsd     xmm6, QWORD PTR [__jsvml_datan2_ha_data_internal+3072]
        pshufd    xmm1, xmm15, 0
        andps     xmm1, xmm6
        pshufd    xmm2, xmm12, 0
        addsd     xmm8, xmm1
...
__jsvml_atan21_ha_ex ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_atan21_ha_ex_B1_B8:
        DD      1612289
        DD      1954970
        DD      1599634
        DD      1538186
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B2_1
        DD      imagerel _B2_9
        DD      imagerel _unwind___jsvml_atan21_ha_ex_B1_B8
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_atan24_ha_l9

__jsvml_atan24_ha_l9    PROC    EXPORT
...
L79::
        ...
        lea       r13, QWORD PTR [111+rsp]
        vmovupd   ymm14, YMMWORD PTR [__jsvml_datan2_ha_data_internal+896]
        and       r13, -64
        vmovupd   ymm12, YMMWORD PTR [__jsvml_datan2_ha_data_internal+2880]
        vmovups   xmm4, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2688]
        ...
        vandpd    ymm12, ymm5, YMMWORD PTR [__jsvml_datan2_ha_data_internal+960]
        vandpd    ymm10, ymm5, YMMWORD PTR [__jsvml_datan2_ha_data_internal+1024]
        vmovups   xmm0, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2752]
        ...
        vmulpd    ymm8, ymm15, YMMWORD PTR [__jsvml_datan2_ha_data_internal+1344]
        vpcmpeqd  xmm0, xmm3, xmm0
        vmulpd    ymm3, ymm15, YMMWORD PTR [__jsvml_datan2_ha_data_internal+1152]
        vpor      xmm6, xmm9, xmm7
        vmulpd    ymm7, ymm15, YMMWORD PTR [__jsvml_datan2_ha_data_internal+1216]
        vpor      xmm4, xmm2, xmm0
        vpor      xmm0, xmm6, xmm4
        vmulpd    ymm6, ymm15, YMMWORD PTR [__jsvml_datan2_ha_data_internal+1280]
        vmovupd   ymm9, YMMWORD PTR [__jsvml_datan2_ha_data_internal+1792]
        vmovmskps r11d, xmm0
        test      r11d, r11d
        ...
        vpaddd    xmm2, xmm3, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1408]
        vpslld    xmm8, xmm2, 5
        vmovd     ecx, xmm8
        vpextrd   r9d, xmm8, 2
        vpextrd   eax, xmm8, 1
        vmovq     xmm6, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+rdx+rcx]
        vpextrd   r10d, xmm8, 3
        vmovq     xmm5, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+rdx+r9]
        vmovhpd   xmm4, xmm6, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+rdx+rax]
        vmovhpd   xmm7, xmm5, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+rdx+r10]
        vmovq     xmm3, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+8+rdx+rcx]
        vmovq     xmm8, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+8+rdx+r9]
        vmovhpd   xmm6, xmm3, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+8+rdx+rax]
        vmovhpd   xmm5, xmm8, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+8+rdx+r10]
        vinsertf128 ymm2, ymm4, xmm7, 1
        vmovq     xmm7, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+16+rdx+rcx]
        vmovq     xmm4, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+16+rdx+r9]
        vmovhpd   xmm3, xmm7, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+16+rdx+rax]
        vinsertf128 ymm8, ymm6, xmm5, 1
        vmovhpd   xmm5, xmm4, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+16+rdx+r10]
        vmovq     xmm6, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+24+rdx+rcx]
        vmovhpd   xmm4, xmm6, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+24+rdx+rax]
        vinsertf128 ymm7, ymm3, xmm5, 1
        vmovq     xmm5, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+24+rdx+r9]
        vmovhpd   xmm3, xmm5, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+24+rdx+r10]
        ...
        vmovups   xmm5, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1536]
        vextracti128 xmm6, ymm2, 1
        vshufps   xmm4, xmm2, xmm6, 221
        vandps    xmm6, xmm4, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1472]
        vpslld    xmm4, xmm4, 3
        vpsubd    xmm6, xmm5, xmm6
        vandps    xmm5, xmm4, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1600]
        vorps     xmm4, xmm5, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1664]
        vrcpps    xmm5, xmm4
        vpsrld    xmm4, xmm5, 3
        vpsubd    xmm5, xmm4, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1728]
        vpaddd    xmm5, xmm5, xmm6
        vpshufd   xmm6, xmm5, 80
        vpshufd   xmm4, xmm5, 250
        vinserti128 ymm5, ymm6, xmm4, 1
        vandpd    ymm4, ymm5, YMMWORD PTR [__jsvml_datan2_ha_data_internal+3008]
        vmovdqa   ymm6, ymm9
        vfnmadd231pd ymm6, ymm4, ymm2
        vfmadd213pd ymm6, ymm6, ymm6
        vfmadd213pd ymm4, ymm6, ymm4
        vmovupd   ymm6, YMMWORD PTR [__jsvml_datan2_ha_data_internal+1856]
        vfnmadd231pd ymm9, ymm4, ymm2
        vfmadd213pd ymm4, ymm9, ymm4
        vmulpd    ymm5, ymm3, ymm4
        vfnmadd213pd ymm2, ymm5, ymm3
        vmovupd   ymm3, YMMWORD PTR [__jsvml_datan2_ha_data_internal+1920]
        vmulpd    ymm9, ymm4, ymm2
        vmulpd    ymm4, ymm5, ymm5
        vaddpd    ymm7, ymm7, ymm9
        vmulpd    ymm2, ymm4, ymm4
        vaddpd    ymm9, ymm10, ymm7
        vfmadd213pd ymm6, ymm2, YMMWORD PTR [__jsvml_datan2_ha_data_internal+1984]
        vfmadd213pd ymm3, ymm2, YMMWORD PTR [__jsvml_datan2_ha_data_internal+2048]
        vfmadd213pd ymm6, ymm2, YMMWORD PTR [__jsvml_datan2_ha_data_internal+2112]
        vfmadd213pd ymm3, ymm2, YMMWORD PTR [__jsvml_datan2_ha_data_internal+2176]
        vfmadd213pd ymm6, ymm2, YMMWORD PTR [__jsvml_datan2_ha_data_internal+2240]
        vfmadd213pd ymm3, ymm2, YMMWORD PTR [__jsvml_datan2_ha_data_internal+2304]
        vfmadd213pd ymm6, ymm2, YMMWORD PTR [__jsvml_datan2_ha_data_internal+2368]
        vfmadd213pd ymm3, ymm2, YMMWORD PTR [__jsvml_datan2_ha_data_internal+2432]
        vfmadd213pd ymm6, ymm2, YMMWORD PTR [__jsvml_datan2_ha_data_internal+2496]
        vfmadd213pd ymm3, ymm2, YMMWORD PTR [__jsvml_datan2_ha_data_internal+2560]
...
_B3_12::
        ...
        vmovupd   ymm9, YMMWORD PTR [__jsvml_datan2_ha_data_internal+832]
        ...
        vandpd    ymm5, ymm10, YMMWORD PTR [__jsvml_datan2_ha_data_internal+3136]
        vextracti128 xmm2, ymm3, 1
        vshufps   xmm2, xmm3, xmm2, 221
        ...
        vandpd    ymm2, ymm2, YMMWORD PTR [__jsvml_datan2_ha_data_internal+3072]
...
__jsvml_atan24_ha_l9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_atan24_ha_l9_B1_B4:
        DD      1603329
        DD      4904055
        DD      1271919
        DD      1538150
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B3_1
        DD      imagerel _B3_7
        DD      imagerel _unwind___jsvml_atan24_ha_l9_B1_B4

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_atan24_ha_l9_B7_B11:
        DD      265761
        DD      287758
        DD      340999
        DD      imagerel _B3_1
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B3_7
        DD      imagerel _B3_12
        DD      imagerel _unwind___jsvml_atan24_ha_l9_B7_B11
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B3_12
        DD      imagerel _B3_13
        DD      imagerel _unwind___jsvml_atan24_ha_l9_B12_B12
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_atan24_ha_e9

__jsvml_atan24_ha_e9    PROC    EXPORT
...
L111::
        ...
        lea       r13, QWORD PTR [111+rsp]
        vmovupd   ymm13, YMMWORD PTR [__jsvml_datan2_ha_data_internal+896]
        and       r13, -64
        vmovupd   ymm8, YMMWORD PTR [__jsvml_datan2_ha_data_internal+1088]
        vmovupd   ymm9, YMMWORD PTR [__jsvml_datan2_ha_data_internal+2880]
        vmovupd   YMMWORD PTR [64+r13], ymm1
        vmovupd   YMMWORD PTR [32+r13], ymm0
        ...
        vandpd    ymm4, ymm2, YMMWORD PTR [__jsvml_datan2_ha_data_internal+960]
        vmovupd   YMMWORD PTR [192+r13], ymm4
        vmovups   xmm4, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2688]
        vandpd    ymm9, ymm2, YMMWORD PTR [__jsvml_datan2_ha_data_internal+1024]
        ...
        vmovups   xmm4, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2752]
        vpaddd    xmm0, xmm1, XMMWORD PTR [__jsvml_datan2_ha_data_internal+3200]
        vpcmpgtd  xmm3, xmm15, xmm4
        vpcmpeqd  xmm15, xmm15, xmm4
        vpcmpgtd  xmm2, xmm14, xmm4
        vpcmpeqd  xmm14, xmm14, xmm4
        vpor      xmm1, xmm3, xmm15
        vmovups   xmm4, XMMWORD PTR [__jsvml_datan2_ha_data_internal+3264]
        vpor      xmm15, xmm2, xmm14
        vpcmpgtd  xmm2, xmm4, xmm0
        vpcmpeqd  xmm0, xmm4, xmm0
        vmulpd    ymm14, ymm6, YMMWORD PTR [__jsvml_datan2_ha_data_internal+1152]
        vpor      xmm3, xmm1, xmm15
        vpor      xmm15, xmm2, xmm0
        vpor      xmm4, xmm3, xmm15
        vmovdqu   XMMWORD PTR [32+rsp], xmm4
        vmulpd    ymm0, ymm6, YMMWORD PTR [__jsvml_datan2_ha_data_internal+1344]
        vmulpd    ymm2, ymm6, YMMWORD PTR [__jsvml_datan2_ha_data_internal+1216]
        vmulpd    ymm6, ymm6, YMMWORD PTR [__jsvml_datan2_ha_data_internal+1280]
        ...
        vpaddd    xmm2, xmm4, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1408]
        vpslld    xmm3, xmm2, 5
        vmovd     ecx, xmm3
        vpextrd   r9d, xmm3, 2
        vpextrd   eax, xmm3, 1
        vmovq     xmm5, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+rdx+rcx]
        vpextrd   r10d, xmm3, 3
        vmovq     xmm0, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+rdx+r9]
        vmovq     xmm4, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+8+rdx+r9]
        vmovhpd   xmm1, xmm5, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+rdx+rax]
        vmovq     xmm15, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+8+rdx+rcx]
        vmovq     xmm5, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+16+rdx+rcx]
        vmovhpd   xmm14, xmm0, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+rdx+r10]
        vmovq     xmm0, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+16+rdx+r9]
        vmovhpd   xmm6, xmm15, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+8+rdx+rax]
        vmovhpd   xmm2, xmm4, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+8+rdx+r10]
        vmovq     xmm4, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+24+rdx+rcx]
        vinsertf128 ymm3, ymm1, xmm14, 1
        vmovhpd   xmm1, xmm5, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+16+rdx+rax]
        vmovhpd   xmm14, xmm0, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+16+rdx+r10]
        vmovq     xmm5, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+24+rdx+r9]
        vinsertf128 ymm15, ymm6, xmm2, 1
        vmovhpd   xmm2, xmm4, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+24+rdx+rax]
        vinsertf128 ymm6, ymm1, xmm14, 1
        vmovhpd   xmm1, xmm5, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+24+rdx+r10]
        ...
        vmovups   xmm7, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1536]
        vextractf128 xmm12, ymm10, 1
        vshufps   xmm8, xmm10, xmm12, 221
        vpslld    xmm2, xmm8, 3
        vandps    xmm1, xmm2, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1600]
        vorps     xmm0, xmm1, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1664]
        vrcpps    xmm14, xmm0
        vandps    xmm11, xmm8, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1472]
        vpsrld    xmm12, xmm14, 3
        vpsubd    xmm11, xmm7, xmm11
        vpsubd    xmm7, xmm12, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1728]
        vpaddd    xmm2, xmm7, xmm11
        vpshufd   xmm8, xmm2, 80
        vpshufd   xmm1, xmm2, 250
        vinsertf128 ymm0, ymm8, xmm1, 1
        vandpd    ymm2, ymm0, YMMWORD PTR [__jsvml_datan2_ha_data_internal+3008]
        vmulpd    ymm10, ymm10, ymm2
        vmulpd    ymm3, ymm2, ymm3
        vsubpd    ymm14, ymm10, YMMWORD PTR [__jsvml_datan2_ha_data_internal+1792]
        ...
        vmulpd    ymm2, ymm8, YMMWORD PTR [__jsvml_datan2_ha_data_internal+1856]
        vmulpd    ymm4, ymm8, YMMWORD PTR [__jsvml_datan2_ha_data_internal+1920]
        vaddpd    ymm0, ymm2, YMMWORD PTR [__jsvml_datan2_ha_data_internal+1984]
        vaddpd    ymm2, ymm4, YMMWORD PTR [__jsvml_datan2_ha_data_internal+2048]
        vmulpd    ymm1, ymm8, ymm0
        vmulpd    ymm3, ymm8, ymm2
        vaddpd    ymm4, ymm1, YMMWORD PTR [__jsvml_datan2_ha_data_internal+2112]
        vaddpd    ymm14, ymm3, YMMWORD PTR [__jsvml_datan2_ha_data_internal+2176]
        vmulpd    ymm5, ymm8, ymm4
        vmulpd    ymm14, ymm8, ymm14
        vaddpd    ymm0, ymm5, YMMWORD PTR [__jsvml_datan2_ha_data_internal+2240]
        vaddpd    ymm2, ymm14, YMMWORD PTR [__jsvml_datan2_ha_data_internal+2304]
        vmulpd    ymm1, ymm8, ymm0
        vmulpd    ymm3, ymm8, ymm2
        vaddpd    ymm4, ymm1, YMMWORD PTR [__jsvml_datan2_ha_data_internal+2368]
        vaddpd    ymm0, ymm3, YMMWORD PTR [__jsvml_datan2_ha_data_internal+2432]
        vmulpd    ymm5, ymm8, ymm4
        vmulpd    ymm8, ymm8, ymm0
        vaddpd    ymm1, ymm5, YMMWORD PTR [__jsvml_datan2_ha_data_internal+2496]
        vaddpd    ymm0, ymm8, YMMWORD PTR [__jsvml_datan2_ha_data_internal+2560]
...
_B4_12::
        ...
        vmovupd   ymm11, YMMWORD PTR [__jsvml_datan2_ha_data_internal+832]
        ...
        vandpd    ymm6, ymm12, YMMWORD PTR [__jsvml_datan2_ha_data_internal+3136]
        ...
        vandpd    ymm15, ymm14, YMMWORD PTR [__jsvml_datan2_ha_data_internal+3072]
...
__jsvml_atan24_ha_e9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_atan24_ha_e9_B1_B4:
        DD      1603329
        DD      5428343
        DD      1534063
        DD      1800294
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B4_1
        DD      imagerel _B4_7
        DD      imagerel _unwind___jsvml_atan24_ha_e9_B1_B4

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_atan24_ha_e9_B7_B11:
        DD      265761
        DD      287758
        DD      340999
        DD      imagerel _B4_1
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B4_7
        DD      imagerel _B4_12
        DD      imagerel _unwind___jsvml_atan24_ha_e9_B7_B11

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_atan24_ha_e9_B12_B12:
        DD      33
        DD      imagerel _B4_1
        DD      imagerel _B4_7
        DD      imagerel _unwind___jsvml_atan24_ha_e9_B1_B4
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B4_12
        DD      imagerel _B4_13
        DD      imagerel _unwind___jsvml_atan24_ha_e9_B12_B12
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_atan22_ha_l9

__jsvml_atan22_ha_l9    PROC    EXPORT
...
L155::
        ...
        lea       r13, QWORD PTR [111+rsp]
        vmovupd   xmm5, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2880]
        and       r13, -64
        vcmpltpd  xmm4, xmm13, xmm5
        vmovupd   xmm10, XMMWORD PTR [__jsvml_datan2_ha_data_internal+896]
        vandpd    xmm11, xmm13, xmm10
        vandpd    xmm10, xmm0, xmm10
        vpshufd   xmm1, xmm10, 221
        vxorpd    xmm9, xmm0, xmm10
        vmovq     xmm3, QWORD PTR [__jsvml_datan2_ha_data_internal+2688]
        vxorpd    xmm7, xmm13, xmm11
        vpshufd   xmm2, xmm11, 221
        vpsubd    xmm14, xmm1, xmm3
        vmovq     xmm12, QWORD PTR [__jsvml_datan2_ha_data_internal+2752]
        vmovupd   XMMWORD PTR [416+rsp], xmm5
        vpsubd    xmm5, xmm2, xmm3
        vandpd    xmm8, xmm4, XMMWORD PTR [__jsvml_datan2_ha_data_internal+960]
        vpcmpgtd  xmm15, xmm5, xmm12
        vandpd    xmm6, xmm4, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1024]
        ...
        vmulpd    xmm4, xmm11, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1152]
        vmulpd    xmm5, xmm11, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1216]
        vmulpd    xmm15, xmm11, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1280]
        vpor      xmm12, xmm3, xmm0
        vmulpd    xmm3, xmm11, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1344]
        vmovmskps r9d, xmm12
        ...
        vmovq     xmm14, QWORD PTR [__jsvml_datan2_ha_data_internal+1408]
        vpaddd    xmm2, xmm4, xmm5
        vpaddd    xmm14, xmm2, xmm14
        vpslld    xmm3, xmm14, 5
        vmovd     edx, xmm3
        vpextrd   ecx, xmm3, 1
        vmovq     xmm14, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+24+r8+rdx]
        vmovq     xmm1, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+r8+rdx]
        vmovhpd   xmm3, xmm14, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+24+r8+rcx]
        vmovhpd   xmm0, xmm1, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+r8+rcx]
        vandpd    xmm2, xmm3, xmm10
        vandpd    xmm3, xmm3, xmm11
        vfmadd231pd xmm3, xmm10, xmm0
        vmovq     xmm15, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+16+r8+rdx]
        vmovhpd   xmm4, xmm15, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+16+r8+rcx]
        vmovq     xmm15, QWORD PTR [__jsvml_datan2_ha_data_internal+1600]
        vmovq     xmm14, QWORD PTR [__jsvml_datan2_ha_data_internal+1664]
        vpshufd   xmm1, xmm3, 221
        vfnmadd231pd xmm2, xmm11, xmm0
        vpslld    xmm0, xmm1, 3
        vpand     xmm0, xmm0, xmm15
        vpor      xmm14, xmm0, xmm14
        vmovq     xmm0, QWORD PTR [__jsvml_datan2_ha_data_internal+1728]
        vmovq     xmm5, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+8+r8+rdx]
        vrcpps    xmm15, xmm14
        vpsrld    xmm14, xmm15, 3
        vpsubd    xmm15, xmm14, xmm0
        vmovq     xmm14, QWORD PTR [__jsvml_datan2_ha_data_internal+1472]
        vpand     xmm14, xmm1, xmm14
        vmovq     xmm1, QWORD PTR [__jsvml_datan2_ha_data_internal+1536]
        vpsubd    xmm0, xmm1, xmm14
        vpaddd    xmm15, xmm15, xmm0
        vpshufd   xmm1, xmm15, 80
        vandpd    xmm1, xmm1, XMMWORD PTR [__jsvml_datan2_ha_data_internal+3008]
        vmovupd   xmm0, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1792]
        vmovapd   xmm14, xmm1
        vfnmadd213pd xmm14, xmm3, xmm0
        vmovhpd   xmm5, xmm5, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+8+r8+rcx]
        ...
        vmovupd   xmm1, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1856]
        vmovupd   xmm3, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1920]
        vfmadd213pd xmm1, xmm2, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1984]
        vfmadd213pd xmm3, xmm2, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2048]
        vaddpd    xmm4, xmm4, xmm14
        vfmadd213pd xmm1, xmm2, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2112]
        vfmadd213pd xmm3, xmm2, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2176]
        vaddpd    xmm6, xmm6, xmm4
        vfmadd213pd xmm1, xmm2, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2240]
        vfmadd213pd xmm3, xmm2, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2304]
        vfmadd213pd xmm1, xmm2, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2368]
        vfmadd213pd xmm3, xmm2, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2432]
        vfmadd213pd xmm1, xmm2, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2496]
        vfmadd213pd xmm3, xmm2, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2560]
...
_B5_12::
        ...
        vmovupd   xmm6, XMMWORD PTR [__jsvml_datan2_ha_data_internal+832]
        vorpd     xmm10, xmm11, xmm15
        vandpd    xmm3, xmm7, XMMWORD PTR [__jsvml_datan2_ha_data_internal+3136]
        ...
        vandpd    xmm9, xmm7, XMMWORD PTR [__jsvml_datan2_ha_data_internal+3072]
...
__jsvml_atan22_ha_l9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_atan22_ha_l9_B1_B4:
        DD      1604097
        DD      3593338
        DD      1075314
        DD      1472617
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B5_1
        DD      imagerel _B5_7
        DD      imagerel _unwind___jsvml_atan22_ha_l9_B1_B4

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_atan22_ha_l9_B7_B11:
        DD      265761
        DD      287758
        DD      340999
        DD      imagerel _B5_1
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B5_7
        DD      imagerel _B5_12
        DD      imagerel _unwind___jsvml_atan22_ha_l9_B7_B11

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_atan22_ha_l9_B12_B12:
        DD      33
        DD      imagerel _B5_1
        DD      imagerel _B5_7
        DD      imagerel _unwind___jsvml_atan22_ha_l9_B1_B4
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B5_12
        DD      imagerel _B5_13
        DD      imagerel _unwind___jsvml_atan22_ha_l9_B12_B12
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_atan22_ha_e9

__jsvml_atan22_ha_e9    PROC    EXPORT
...
L187::
        ...
        lea       r13, QWORD PTR [111+rsp]
        vmovupd   xmm12, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2880]
        and       r13, -64
        vcmpltpd  xmm3, xmm1, xmm12
        vmovupd   xmm13, XMMWORD PTR [__jsvml_datan2_ha_data_internal+896]
        vmovupd   xmm6, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1088]
        ...
        vandpd    xmm12, xmm3, XMMWORD PTR [__jsvml_datan2_ha_data_internal+960]
        vandpd    xmm5, xmm2, xmm6
        vandpd    xmm7, xmm3, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1024]
        vpshufd   xmm3, xmm2, 221
        vxorpd    xmm7, xmm7, xmm11
        vpshufd   xmm4, xmm4, 221
        vmovq     xmm15, QWORD PTR [__jsvml_datan2_ha_data_internal+2688]
        vmovupd   XMMWORD PTR [432+rsp], xmm1
        vpsubd    xmm14, xmm4, xmm15
        vmovupd   XMMWORD PTR [32+rsp], xmm0
        vpsubd    xmm0, xmm3, xmm15
        vmovq     xmm1, QWORD PTR [__jsvml_datan2_ha_data_internal+3200]
        vpsubd    xmm15, xmm4, xmm3
        vpaddd    xmm3, xmm15, xmm1
        vmovq     xmm15, QWORD PTR [__jsvml_datan2_ha_data_internal+2752]
        ...
        vmovq     xmm14, QWORD PTR [__jsvml_datan2_ha_data_internal+3264]
        vpor      xmm0, xmm0, xmm15
        vpcmpgtd  xmm1, xmm14, xmm3
        vpcmpeqd  xmm3, xmm14, xmm3
        vpor      xmm3, xmm1, xmm3
        vmulpd    xmm15, xmm2, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1152]
        vmulpd    xmm1, xmm2, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1216]
        vsubpd    xmm8, xmm2, xmm5
        vpor      xmm0, xmm0, xmm3
        vmulpd    xmm3, xmm2, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1344]
        vmovdqu   XMMWORD PTR [480+rsp], xmm0
        vmulpd    xmm0, xmm2, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1280]
        ...
        vmovd     edx, xmm3
        vpextrd   ecx, xmm3, 1
        vmovq     xmm2, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+r8+rdx]
        vmovq     xmm4, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+16+r8+rdx]
        vmovhpd   xmm1, xmm2, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+r8+rcx]
        vmovhpd   xmm2, xmm4, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+16+r8+rcx]
        vmulpd    xmm4, xmm5, xmm1
        vmovq     xmm0, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+24+r8+rdx]
        vmovhpd   xmm0, xmm0, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+24+r8+rcx]
        ...
        vmovq     xmm15, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+8+r8+rdx]
        vandpd    xmm8, xmm0, xmm8
        vmovhpd   xmm3, xmm15, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+8+r8+rcx]
        ...
        vmovq     xmm10, QWORD PTR [__jsvml_datan2_ha_data_internal+1600]
        vpslld    xmm8, xmm1, 3
        vmovq     xmm5, QWORD PTR [__jsvml_datan2_ha_data_internal+1664]
        vpand     xmm8, xmm8, xmm10
        vpor      xmm5, xmm8, xmm5
        vrcpps    xmm8, xmm5
        vmovq     xmm9, QWORD PTR [__jsvml_datan2_ha_data_internal+1728]
        vpsrld    xmm10, xmm8, 3
        vmovq     xmm6, QWORD PTR [__jsvml_datan2_ha_data_internal+1472]
        vpsubd    xmm8, xmm10, xmm9
        vmovq     xmm9, QWORD PTR [__jsvml_datan2_ha_data_internal+1536]
        vpand     xmm6, xmm1, xmm6
        vpsubd    xmm1, xmm9, xmm6
        vpaddd    xmm8, xmm8, xmm1
        vpshufd   xmm10, xmm8, 80
        vandpd    xmm10, xmm10, XMMWORD PTR [__jsvml_datan2_ha_data_internal+3008]
        vmulpd    xmm14, xmm14, xmm10
        vmulpd    xmm0, xmm10, xmm0
        vsubpd    xmm8, xmm14, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1792]
        ...
        vmulpd    xmm15, xmm6, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1856]
        vmulpd    xmm0, xmm6, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1920]
        vaddpd    xmm1, xmm15, XMMWORD PTR [__jsvml_datan2_ha_data_internal+1984]
        vaddpd    xmm14, xmm0, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2048]
        vmulpd    xmm4, xmm6, xmm1
        vmulpd    xmm15, xmm6, xmm14
        vaddpd    xmm0, xmm4, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2112]
        vaddpd    xmm4, xmm15, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2176]
        vmulpd    xmm1, xmm6, xmm0
        vmulpd    xmm14, xmm6, xmm4
        vaddpd    xmm15, xmm1, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2240]
        vaddpd    xmm0, xmm14, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2304]
        vmulpd    xmm15, xmm6, xmm15
        vmulpd    xmm1, xmm6, xmm0
        vaddpd    xmm4, xmm15, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2368]
        vaddpd    xmm0, xmm1, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2432]
        vmulpd    xmm14, xmm6, xmm4
        vmulpd    xmm6, xmm6, xmm0
        vaddpd    xmm1, xmm14, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2496]
        vaddpd    xmm0, xmm6, XMMWORD PTR [__jsvml_datan2_ha_data_internal+2560]
...
_B6_12::
        ...
        vmovupd   xmm9, XMMWORD PTR [__jsvml_datan2_ha_data_internal+832]
        vorpd     xmm1, xmm14, xmm15
        vandpd    xmm6, xmm8, xmm9
        vandpd    xmm5, xmm11, xmm9
        vandpd    xmm9, xmm12, xmm13
        vandpd    xmm4, xmm10, XMMWORD PTR [__jsvml_datan2_ha_data_internal+3136]
        ...
        vandpd    xmm11, xmm9, XMMWORD PTR [__jsvml_datan2_ha_data_internal+3072]
...
__jsvml_atan22_ha_e9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_atan22_ha_e9_B1_B4:
        DD      1603073
        DD      4117622
        DD      1075310
        DD      1276005
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B6_1
        DD      imagerel _B6_7
        DD      imagerel _unwind___jsvml_atan22_ha_e9_B1_B4

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_atan22_ha_e9_B7_B11:
        DD      265761
        DD      287758
        DD      340999
        DD      imagerel _B6_1
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B6_7
        DD      imagerel _B6_12
        DD      imagerel _unwind___jsvml_atan22_ha_e9_B7_B11

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_atan22_ha_e9_B12_B12:
        DD      33
        DD      imagerel _B6_1
        DD      imagerel _B6_7
        DD      imagerel _unwind___jsvml_atan22_ha_e9_B1_B4
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B6_12
        DD      imagerel _B6_13
        DD      imagerel _unwind___jsvml_atan22_ha_e9_B12_B12
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_atan28_ha_z0

__jsvml_atan28_ha_z0    PROC    EXPORT
...
L227::
        ...
        vmovups   zmm2, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+896]
        and       r13, -64
        vmovdqu   ymm8, YMMWORD PTR [__jsvml_datan2_ha_data_internal+2688]
        vmovups   zmm25, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+1344]
        vmovups   zmm23, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+1280]
        vmovups   zmm24, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+1216]
        vmovups   zmm31, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+1152]
        vmovups   zmm26, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+1792]
        vmovups   zmm28, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+960]
        vmovaps   zmm6, zmm1
        vmovaps   zmm5, zmm0
        vandpd    zmm4, zmm6, zmm2
        vandpd    zmm3, zmm5, zmm2
        vmovdqu   ymm1, YMMWORD PTR [__jsvml_datan2_ha_data_internal+2752]
        vmovups   zmm2, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+2880]
        ...
        vmovups   zmm11, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+704]
        vmovups   zmm14, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+768]
        vmovups   zmm9, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+192]
        vmovups   zmm10, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+256]
        vmovups   zmm13, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+512]
        vmovups   zmm12, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+448]
        vblendmpd zmm23{k1}, zmm11, zmm26
        vblendmpd zmm22{k3}, zmm14, zmm26
        vpor      ymm1, ymm15, ymm1
        vblendmpd zmm15{k1}, zmm9, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+320]
        vblendmpd zmm30{k1}, zmm10, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+384]
        vblendmpd zmm0{k2}, zmm23, zmm22
        vblendmpd zmm31{k3}, zmm13, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+640]
        vblendmpd zmm29{k3}, zmm12, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+576]
        vmovups   zmm11, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+2368]
        vmovups   zmm12, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+2432]
        vmovups   zmm13, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+2496]
        vblendmpd zmm24{k2}, zmm30, zmm31
        vblendmpd zmm25{k2}, zmm15, zmm29
        vmovups   zmm30, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+1984]
        vmovups   zmm29, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+2048]
        vmovups   zmm15, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+2560]
        vmovaps   zmm9, zmm4
        ...
        vmovups   zmm7, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+2112]
        vfnmadd231pd zmm26, zmm10, zmm9 {rn-sae}
        vmovaps   zmm8, zmm3
        vxorpd    zmm8{k3}, zmm3, zmm3
        vfmadd213pd zmm10, zmm26, zmm10 {rn-sae}
        vmovups   zmm26, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+1856]
        vfnmadd231pd zmm8{k4}, zmm0, zmm4 {rn-sae}
        vmovups   zmm0, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+1920]
        vmulpd    zmm23, zmm10, zmm8 {rn-sae}
        vmulpd    zmm31, zmm23, zmm23 {rn-sae}
        vfnmadd213pd zmm9, zmm23, zmm8 {rn-sae}
        vmovups   zmm8, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+2176]
        vmulpd    zmm14, zmm31, zmm31 {rn-sae}
        vmulpd    zmm22, zmm9, zmm10 {rn-sae}
        vmovups   zmm9, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+2240]
        vmovups   zmm10, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+2304]
        vfmadd231pd zmm30, zmm26, zmm14 {rn-sae}
        vfmadd231pd zmm29, zmm0, zmm14 {rn-sae}
        vxorpd    zmm26, zmm27, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+1024]
...
_B7_17::
        ...
        vmovups   zmm24, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+3136]
        vmovups   zmm23, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+832]
        vmovups   zmm22, ZMMWORD PTR [__jsvml_datan2_ha_data_internal+3072]
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B7_12
        DD      imagerel _B7_17
        DD      imagerel _unwind___jsvml_atan28_ha_z0_B12_B16

.pdata  ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_atan28_ha_z0_B17_B17:
        DD      33
        DD      imagerel _B7_1
        DD      imagerel _B7_12
        DD      imagerel _unwind___jsvml_atan28_ha_z0_B1_B10
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B7_17
        DD      imagerel _B7_18
        DD      imagerel _unwind___jsvml_atan28_ha_z0_B17_B17
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_atan21_ha_e9

__jsvml_atan21_ha_e9    PROC    EXPORT
...
L278::
        ...
        mov       QWORD PTR [232+rsp], r13
        lea       r13, QWORD PTR [95+rsp]
        vmovsd    xmm2, QWORD PTR [__jsvml_datan2_ha_data_internal+2880]
        and       r13, -64
        vmovsd    xmm12, QWORD PTR [__jsvml_datan2_ha_data_internal+896]
        vcmpltsd  xmm8, xmm1, xmm2
        vmovsd    xmm11, QWORD PTR [__jsvml_datan2_ha_data_internal+960]
        vandpd    xmm13, xmm1, xmm12
        vmovsd    xmm3, QWORD PTR [__jsvml_datan2_ha_data_internal+1024]
        vandpd    xmm14, xmm0, xmm12
        vmovsd    xmm5, QWORD PTR [__jsvml_datan2_ha_data_internal+1088]
        ...
        vmulsd    xmm1, xmm13, QWORD PTR [__jsvml_datan2_ha_data_internal+1152]
        vpor      xmm2, xmm2, xmm15
        vmulsd    xmm0, xmm13, QWORD PTR [__jsvml_datan2_ha_data_internal+1216]
        vmulsd    xmm14, xmm13, QWORD PTR [__jsvml_datan2_ha_data_internal+1280]
        vmulsd    xmm15, xmm13, QWORD PTR [__jsvml_datan2_ha_data_internal+1344]
        ...
        vpslld    xmm3, xmm14, 5
        vmovd     edx, xmm3
        vmovq     xmm1, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+rax+rdx]
        vmulsd    xmm3, xmm1, xmm6
        vmovq     xmm0, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+24+rax+rdx]
        ...
        vmovsd    xmm5, QWORD PTR [__jsvml_datan2_ha_data_internal+3008]
        vpshufd   xmm9, xmm6, 0
        vandpd    xmm4, xmm9, xmm5
        vmulsd    xmm5, xmm0, xmm4
        vmulsd    xmm1, xmm1, xmm4
        vsubsd    xmm0, xmm5, QWORD PTR [__jsvml_datan2_ha_data_internal+1792]
        ...
        vmovsd    xmm0, QWORD PTR [__jsvml_datan2_ha_data_internal+1920]
        ...
        vmovsd    xmm14, QWORD PTR [__jsvml_datan2_ha_data_internal+1856]
        ...
        vaddsd    xmm3, xmm14, QWORD PTR [__jsvml_datan2_ha_data_internal+1984]
        vaddsd    xmm0, xmm1, QWORD PTR [__jsvml_datan2_ha_data_internal+2048]
        vmulsd    xmm15, xmm3, xmm5
        vmulsd    xmm1, xmm0, xmm5
        vaddsd    xmm3, xmm15, QWORD PTR [__jsvml_datan2_ha_data_internal+2112]
        vaddsd    xmm15, xmm1, QWORD PTR [__jsvml_datan2_ha_data_internal+2176]
        vmulsd    xmm14, xmm3, xmm5
        vmulsd    xmm15, xmm15, xmm5
        vaddsd    xmm0, xmm14, QWORD PTR [__jsvml_datan2_ha_data_internal+2240]
        vaddsd    xmm3, xmm15, QWORD PTR [__jsvml_datan2_ha_data_internal+2304]
        vmulsd    xmm1, xmm0, xmm5
        vmulsd    xmm14, xmm3, xmm5
        vaddsd    xmm0, xmm1, QWORD PTR [__jsvml_datan2_ha_data_internal+2368]
        vaddsd    xmm3, xmm14, QWORD PTR [__jsvml_datan2_ha_data_internal+2432]
        vmulsd    xmm1, xmm0, xmm5
        vmulsd    xmm5, xmm3, xmm5
        vaddsd    xmm14, xmm1, QWORD PTR [__jsvml_datan2_ha_data_internal+2496]
        vaddsd    xmm1, xmm5, QWORD PTR [__jsvml_datan2_ha_data_internal+2560]
        vmulsd    xmm0, xmm14, xmm9
        vaddsd    xmm3, xmm0, xmm1
        vxorpd    xmm0, xmm8, xmm10
        vaddsd    xmm8, xmm6, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+16+rax+rdx]
        ...
        vaddsd    xmm6, xmm5, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+8+rax+rdx]
        vmovmskps eax, xmm2
...
_B8_8::
        ...
        vmovsd    xmm10, QWORD PTR [__jsvml_datan2_ha_data_internal+832]
        ...
        vmovsd    xmm11, QWORD PTR [__jsvml_datan2_ha_data_internal+3136]
        ...
        vmovsd    xmm8, QWORD PTR [__jsvml_datan2_ha_data_internal+3072]
        vpshufd   xmm7, xmm5, 0
...
__jsvml_atan21_ha_e9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_atan21_ha_e9_B1_B8:
        DD      1611521
        DD      1954967
        DD      1599631
        DD      1538182
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_atan21_ha_l9

__jsvml_atan21_ha_l9    PROC    EXPORT
...
L310::
        ...
        mov       QWORD PTR [232+rsp], r13
        lea       r13, QWORD PTR [95+rsp]
        vmovsd    xmm5, QWORD PTR [__jsvml_datan2_ha_data_internal+2880]
        and       r13, -64
        vmovsd    xmm9, QWORD PTR [__jsvml_datan2_ha_data_internal+896]
        vcmpltsd  xmm3, xmm12, xmm5
        vandpd    xmm10, xmm12, xmm9
        vandpd    xmm9, xmm0, xmm9
        vmovsd    xmm4, QWORD PTR [__jsvml_datan2_ha_data_internal+960]
        vxorpd    xmm6, xmm12, xmm10
        vmovsd    xmm2, QWORD PTR [__jsvml_datan2_ha_data_internal+1024]
        ...
        vmulsd    xmm3, xmm10, QWORD PTR [__jsvml_datan2_ha_data_internal+1152]
        vpor      xmm11, xmm13, xmm11
        vmulsd    xmm15, xmm10, QWORD PTR [__jsvml_datan2_ha_data_internal+1216]
        vmulsd    xmm2, xmm10, QWORD PTR [__jsvml_datan2_ha_data_internal+1280]
        vmulsd    xmm13, xmm10, QWORD PTR [__jsvml_datan2_ha_data_internal+1344]
        ...
        vpslld    xmm14, xmm2, 5
        vmovd     edx, xmm14
        vmovsd    xmm4, QWORD PTR [__jsvml_datan2_ha_data_internal+1792]
        vmovq     xmm15, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+24+rax+rdx]
        vmovq     xmm3, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+rax+rdx]
        ...
        vmovsd    xmm13, QWORD PTR [__jsvml_datan2_ha_data_internal+3008]
        vpshufd   xmm14, xmm3, 85
        ...
        vmovsd    xmm1, QWORD PTR [__jsvml_datan2_ha_data_internal+1920]
        vmulsd    xmm13, xmm3, xmm2
        vmulsd    xmm3, xmm14, xmm14
        vmulsd    xmm4, xmm3, xmm3
        vmovsd    xmm2, QWORD PTR [__jsvml_datan2_ha_data_internal+1856]
        vfmadd213sd xmm2, xmm4, QWORD PTR [__jsvml_datan2_ha_data_internal+1984]
        vfmadd213sd xmm1, xmm4, QWORD PTR [__jsvml_datan2_ha_data_internal+2048]
        vfmadd213sd xmm2, xmm4, QWORD PTR [__jsvml_datan2_ha_data_internal+2112]
        vfmadd213sd xmm1, xmm4, QWORD PTR [__jsvml_datan2_ha_data_internal+2176]
        vfmadd213sd xmm2, xmm4, QWORD PTR [__jsvml_datan2_ha_data_internal+2240]
        vfmadd213sd xmm1, xmm4, QWORD PTR [__jsvml_datan2_ha_data_internal+2304]
        vfmadd213sd xmm2, xmm4, QWORD PTR [__jsvml_datan2_ha_data_internal+2368]
        vfmadd213sd xmm1, xmm4, QWORD PTR [__jsvml_datan2_ha_data_internal+2432]
        vfmadd213sd xmm2, xmm4, QWORD PTR [__jsvml_datan2_ha_data_internal+2496]
        vfmadd213sd xmm1, xmm4, QWORD PTR [__jsvml_datan2_ha_data_internal+2560]
        vfmadd213sd xmm2, xmm3, xmm1
        vxorpd    xmm1, xmm5, xmm6
        vaddsd    xmm5, xmm13, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+16+rax+rdx]
        vmulsd    xmm15, xmm2, xmm3
        vaddsd    xmm5, xmm5, xmm1
        vfmadd213sd xmm15, xmm14, xmm5
        mov       QWORD PTR [416+rsp], r13
        vaddsd    xmm2, xmm14, xmm15
        vaddsd    xmm3, xmm2, QWORD PTR [imagerel(__jsvml_datan2_ha_data_internal)+8+rax+rdx]
        vmovmskps eax, xmm11
...
_B9_8::
        ...
        vmovsd    xmm13, QWORD PTR [__jsvml_datan2_ha_data_internal+832]
        ...
        vmovsd    xmm14, QWORD PTR [__jsvml_datan2_ha_data_internal+3136]
        ...
        vmovsd    xmm7, QWORD PTR [__jsvml_datan2_ha_data_internal+3072]
...
__jsvml_atan21_ha_l9 ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_atan21_ha_l9_B1_B8:
        DD      1615361
        DD      1954982
        DD      1599644
        DD      1538189
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B9_1
        DD      imagerel _B9_9
        DD      imagerel _unwind___jsvml_atan21_ha_l9_B1_B8
...
_TEXT   SEGMENT      'CODE'
        ...
        ALIGN     16
        PUBLIC __jsvml_datan2_ha_cout_rare_internal

__jsvml_datan2_ha_cout_rare_internal    PROC
...
__jsvml_datan2_ha_cout_rare_internal ENDP

_TEXT   ENDS
.xdata  SEGMENT  DWORD   READ  ''

        ALIGN 004H
_unwind___jsvml_datan2_ha_cout_rare_internal_B1_B57:
        DD      551425
        DD      419946
        DD      579685
        DD      522332
...
.pdata  SEGMENT  DWORD   READ  ''
        ...
        DD      imagerel _B10_1
        DD      imagerel _B10_54
        DD      imagerel _unwind___jsvml_datan2_ha_cout_rare_internal_B1_B57
